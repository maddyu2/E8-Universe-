...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8513
\end{equation}

Proof instance 9529 quantum parameter:
\begin{equation}
\hbar \omega_{9529} = 0.990175 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9529} = 1.01e+192
\end{equation}
