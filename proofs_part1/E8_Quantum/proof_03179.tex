...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0582
\end{equation}

Proof instance 3179 quantum parameter:
\begin{equation}
\hbar \omega_{3179} = 1.003937 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3179} = 9.97e+191
\end{equation}
