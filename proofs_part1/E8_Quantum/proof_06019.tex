...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8744
\end{equation}

Proof instance 6019 quantum parameter:
\begin{equation}
\hbar \omega_{6019} = 1.008950 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6019} = 1.01e+192
\end{equation}
