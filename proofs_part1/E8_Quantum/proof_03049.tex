...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7428
\end{equation}

Proof instance 3049 quantum parameter:
\begin{equation}
\hbar \omega_{3049} = 1.001436 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3049} = 9.23e+191
\end{equation}
