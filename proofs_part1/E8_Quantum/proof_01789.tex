...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7461
\end{equation}

Proof instance 1789 quantum parameter:
\begin{equation}
\hbar \omega_{1789} = 1.011081 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1789} = 8.17e+191
\end{equation}
