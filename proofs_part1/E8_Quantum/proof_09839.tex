...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0402
\end{equation}

Proof instance 9839 quantum parameter:
\begin{equation}
\hbar \omega_{9839} = 1.017033 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9839} = 1.02e+192
\end{equation}
