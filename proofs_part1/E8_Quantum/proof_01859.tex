...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5884
\end{equation}

Proof instance 1859 quantum parameter:
\begin{equation}
\hbar \omega_{1859} = 0.995836 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1859} = 9.48e+191
\end{equation}
