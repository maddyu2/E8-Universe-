...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0519
\end{equation}

Proof instance 7059 quantum parameter:
\begin{equation}
\hbar \omega_{7059} = 1.000862 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7059} = 1.04e+192
\end{equation}
