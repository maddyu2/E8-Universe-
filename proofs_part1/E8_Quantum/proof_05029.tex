...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7289
\end{equation}

Proof instance 5029 quantum parameter:
\begin{equation}
\hbar \omega_{5029} = 0.987987 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5029} = 9.78e+191
\end{equation}
