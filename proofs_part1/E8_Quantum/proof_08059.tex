...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0878
\end{equation}

Proof instance 8059 quantum parameter:
\begin{equation}
\hbar \omega_{8059} = 1.010402 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8059} = 1.03e+192
\end{equation}
