...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2332
\end{equation}

Proof instance 1869 quantum parameter:
\begin{equation}
\hbar \omega_{1869} = 1.005457 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1869} = 9.31e+191
\end{equation}
