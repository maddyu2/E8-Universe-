...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3121
\end{equation}

Proof instance 8489 quantum parameter:
\begin{equation}
\hbar \omega_{8489} = 0.984472 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8489} = 1.08e+192
\end{equation}
