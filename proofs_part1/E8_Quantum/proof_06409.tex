...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7702
\end{equation}

Proof instance 6409 quantum parameter:
\begin{equation}
\hbar \omega_{6409} = 1.002134 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6409} = 8.55e+191
\end{equation}
