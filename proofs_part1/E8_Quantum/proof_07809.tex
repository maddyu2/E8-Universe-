...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3837
\end{equation}

Proof instance 7809 quantum parameter:
\begin{equation}
\hbar \omega_{7809} = 0.993112 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7809} = 9.17e+191
\end{equation}
