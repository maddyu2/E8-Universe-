...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5348
\end{equation}

Proof instance 1779 quantum parameter:
\begin{equation}
\hbar \omega_{1779} = 1.008553 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1779} = 9.96e+191
\end{equation}
