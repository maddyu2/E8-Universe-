...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1104
\end{equation}

Proof instance 1279 quantum parameter:
\begin{equation}
\hbar \omega_{1279} = 0.998388 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1279} = 1.05e+192
\end{equation}
