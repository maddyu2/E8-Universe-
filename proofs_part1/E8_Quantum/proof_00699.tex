...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6956
\end{equation}

Proof instance 699 quantum parameter:
\begin{equation}
\hbar \omega_{699} = 1.016129 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{699} = 1.02e+192
\end{equation}
