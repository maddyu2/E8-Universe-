...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7749
\end{equation}

Proof instance 5519 quantum parameter:
\begin{equation}
\hbar \omega_{5519} = 0.979072 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5519} = 1.04e+192
\end{equation}
