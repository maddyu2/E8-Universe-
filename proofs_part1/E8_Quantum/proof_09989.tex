...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3973
\end{equation}

Proof instance 9989 quantum parameter:
\begin{equation}
\hbar \omega_{9989} = 1.013075 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9989} = 1.16e+192
\end{equation}
