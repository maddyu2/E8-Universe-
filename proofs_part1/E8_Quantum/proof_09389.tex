...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6384
\end{equation}

Proof instance 9389 quantum parameter:
\begin{equation}
\hbar \omega_{9389} = 1.003340 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9389} = 1.05e+192
\end{equation}
