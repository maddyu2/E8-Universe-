...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8692
\end{equation}

Proof instance 6709 quantum parameter:
\begin{equation}
\hbar \omega_{6709} = 0.990540 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6709} = 8.85e+191
\end{equation}
