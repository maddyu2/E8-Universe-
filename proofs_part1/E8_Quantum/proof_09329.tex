...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4894
\end{equation}

Proof instance 9329 quantum parameter:
\begin{equation}
\hbar \omega_{9329} = 1.008545 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9329} = 1.02e+192
\end{equation}
