...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7603
\end{equation}

Proof instance 8509 quantum parameter:
\begin{equation}
\hbar \omega_{8509} = 0.975389 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8509} = 8.72e+191
\end{equation}
