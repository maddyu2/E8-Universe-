...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6731
\end{equation}

Proof instance 1469 quantum parameter:
\begin{equation}
\hbar \omega_{1469} = 1.006464 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1469} = 1.08e+192
\end{equation}
