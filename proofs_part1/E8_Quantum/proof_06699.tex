...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8295
\end{equation}

Proof instance 6699 quantum parameter:
\begin{equation}
\hbar \omega_{6699} = 0.996856 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6699} = 8.79e+191
\end{equation}
