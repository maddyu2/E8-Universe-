...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1900
\end{equation}

Proof instance 9249 quantum parameter:
\begin{equation}
\hbar \omega_{9249} = 1.001988 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9249} = 1.02e+192
\end{equation}
