...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6179
\end{equation}

Proof instance 3639 quantum parameter:
\begin{equation}
\hbar \omega_{3639} = 1.001616 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3639} = 9.60e+191
\end{equation}
