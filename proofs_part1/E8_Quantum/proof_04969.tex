...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2119
\end{equation}

Proof instance 4969 quantum parameter:
\begin{equation}
\hbar \omega_{4969} = 0.995493 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4969} = 1.04e+192
\end{equation}
