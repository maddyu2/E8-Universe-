...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7333
\end{equation}

Proof instance 3079 quantum parameter:
\begin{equation}
\hbar \omega_{3079} = 0.993458 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3079} = 8.83e+191
\end{equation}
