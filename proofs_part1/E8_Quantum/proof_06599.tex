...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0312
\end{equation}

Proof instance 6599 quantum parameter:
\begin{equation}
\hbar \omega_{6599} = 1.009067 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6599} = 1.04e+192
\end{equation}
