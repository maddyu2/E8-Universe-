...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0045
\end{equation}

Proof instance 3459 quantum parameter:
\begin{equation}
\hbar \omega_{3459} = 1.012266 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3459} = 9.68e+191
\end{equation}
