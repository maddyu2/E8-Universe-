...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1430
\end{equation}

Proof instance 7959 quantum parameter:
\begin{equation}
\hbar \omega_{7959} = 1.004921 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7959} = 1.02e+192
\end{equation}
