...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9845
\end{equation}

Proof instance 6479 quantum parameter:
\begin{equation}
\hbar \omega_{6479} = 1.002150 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6479} = 1.10e+192
\end{equation}
