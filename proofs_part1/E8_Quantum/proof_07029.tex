...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7601
\end{equation}

Proof instance 7029 quantum parameter:
\begin{equation}
\hbar \omega_{7029} = 0.985944 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7029} = 8.87e+191
\end{equation}
