...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5204
\end{equation}

Proof instance 9609 quantum parameter:
\begin{equation}
\hbar \omega_{9609} = 1.013985 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9609} = 1.09e+192
\end{equation}
