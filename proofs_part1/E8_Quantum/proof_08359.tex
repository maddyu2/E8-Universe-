...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8840
\end{equation}

Proof instance 8359 quantum parameter:
\begin{equation}
\hbar \omega_{8359} = 0.997677 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8359} = 8.64e+191
\end{equation}
