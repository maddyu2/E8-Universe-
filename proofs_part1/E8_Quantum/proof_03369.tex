...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4858
\end{equation}

Proof instance 3369 quantum parameter:
\begin{equation}
\hbar \omega_{3369} = 0.989431 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3369} = 8.52e+191
\end{equation}
