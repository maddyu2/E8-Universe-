...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7608
\end{equation}

Proof instance 7389 quantum parameter:
\begin{equation}
\hbar \omega_{7389} = 1.017431 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7389} = 9.53e+191
\end{equation}
