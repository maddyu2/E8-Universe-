...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7785
\end{equation}

Proof instance 1699 quantum parameter:
\begin{equation}
\hbar \omega_{1699} = 0.988726 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1699} = 9.14e+191
\end{equation}
