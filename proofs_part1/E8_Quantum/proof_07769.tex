...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2244
\end{equation}

Proof instance 7769 quantum parameter:
\begin{equation}
\hbar \omega_{7769} = 0.992683 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7769} = 1.03e+192
\end{equation}
