...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3700
\end{equation}

Proof instance 1979 quantum parameter:
\begin{equation}
\hbar \omega_{1979} = 1.007910 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1979} = 9.04e+191
\end{equation}
