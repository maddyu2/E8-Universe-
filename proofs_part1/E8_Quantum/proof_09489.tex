...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2729
\end{equation}

Proof instance 9489 quantum parameter:
\begin{equation}
\hbar \omega_{9489} = 0.995191 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9489} = 1.06e+192
\end{equation}
