...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8990
\end{equation}

Proof instance 7519 quantum parameter:
\begin{equation}
\hbar \omega_{7519} = 0.998760 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7519} = 9.00e+191
\end{equation}
