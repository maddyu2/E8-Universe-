...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9067
\end{equation}

Proof instance 8579 quantum parameter:
\begin{equation}
\hbar \omega_{8579} = 0.992771 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8579} = 9.95e+191
\end{equation}
