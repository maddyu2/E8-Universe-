...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1137
\end{equation}

Proof instance 9069 quantum parameter:
\begin{equation}
\hbar \omega_{9069} = 0.985098 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9069} = 9.92e+191
\end{equation}
