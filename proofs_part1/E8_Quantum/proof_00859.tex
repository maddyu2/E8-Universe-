...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9875
\end{equation}

Proof instance 859 quantum parameter:
\begin{equation}
\hbar \omega_{859} = 1.000507 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{859} = 9.70e+191
\end{equation}
