...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4191
\end{equation}

Proof instance 1589 quantum parameter:
\begin{equation}
\hbar \omega_{1589} = 0.990599 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1589} = 1.01e+192
\end{equation}
