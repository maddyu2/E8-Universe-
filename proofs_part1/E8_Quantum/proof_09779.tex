...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8705
\end{equation}

Proof instance 9779 quantum parameter:
\begin{equation}
\hbar \omega_{9779} = 0.989037 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9779} = 1.02e+192
\end{equation}
