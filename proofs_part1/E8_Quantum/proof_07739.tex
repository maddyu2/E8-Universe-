...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2392
\end{equation}

Proof instance 7739 quantum parameter:
\begin{equation}
\hbar \omega_{7739} = 1.016313 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7739} = 9.85e+191
\end{equation}
