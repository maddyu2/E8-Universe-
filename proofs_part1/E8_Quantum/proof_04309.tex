...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7993
\end{equation}

Proof instance 4309 quantum parameter:
\begin{equation}
\hbar \omega_{4309} = 1.013567 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4309} = 9.99e+191
\end{equation}
