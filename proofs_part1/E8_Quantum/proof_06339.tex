...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7450
\end{equation}

Proof instance 6339 quantum parameter:
\begin{equation}
\hbar \omega_{6339} = 1.002339 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6339} = 9.70e+191
\end{equation}
