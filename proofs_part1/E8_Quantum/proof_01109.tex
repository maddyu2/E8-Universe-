...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.0749
\end{equation}

Proof instance 1109 quantum parameter:
\begin{equation}
\hbar \omega_{1109} = 1.023406 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1109} = 9.17e+191
\end{equation}
