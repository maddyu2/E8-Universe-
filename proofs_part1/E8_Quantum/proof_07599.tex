...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.2944
\end{equation}

Proof instance 7599 quantum parameter:
\begin{equation}
\hbar \omega_{7599} = 0.979849 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7599} = 1.14e+192
\end{equation}
