...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5308
\end{equation}

Proof instance 6789 quantum parameter:
\begin{equation}
\hbar \omega_{6789} = 1.018050 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6789} = 1.16e+192
\end{equation}
