...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2408
\end{equation}

Proof instance 8369 quantum parameter:
\begin{equation}
\hbar \omega_{8369} = 0.991278 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8369} = 8.93e+191
\end{equation}
