...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3451
\end{equation}

Proof instance 6689 quantum parameter:
\begin{equation}
\hbar \omega_{6689} = 0.996261 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6689} = 1.22e+192
\end{equation}
