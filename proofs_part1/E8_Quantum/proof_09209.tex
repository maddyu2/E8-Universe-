...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5677
\end{equation}

Proof instance 9209 quantum parameter:
\begin{equation}
\hbar \omega_{9209} = 1.010382 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9209} = 1.02e+192
\end{equation}
