...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9958
\end{equation}

Proof instance 3869 quantum parameter:
\begin{equation}
\hbar \omega_{3869} = 0.997428 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3869} = 8.27e+191
\end{equation}
