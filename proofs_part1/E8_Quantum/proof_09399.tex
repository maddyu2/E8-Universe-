...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8961
\end{equation}

Proof instance 9399 quantum parameter:
\begin{equation}
\hbar \omega_{9399} = 1.001357 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9399} = 9.80e+191
\end{equation}
