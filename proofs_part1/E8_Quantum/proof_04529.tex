...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4903
\end{equation}

Proof instance 4529 quantum parameter:
\begin{equation}
\hbar \omega_{4529} = 0.999102 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4529} = 1.00e+192
\end{equation}
