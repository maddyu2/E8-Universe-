...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7103
\end{equation}

Proof instance 2159 quantum parameter:
\begin{equation}
\hbar \omega_{2159} = 1.011398 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2159} = 8.97e+191
\end{equation}
