...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4017
\end{equation}

Proof instance 409 quantum parameter:
\begin{equation}
\hbar \omega_{409} = 0.992306 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{409} = 1.03e+192
\end{equation}
