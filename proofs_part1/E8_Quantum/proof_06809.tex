...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4764
\end{equation}

Proof instance 6809 quantum parameter:
\begin{equation}
\hbar \omega_{6809} = 0.995864 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6809} = 1.03e+192
\end{equation}
