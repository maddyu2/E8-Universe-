...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8576
\end{equation}

Proof instance 9019 quantum parameter:
\begin{equation}
\hbar \omega_{9019} = 0.990946 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9019} = 9.39e+191
\end{equation}
