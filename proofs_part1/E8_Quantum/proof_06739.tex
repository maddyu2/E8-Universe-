...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8176
\end{equation}

Proof instance 6739 quantum parameter:
\begin{equation}
\hbar \omega_{6739} = 0.998395 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6739} = 9.27e+191
\end{equation}
