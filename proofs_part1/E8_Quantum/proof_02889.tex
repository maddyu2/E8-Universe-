...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8436
\end{equation}

Proof instance 2889 quantum parameter:
\begin{equation}
\hbar \omega_{2889} = 0.982345 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2889} = 1.02e+192
\end{equation}
