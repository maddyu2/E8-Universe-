...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9871
\end{equation}

Proof instance 9889 quantum parameter:
\begin{equation}
\hbar \omega_{9889} = 0.990204 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9889} = 1.02e+192
\end{equation}
