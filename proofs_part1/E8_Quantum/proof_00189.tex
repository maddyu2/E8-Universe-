...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9947
\end{equation}

Proof instance 189 quantum parameter:
\begin{equation}
\hbar \omega_{189} = 1.011893 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{189} = 8.12e+191
\end{equation}
