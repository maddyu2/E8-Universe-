...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7757
\end{equation}

Proof instance 2039 quantum parameter:
\begin{equation}
\hbar \omega_{2039} = 0.990638 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2039} = 9.37e+191
\end{equation}
