...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4653
\end{equation}

Proof instance 2619 quantum parameter:
\begin{equation}
\hbar \omega_{2619} = 0.999726 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2619} = 9.50e+191
\end{equation}
