...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5746
\end{equation}

Proof instance 4319 quantum parameter:
\begin{equation}
\hbar \omega_{4319} = 0.996560 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4319} = 1.11e+192
\end{equation}
