...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4595
\end{equation}

Proof instance 4539 quantum parameter:
\begin{equation}
\hbar \omega_{4539} = 0.981310 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4539} = 9.16e+191
\end{equation}
