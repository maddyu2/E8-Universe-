...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4256
\end{equation}

Proof instance 3199 quantum parameter:
\begin{equation}
\hbar \omega_{3199} = 0.978722 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3199} = 1.13e+192
\end{equation}
