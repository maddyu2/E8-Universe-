...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7826
\end{equation}

Proof instance 9679 quantum parameter:
\begin{equation}
\hbar \omega_{9679} = 1.009257 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9679} = 1.23e+192
\end{equation}
