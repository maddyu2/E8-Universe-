...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0379
\end{equation}

Proof instance 6259 quantum parameter:
\begin{equation}
\hbar \omega_{6259} = 1.000586 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6259} = 9.14e+191
\end{equation}
