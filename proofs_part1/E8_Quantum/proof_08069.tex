...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0712
\end{equation}

Proof instance 8069 quantum parameter:
\begin{equation}
\hbar \omega_{8069} = 0.992604 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8069} = 1.08e+192
\end{equation}
