...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3904
\end{equation}

Proof instance 6819 quantum parameter:
\begin{equation}
\hbar \omega_{6819} = 0.999112 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6819} = 1.08e+192
\end{equation}
