...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5543
\end{equation}

Proof instance 1149 quantum parameter:
\begin{equation}
\hbar \omega_{1149} = 0.992293 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1149} = 1.04e+192
\end{equation}
