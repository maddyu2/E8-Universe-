...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1450
\end{equation}

Proof instance 2099 quantum parameter:
\begin{equation}
\hbar \omega_{2099} = 1.004124 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2099} = 1.06e+192
\end{equation}
