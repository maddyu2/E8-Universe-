...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7170
\end{equation}

Proof instance 769 quantum parameter:
\begin{equation}
\hbar \omega_{769} = 0.989232 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{769} = 1.05e+192
\end{equation}
