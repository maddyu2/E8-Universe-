...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3826
\end{equation}

Proof instance 7569 quantum parameter:
\begin{equation}
\hbar \omega_{7569} = 0.998784 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7569} = 9.01e+191
\end{equation}
