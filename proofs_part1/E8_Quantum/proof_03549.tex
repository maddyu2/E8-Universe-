...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3193
\end{equation}

Proof instance 3549 quantum parameter:
\begin{equation}
\hbar \omega_{3549} = 1.012359 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3549} = 1.06e+192
\end{equation}
