...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7156
\end{equation}

Proof instance 1999 quantum parameter:
\begin{equation}
\hbar \omega_{1999} = 1.003933 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1999} = 9.68e+191
\end{equation}
