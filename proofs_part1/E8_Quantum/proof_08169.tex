...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1971
\end{equation}

Proof instance 8169 quantum parameter:
\begin{equation}
\hbar \omega_{8169} = 1.012985 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8169} = 1.11e+192
\end{equation}
