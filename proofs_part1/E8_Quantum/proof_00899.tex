...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0717
\end{equation}

Proof instance 899 quantum parameter:
\begin{equation}
\hbar \omega_{899} = 1.009444 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{899} = 9.22e+191
\end{equation}
