...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8547
\end{equation}

Proof instance 9569 quantum parameter:
\begin{equation}
\hbar \omega_{9569} = 1.000542 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9569} = 9.14e+191
\end{equation}
