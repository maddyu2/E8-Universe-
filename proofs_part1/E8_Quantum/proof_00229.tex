...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8690
\end{equation}

Proof instance 229 quantum parameter:
\begin{equation}
\hbar \omega_{229} = 1.008009 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{229} = 1.03e+192
\end{equation}
