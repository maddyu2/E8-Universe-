...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4342
\end{equation}

Proof instance 1099 quantum parameter:
\begin{equation}
\hbar \omega_{1099} = 0.990498 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1099} = 1.24e+192
\end{equation}
