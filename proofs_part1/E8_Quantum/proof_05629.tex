...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7842
\end{equation}

Proof instance 5629 quantum parameter:
\begin{equation}
\hbar \omega_{5629} = 1.003908 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5629} = 1.11e+192
\end{equation}
