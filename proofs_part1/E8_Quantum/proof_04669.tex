...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5526
\end{equation}

Proof instance 4669 quantum parameter:
\begin{equation}
\hbar \omega_{4669} = 1.008663 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4669} = 1.32e+192
\end{equation}
