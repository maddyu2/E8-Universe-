...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1230
\end{equation}

Proof instance 8279 quantum parameter:
\begin{equation}
\hbar \omega_{8279} = 1.008860 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8279} = 1.12e+192
\end{equation}
