...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5983
\end{equation}

Proof instance 2319 quantum parameter:
\begin{equation}
\hbar \omega_{2319} = 0.996592 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2319} = 9.92e+191
\end{equation}
