...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9802
\end{equation}

Proof instance 6179 quantum parameter:
\begin{equation}
\hbar \omega_{6179} = 1.000104 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6179} = 9.02e+191
\end{equation}
