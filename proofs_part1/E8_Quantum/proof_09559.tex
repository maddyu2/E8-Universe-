...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2899
\end{equation}

Proof instance 9559 quantum parameter:
\begin{equation}
\hbar \omega_{9559} = 0.981099 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9559} = 8.95e+191
\end{equation}
