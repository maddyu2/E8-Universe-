...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6912
\end{equation}

Proof instance 3899 quantum parameter:
\begin{equation}
\hbar \omega_{3899} = 1.000839 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3899} = 1.13e+192
\end{equation}
