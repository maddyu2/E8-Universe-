...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8641
\end{equation}

Proof instance 9859 quantum parameter:
\begin{equation}
\hbar \omega_{9859} = 0.982399 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9859} = 1.16e+192
\end{equation}
