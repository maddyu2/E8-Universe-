...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0762
\end{equation}

Proof instance 8129 quantum parameter:
\begin{equation}
\hbar \omega_{8129} = 1.003455 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8129} = 1.10e+192
\end{equation}
