...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5808
\end{equation}

Proof instance 5189 quantum parameter:
\begin{equation}
\hbar \omega_{5189} = 0.980965 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5189} = 1.02e+192
\end{equation}
