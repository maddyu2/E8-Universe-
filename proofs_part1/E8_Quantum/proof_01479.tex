...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1332
\end{equation}

Proof instance 1479 quantum parameter:
\begin{equation}
\hbar \omega_{1479} = 1.022834 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1479} = 9.85e+191
\end{equation}
