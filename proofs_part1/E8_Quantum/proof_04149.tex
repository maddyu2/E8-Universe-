...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7057
\end{equation}

Proof instance 4149 quantum parameter:
\begin{equation}
\hbar \omega_{4149} = 0.998042 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4149} = 7.29e+191
\end{equation}
