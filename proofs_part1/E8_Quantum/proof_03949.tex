...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2039
\end{equation}

Proof instance 3949 quantum parameter:
\begin{equation}
\hbar \omega_{3949} = 0.988549 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3949} = 1.02e+192
\end{equation}
