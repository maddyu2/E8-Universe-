...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0210
\end{equation}

Proof instance 6369 quantum parameter:
\begin{equation}
\hbar \omega_{6369} = 1.002529 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6369} = 1.07e+192
\end{equation}
