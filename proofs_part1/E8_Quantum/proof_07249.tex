...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2832
\end{equation}

Proof instance 7249 quantum parameter:
\begin{equation}
\hbar \omega_{7249} = 0.983902 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7249} = 1.14e+192
\end{equation}
