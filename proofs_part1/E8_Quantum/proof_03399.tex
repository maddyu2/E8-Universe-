...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9700
\end{equation}

Proof instance 3399 quantum parameter:
\begin{equation}
\hbar \omega_{3399} = 0.991027 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3399} = 1.05e+192
\end{equation}
