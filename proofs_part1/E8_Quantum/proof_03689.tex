...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2523
\end{equation}

Proof instance 3689 quantum parameter:
\begin{equation}
\hbar \omega_{3689} = 0.987524 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3689} = 1.13e+192
\end{equation}
