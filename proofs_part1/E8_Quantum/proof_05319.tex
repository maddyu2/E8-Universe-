...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8697
\end{equation}

Proof instance 5319 quantum parameter:
\begin{equation}
\hbar \omega_{5319} = 0.982177 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5319} = 1.07e+192
\end{equation}
