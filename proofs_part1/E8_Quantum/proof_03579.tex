...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6561
\end{equation}

Proof instance 3579 quantum parameter:
\begin{equation}
\hbar \omega_{3579} = 1.003427 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3579} = 1.08e+192
\end{equation}
