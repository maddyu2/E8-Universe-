...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6519
\end{equation}

Proof instance 9669 quantum parameter:
\begin{equation}
\hbar \omega_{9669} = 1.011823 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9669} = 9.50e+191
\end{equation}
