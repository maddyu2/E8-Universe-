...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7339
\end{equation}

Proof instance 5329 quantum parameter:
\begin{equation}
\hbar \omega_{5329} = 0.994724 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5329} = 9.36e+191
\end{equation}
