...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9776
\end{equation}

Proof instance 6719 quantum parameter:
\begin{equation}
\hbar \omega_{6719} = 0.982584 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6719} = 9.48e+191
\end{equation}
