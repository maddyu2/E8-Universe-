...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0464
\end{equation}

Proof instance 4809 quantum parameter:
\begin{equation}
\hbar \omega_{4809} = 1.005136 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4809} = 1.00e+192
\end{equation}
