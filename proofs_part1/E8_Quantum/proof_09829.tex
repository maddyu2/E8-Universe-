...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8114
\end{equation}

Proof instance 9829 quantum parameter:
\begin{equation}
\hbar \omega_{9829} = 1.021005 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9829} = 1.06e+192
\end{equation}
