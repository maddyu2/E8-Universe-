...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1533
\end{equation}

Proof instance 4819 quantum parameter:
\begin{equation}
\hbar \omega_{4819} = 1.000628 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4819} = 9.39e+191
\end{equation}
