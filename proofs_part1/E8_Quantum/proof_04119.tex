...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9952
\end{equation}

Proof instance 4119 quantum parameter:
\begin{equation}
\hbar \omega_{4119} = 0.991782 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4119} = 1.02e+192
\end{equation}
