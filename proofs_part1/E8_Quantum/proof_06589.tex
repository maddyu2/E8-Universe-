...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7447
\end{equation}

Proof instance 6589 quantum parameter:
\begin{equation}
\hbar \omega_{6589} = 0.987474 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6589} = 1.04e+192
\end{equation}
