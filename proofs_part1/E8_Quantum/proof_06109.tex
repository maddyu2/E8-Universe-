...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.6384
\end{equation}

Proof instance 6109 quantum parameter:
\begin{equation}
\hbar \omega_{6109} = 1.020088 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6109} = 1.00e+192
\end{equation}
