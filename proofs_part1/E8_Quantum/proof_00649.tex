...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7917
\end{equation}

Proof instance 649 quantum parameter:
\begin{equation}
\hbar \omega_{649} = 0.991075 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{649} = 1.04e+192
\end{equation}
