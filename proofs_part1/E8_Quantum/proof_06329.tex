...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0911
\end{equation}

Proof instance 6329 quantum parameter:
\begin{equation}
\hbar \omega_{6329} = 1.002183 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6329} = 9.00e+191
\end{equation}
