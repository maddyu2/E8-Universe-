...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.3098
\end{equation}

Proof instance 3799 quantum parameter:
\begin{equation}
\hbar \omega_{3799} = 1.000805 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3799} = 9.08e+191
\end{equation}
