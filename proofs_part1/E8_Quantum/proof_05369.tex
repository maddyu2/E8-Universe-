...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7352
\end{equation}

Proof instance 5369 quantum parameter:
\begin{equation}
\hbar \omega_{5369} = 1.004193 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5369} = 1.16e+192
\end{equation}
