...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3076
\end{equation}

Proof instance 5679 quantum parameter:
\begin{equation}
\hbar \omega_{5679} = 1.013435 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5679} = 9.05e+191
\end{equation}
