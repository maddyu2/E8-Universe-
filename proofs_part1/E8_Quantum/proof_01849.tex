...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1097
\end{equation}

Proof instance 1849 quantum parameter:
\begin{equation}
\hbar \omega_{1849} = 0.999405 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1849} = 1.03e+192
\end{equation}
