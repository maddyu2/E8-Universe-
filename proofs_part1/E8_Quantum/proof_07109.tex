...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5600
\end{equation}

Proof instance 7109 quantum parameter:
\begin{equation}
\hbar \omega_{7109} = 1.011840 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7109} = 9.72e+191
\end{equation}
