...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2035
\end{equation}

Proof instance 4459 quantum parameter:
\begin{equation}
\hbar \omega_{4459} = 1.000837 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4459} = 1.03e+192
\end{equation}
