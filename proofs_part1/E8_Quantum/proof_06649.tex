...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7374
\end{equation}

Proof instance 6649 quantum parameter:
\begin{equation}
\hbar \omega_{6649} = 1.023891 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6649} = 8.88e+191
\end{equation}
