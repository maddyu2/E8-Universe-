...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0456
\end{equation}

Proof instance 8419 quantum parameter:
\begin{equation}
\hbar \omega_{8419} = 0.996659 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8419} = 9.54e+191
\end{equation}
