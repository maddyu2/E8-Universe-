...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8714
\end{equation}

Proof instance 3649 quantum parameter:
\begin{equation}
\hbar \omega_{3649} = 1.008798 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3649} = 1.03e+192
\end{equation}
