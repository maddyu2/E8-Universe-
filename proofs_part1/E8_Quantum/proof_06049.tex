...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6846
\end{equation}

Proof instance 6049 quantum parameter:
\begin{equation}
\hbar \omega_{6049} = 0.994078 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6049} = 1.02e+192
\end{equation}
