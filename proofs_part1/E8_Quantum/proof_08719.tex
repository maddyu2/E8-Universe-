...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7358
\end{equation}

Proof instance 8719 quantum parameter:
\begin{equation}
\hbar \omega_{8719} = 0.999850 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8719} = 1.04e+192
\end{equation}
