...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6822
\end{equation}

Proof instance 1659 quantum parameter:
\begin{equation}
\hbar \omega_{1659} = 0.977497 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1659} = 1.02e+192
\end{equation}
