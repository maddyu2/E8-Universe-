...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6270
\end{equation}

Proof instance 8389 quantum parameter:
\begin{equation}
\hbar \omega_{8389} = 1.007353 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8389} = 1.17e+192
\end{equation}
