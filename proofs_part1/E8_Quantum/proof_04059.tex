...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1040
\end{equation}

Proof instance 4059 quantum parameter:
\begin{equation}
\hbar \omega_{4059} = 0.985064 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4059} = 9.04e+191
\end{equation}
