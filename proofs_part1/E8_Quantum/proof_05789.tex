...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2565
\end{equation}

Proof instance 5789 quantum parameter:
\begin{equation}
\hbar \omega_{5789} = 1.028488 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5789} = 1.10e+192
\end{equation}
