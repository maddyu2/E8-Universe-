...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8234
\end{equation}

Proof instance 2769 quantum parameter:
\begin{equation}
\hbar \omega_{2769} = 0.999351 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2769} = 9.68e+191
\end{equation}
