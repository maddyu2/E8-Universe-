...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2602
\end{equation}

Proof instance 3069 quantum parameter:
\begin{equation}
\hbar \omega_{3069} = 1.001968 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3069} = 9.55e+191
\end{equation}
