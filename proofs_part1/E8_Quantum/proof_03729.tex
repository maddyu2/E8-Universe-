...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1931
\end{equation}

Proof instance 3729 quantum parameter:
\begin{equation}
\hbar \omega_{3729} = 0.999927 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3729} = 9.33e+191
\end{equation}
