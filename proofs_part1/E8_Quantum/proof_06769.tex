...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1460
\end{equation}

Proof instance 6769 quantum parameter:
\begin{equation}
\hbar \omega_{6769} = 1.004454 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6769} = 9.32e+191
\end{equation}
