...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7842
\end{equation}

Proof instance 4239 quantum parameter:
\begin{equation}
\hbar \omega_{4239} = 1.004260 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4239} = 1.11e+192
\end{equation}
