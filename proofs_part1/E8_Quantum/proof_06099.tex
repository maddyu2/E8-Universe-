...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5565
\end{equation}

Proof instance 6099 quantum parameter:
\begin{equation}
\hbar \omega_{6099} = 1.000896 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6099} = 9.76e+191
\end{equation}
