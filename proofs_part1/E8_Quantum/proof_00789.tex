...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5228
\end{equation}

Proof instance 789 quantum parameter:
\begin{equation}
\hbar \omega_{789} = 1.012344 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{789} = 8.89e+191
\end{equation}
