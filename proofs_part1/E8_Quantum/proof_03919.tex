...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4311
\end{equation}

Proof instance 3919 quantum parameter:
\begin{equation}
\hbar \omega_{3919} = 1.002607 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3919} = 1.04e+192
\end{equation}
