...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3781
\end{equation}

Proof instance 6399 quantum parameter:
\begin{equation}
\hbar \omega_{6399} = 0.998761 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6399} = 9.28e+191
\end{equation}
