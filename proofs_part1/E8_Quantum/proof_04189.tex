...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3624
\end{equation}

Proof instance 4189 quantum parameter:
\begin{equation}
\hbar \omega_{4189} = 0.994303 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4189} = 9.69e+191
\end{equation}
