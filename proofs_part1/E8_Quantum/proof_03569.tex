...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.0334
\end{equation}

Proof instance 3569 quantum parameter:
\begin{equation}
\hbar \omega_{3569} = 1.011296 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3569} = 8.08e+191
\end{equation}
