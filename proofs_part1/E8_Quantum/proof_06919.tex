...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5347
\end{equation}

Proof instance 6919 quantum parameter:
\begin{equation}
\hbar \omega_{6919} = 1.015521 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6919} = 1.04e+192
\end{equation}
