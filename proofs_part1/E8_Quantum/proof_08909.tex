...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3287
\end{equation}

Proof instance 8909 quantum parameter:
\begin{equation}
\hbar \omega_{8909} = 1.009726 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8909} = 9.26e+191
\end{equation}
