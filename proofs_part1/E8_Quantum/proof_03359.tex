...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9296
\end{equation}

Proof instance 3359 quantum parameter:
\begin{equation}
\hbar \omega_{3359} = 0.995021 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3359} = 1.01e+192
\end{equation}
