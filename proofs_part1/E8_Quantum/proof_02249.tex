...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.4472
\end{equation}

Proof instance 2249 quantum parameter:
\begin{equation}
\hbar \omega_{2249} = 1.018306 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2249} = 1.04e+192
\end{equation}
