...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5592
\end{equation}

Proof instance 8109 quantum parameter:
\begin{equation}
\hbar \omega_{8109} = 0.994401 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8109} = 9.94e+191
\end{equation}
