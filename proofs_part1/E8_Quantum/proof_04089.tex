...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2889
\end{equation}

Proof instance 4089 quantum parameter:
\begin{equation}
\hbar \omega_{4089} = 1.016592 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4089} = 1.09e+192
\end{equation}
