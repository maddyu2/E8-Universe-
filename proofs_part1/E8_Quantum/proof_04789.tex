...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7506
\end{equation}

Proof instance 4789 quantum parameter:
\begin{equation}
\hbar \omega_{4789} = 1.016137 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4789} = 1.18e+192
\end{equation}
