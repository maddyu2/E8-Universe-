...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.0534
\end{equation}

Proof instance 7299 quantum parameter:
\begin{equation}
\hbar \omega_{7299} = 0.988727 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7299} = 9.75e+191
\end{equation}
