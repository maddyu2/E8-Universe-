...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5969
\end{equation}

Proof instance 9949 quantum parameter:
\begin{equation}
\hbar \omega_{9949} = 1.011654 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9949} = 9.67e+191
\end{equation}
