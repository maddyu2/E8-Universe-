...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3160
\end{equation}

Proof instance 4879 quantum parameter:
\begin{equation}
\hbar \omega_{4879} = 1.006388 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4879} = 1.11e+192
\end{equation}
