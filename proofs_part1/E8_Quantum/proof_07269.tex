...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5056
\end{equation}

Proof instance 7269 quantum parameter:
\begin{equation}
\hbar \omega_{7269} = 0.985530 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7269} = 1.10e+192
\end{equation}
