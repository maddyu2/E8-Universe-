...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4801
\end{equation}

Proof instance 4729 quantum parameter:
\begin{equation}
\hbar \omega_{4729} = 0.991197 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4729} = 9.85e+191
\end{equation}
