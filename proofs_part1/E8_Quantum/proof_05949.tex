...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0285
\end{equation}

Proof instance 5949 quantum parameter:
\begin{equation}
\hbar \omega_{5949} = 0.993271 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5949} = 8.46e+191
\end{equation}
