...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1783
\end{equation}

Proof instance 4229 quantum parameter:
\begin{equation}
\hbar \omega_{4229} = 0.987374 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4229} = 1.09e+192
\end{equation}
