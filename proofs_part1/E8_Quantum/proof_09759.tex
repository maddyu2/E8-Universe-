...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2410
\end{equation}

Proof instance 9759 quantum parameter:
\begin{equation}
\hbar \omega_{9759} = 1.018981 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9759} = 1.13e+192
\end{equation}
