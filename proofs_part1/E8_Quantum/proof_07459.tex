...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1755
\end{equation}

Proof instance 7459 quantum parameter:
\begin{equation}
\hbar \omega_{7459} = 1.005273 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7459} = 9.56e+191
\end{equation}
