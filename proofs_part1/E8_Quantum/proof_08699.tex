...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9823
\end{equation}

Proof instance 8699 quantum parameter:
\begin{equation}
\hbar \omega_{8699} = 1.001160 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8699} = 1.00e+192
\end{equation}
