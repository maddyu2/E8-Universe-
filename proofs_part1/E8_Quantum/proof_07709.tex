...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2945
\end{equation}

Proof instance 7709 quantum parameter:
\begin{equation}
\hbar \omega_{7709} = 0.986913 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7709} = 1.01e+192
\end{equation}
