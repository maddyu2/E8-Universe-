...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0111
\end{equation}

Proof instance 4759 quantum parameter:
\begin{equation}
\hbar \omega_{4759} = 1.014623 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4759} = 9.45e+191
\end{equation}
