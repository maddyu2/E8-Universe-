...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2993
\end{equation}

Proof instance 4349 quantum parameter:
\begin{equation}
\hbar \omega_{4349} = 0.998758 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4349} = 9.24e+191
\end{equation}
