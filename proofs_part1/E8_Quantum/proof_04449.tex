...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8014
\end{equation}

Proof instance 4449 quantum parameter:
\begin{equation}
\hbar \omega_{4449} = 1.008622 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4449} = 1.02e+192
\end{equation}
