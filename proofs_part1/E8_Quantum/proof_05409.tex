...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7509
\end{equation}

Proof instance 5409 quantum parameter:
\begin{equation}
\hbar \omega_{5409} = 1.003205 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5409} = 1.28e+192
\end{equation}
