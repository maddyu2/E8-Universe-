...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2695
\end{equation}

Proof instance 9059 quantum parameter:
\begin{equation}
\hbar \omega_{9059} = 0.995017 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9059} = 9.83e+191
\end{equation}
