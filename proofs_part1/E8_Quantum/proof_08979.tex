...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9152
\end{equation}

Proof instance 8979 quantum parameter:
\begin{equation}
\hbar \omega_{8979} = 1.011170 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8979} = 1.03e+192
\end{equation}
