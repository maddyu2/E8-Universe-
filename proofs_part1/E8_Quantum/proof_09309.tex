...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5259
\end{equation}

Proof instance 9309 quantum parameter:
\begin{equation}
\hbar \omega_{9309} = 1.011065 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9309} = 1.00e+192
\end{equation}
