...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2796
\end{equation}

Proof instance 489 quantum parameter:
\begin{equation}
\hbar \omega_{489} = 1.018270 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{489} = 1.15e+192
\end{equation}
