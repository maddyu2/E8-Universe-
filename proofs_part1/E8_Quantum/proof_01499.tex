...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3220
\end{equation}

Proof instance 1499 quantum parameter:
\begin{equation}
\hbar \omega_{1499} = 1.002619 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1499} = 9.57e+191
\end{equation}
