...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3258
\end{equation}

Proof instance 179 quantum parameter:
\begin{equation}
\hbar \omega_{179} = 1.004205 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{179} = 9.93e+191
\end{equation}
