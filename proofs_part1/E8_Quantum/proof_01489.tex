...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7086
\end{equation}

Proof instance 1489 quantum parameter:
\begin{equation}
\hbar \omega_{1489} = 0.997724 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1489} = 1.08e+192
\end{equation}
