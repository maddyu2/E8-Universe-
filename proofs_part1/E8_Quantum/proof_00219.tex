...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2593
\end{equation}

Proof instance 219 quantum parameter:
\begin{equation}
\hbar \omega_{219} = 1.005307 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{219} = 9.43e+191
\end{equation}
