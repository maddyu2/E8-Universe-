...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7671
\end{equation}

Proof instance 2669 quantum parameter:
\begin{equation}
\hbar \omega_{2669} = 0.973929 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2669} = 1.14e+192
\end{equation}
