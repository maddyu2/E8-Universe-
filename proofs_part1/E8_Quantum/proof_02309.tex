...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5700
\end{equation}

Proof instance 2309 quantum parameter:
\begin{equation}
\hbar \omega_{2309} = 0.990309 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2309} = 9.75e+191
\end{equation}
