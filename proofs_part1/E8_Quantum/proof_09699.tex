...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4717
\end{equation}

Proof instance 9699 quantum parameter:
\begin{equation}
\hbar \omega_{9699} = 0.992197 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9699} = 1.13e+192
\end{equation}
