...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5842
\end{equation}

Proof instance 8659 quantum parameter:
\begin{equation}
\hbar \omega_{8659} = 1.003702 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8659} = 9.35e+191
\end{equation}
