...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3215
\end{equation}

Proof instance 7129 quantum parameter:
\begin{equation}
\hbar \omega_{7129} = 1.018337 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7129} = 1.07e+192
\end{equation}
