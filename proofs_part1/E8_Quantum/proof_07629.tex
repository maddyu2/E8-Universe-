...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.9580
\end{equation}

Proof instance 7629 quantum parameter:
\begin{equation}
\hbar \omega_{7629} = 0.996081 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7629} = 6.81e+191
\end{equation}
