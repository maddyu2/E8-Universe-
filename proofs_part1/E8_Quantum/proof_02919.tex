...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3425
\end{equation}

Proof instance 2919 quantum parameter:
\begin{equation}
\hbar \omega_{2919} = 0.989457 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2919} = 9.82e+191
\end{equation}
