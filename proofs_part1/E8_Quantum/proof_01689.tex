...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8480
\end{equation}

Proof instance 1689 quantum parameter:
\begin{equation}
\hbar \omega_{1689} = 1.014433 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1689} = 9.47e+191
\end{equation}
