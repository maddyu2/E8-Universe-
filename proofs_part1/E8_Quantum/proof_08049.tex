...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9337
\end{equation}

Proof instance 8049 quantum parameter:
\begin{equation}
\hbar \omega_{8049} = 1.003026 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8049} = 1.12e+192
\end{equation}
