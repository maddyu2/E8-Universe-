...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2742
\end{equation}

Proof instance 9029 quantum parameter:
\begin{equation}
\hbar \omega_{9029} = 0.998370 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9029} = 1.21e+192
\end{equation}
