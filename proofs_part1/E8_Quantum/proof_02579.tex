...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8187
\end{equation}

Proof instance 2579 quantum parameter:
\begin{equation}
\hbar \omega_{2579} = 0.998491 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2579} = 9.72e+191
\end{equation}
