...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.6340
\end{equation}

Proof instance 6349 quantum parameter:
\begin{equation}
\hbar \omega_{6349} = 0.980163 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6349} = 9.79e+191
\end{equation}
