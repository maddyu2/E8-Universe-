...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6387
\end{equation}

Proof instance 6429 quantum parameter:
\begin{equation}
\hbar \omega_{6429} = 1.001385 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6429} = 9.75e+191
\end{equation}
