...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2512
\end{equation}

Proof instance 5419 quantum parameter:
\begin{equation}
\hbar \omega_{5419} = 1.004286 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5419} = 1.10e+192
\end{equation}
