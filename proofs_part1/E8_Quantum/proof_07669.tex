...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5206
\end{equation}

Proof instance 7669 quantum parameter:
\begin{equation}
\hbar \omega_{7669} = 0.995062 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7669} = 1.04e+192
\end{equation}
