...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9801
\end{equation}

Proof instance 7859 quantum parameter:
\begin{equation}
\hbar \omega_{7859} = 1.005089 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7859} = 9.31e+191
\end{equation}
