...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9774
\end{equation}

Proof instance 2609 quantum parameter:
\begin{equation}
\hbar \omega_{2609} = 1.003835 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2609} = 1.24e+192
\end{equation}
