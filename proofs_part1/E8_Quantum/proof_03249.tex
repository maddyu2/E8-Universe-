...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8762
\end{equation}

Proof instance 3249 quantum parameter:
\begin{equation}
\hbar \omega_{3249} = 0.988887 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3249} = 1.20e+192
\end{equation}
