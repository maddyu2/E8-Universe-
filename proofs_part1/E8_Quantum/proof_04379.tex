...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3664
\end{equation}

Proof instance 4379 quantum parameter:
\begin{equation}
\hbar \omega_{4379} = 1.009823 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4379} = 8.49e+191
\end{equation}
