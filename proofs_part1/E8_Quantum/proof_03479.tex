...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4123
\end{equation}

Proof instance 3479 quantum parameter:
\begin{equation}
\hbar \omega_{3479} = 0.985650 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3479} = 1.07e+192
\end{equation}
