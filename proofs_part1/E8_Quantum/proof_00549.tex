...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9651
\end{equation}

Proof instance 549 quantum parameter:
\begin{equation}
\hbar \omega_{549} = 1.008227 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{549} = 9.87e+191
\end{equation}
