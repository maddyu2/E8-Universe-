...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4081
\end{equation}

Proof instance 6889 quantum parameter:
\begin{equation}
\hbar \omega_{6889} = 0.997789 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6889} = 1.18e+192
\end{equation}
