...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2182
\end{equation}

Proof instance 6729 quantum parameter:
\begin{equation}
\hbar \omega_{6729} = 1.021546 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6729} = 1.16e+192
\end{equation}
