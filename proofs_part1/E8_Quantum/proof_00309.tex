...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9462
\end{equation}

Proof instance 309 quantum parameter:
\begin{equation}
\hbar \omega_{309} = 1.013930 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{309} = 1.06e+192
\end{equation}
