...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.7222
\end{equation}

Proof instance 5699 quantum parameter:
\begin{equation}
\hbar \omega_{5699} = 0.983945 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5699} = 1.07e+192
\end{equation}
