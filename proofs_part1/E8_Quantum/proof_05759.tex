...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9481
\end{equation}

Proof instance 5759 quantum parameter:
\begin{equation}
\hbar \omega_{5759} = 1.003294 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5759} = 1.10e+192
\end{equation}
