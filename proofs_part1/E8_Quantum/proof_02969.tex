...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8041
\end{equation}

Proof instance 2969 quantum parameter:
\begin{equation}
\hbar \omega_{2969} = 0.993188 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2969} = 9.48e+191
\end{equation}
