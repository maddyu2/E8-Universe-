...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5297
\end{equation}

Proof instance 3999 quantum parameter:
\begin{equation}
\hbar \omega_{3999} = 1.017615 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3999} = 9.23e+191
\end{equation}
