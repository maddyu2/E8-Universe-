...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4192
\end{equation}

Proof instance 8789 quantum parameter:
\begin{equation}
\hbar \omega_{8789} = 1.009714 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8789} = 9.69e+191
\end{equation}
