...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8965
\end{equation}

Proof instance 8809 quantum parameter:
\begin{equation}
\hbar \omega_{8809} = 0.979125 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8809} = 9.84e+191
\end{equation}
