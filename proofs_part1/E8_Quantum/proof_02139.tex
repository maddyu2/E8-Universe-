...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3262
\end{equation}

Proof instance 2139 quantum parameter:
\begin{equation}
\hbar \omega_{2139} = 0.997144 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2139} = 9.60e+191
\end{equation}
