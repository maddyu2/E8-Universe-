...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5791
\end{equation}

Proof instance 7009 quantum parameter:
\begin{equation}
\hbar \omega_{7009} = 0.984930 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7009} = 1.11e+192
\end{equation}
