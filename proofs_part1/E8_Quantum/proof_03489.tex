...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7276
\end{equation}

Proof instance 3489 quantum parameter:
\begin{equation}
\hbar \omega_{3489} = 0.994731 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3489} = 1.07e+192
\end{equation}
