...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3398
\end{equation}

Proof instance 1179 quantum parameter:
\begin{equation}
\hbar \omega_{1179} = 0.985511 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1179} = 1.15e+192
\end{equation}
