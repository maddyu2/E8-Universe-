...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3274
\end{equation}

Proof instance 3409 quantum parameter:
\begin{equation}
\hbar \omega_{3409} = 0.998025 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3409} = 1.17e+192
\end{equation}
