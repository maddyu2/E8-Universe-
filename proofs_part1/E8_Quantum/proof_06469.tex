...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3212
\end{equation}

Proof instance 6469 quantum parameter:
\begin{equation}
\hbar \omega_{6469} = 0.994172 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6469} = 9.35e+191
\end{equation}
