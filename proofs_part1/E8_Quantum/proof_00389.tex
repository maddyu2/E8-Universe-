...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7108
\end{equation}

Proof instance 389 quantum parameter:
\begin{equation}
\hbar \omega_{389} = 0.984751 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{389} = 1.03e+192
\end{equation}
