...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1232
\end{equation}

Proof instance 509 quantum parameter:
\begin{equation}
\hbar \omega_{509} = 1.014753 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{509} = 9.19e+191
\end{equation}
