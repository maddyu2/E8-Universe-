...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8631
\end{equation}

Proof instance 3089 quantum parameter:
\begin{equation}
\hbar \omega_{3089} = 1.002047 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3089} = 8.83e+191
\end{equation}
