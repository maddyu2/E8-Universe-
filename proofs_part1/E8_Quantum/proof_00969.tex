...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5505
\end{equation}

Proof instance 969 quantum parameter:
\begin{equation}
\hbar \omega_{969} = 0.990570 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{969} = 9.12e+191
\end{equation}
