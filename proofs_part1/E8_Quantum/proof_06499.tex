...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5124
\end{equation}

Proof instance 6499 quantum parameter:
\begin{equation}
\hbar \omega_{6499} = 1.003214 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6499} = 9.38e+191
\end{equation}
