...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1777
\end{equation}

Proof instance 9799 quantum parameter:
\begin{equation}
\hbar \omega_{9799} = 0.983428 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9799} = 1.09e+192
\end{equation}
