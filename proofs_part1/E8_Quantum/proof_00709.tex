...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9783
\end{equation}

Proof instance 709 quantum parameter:
\begin{equation}
\hbar \omega_{709} = 0.998373 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{709} = 1.03e+192
\end{equation}
