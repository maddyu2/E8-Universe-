...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.3924
\end{equation}

Proof instance 1619 quantum parameter:
\begin{equation}
\hbar \omega_{1619} = 0.993938 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1619} = 9.07e+191
\end{equation}
