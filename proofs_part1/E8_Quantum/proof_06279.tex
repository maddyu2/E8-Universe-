...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5692
\end{equation}

Proof instance 6279 quantum parameter:
\begin{equation}
\hbar \omega_{6279} = 0.980985 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6279} = 8.55e+191
\end{equation}
