...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9931
\end{equation}

Proof instance 5579 quantum parameter:
\begin{equation}
\hbar \omega_{5579} = 1.005692 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5579} = 1.17e+192
\end{equation}
