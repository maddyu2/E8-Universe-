...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5062
\end{equation}

Proof instance 4009 quantum parameter:
\begin{equation}
\hbar \omega_{4009} = 1.013109 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4009} = 1.02e+192
\end{equation}
