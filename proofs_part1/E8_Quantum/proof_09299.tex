...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9372
\end{equation}

Proof instance 9299 quantum parameter:
\begin{equation}
\hbar \omega_{9299} = 1.006678 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9299} = 9.57e+191
\end{equation}
