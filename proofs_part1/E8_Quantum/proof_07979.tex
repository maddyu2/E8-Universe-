...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2263
\end{equation}

Proof instance 7979 quantum parameter:
\begin{equation}
\hbar \omega_{7979} = 0.997971 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7979} = 8.77e+191
\end{equation}
