...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6459
\end{equation}

Proof instance 4829 quantum parameter:
\begin{equation}
\hbar \omega_{4829} = 1.003687 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4829} = 9.13e+191
\end{equation}
