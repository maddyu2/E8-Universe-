...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4164
\end{equation}

Proof instance 3339 quantum parameter:
\begin{equation}
\hbar \omega_{3339} = 1.001230 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3339} = 9.89e+191
\end{equation}
