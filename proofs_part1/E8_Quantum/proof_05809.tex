...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9919
\end{equation}

Proof instance 5809 quantum parameter:
\begin{equation}
\hbar \omega_{5809} = 0.986312 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5809} = 9.86e+191
\end{equation}
