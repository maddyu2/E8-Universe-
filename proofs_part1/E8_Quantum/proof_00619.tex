...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2761
\end{equation}

Proof instance 619 quantum parameter:
\begin{equation}
\hbar \omega_{619} = 0.991806 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{619} = 1.06e+192
\end{equation}
