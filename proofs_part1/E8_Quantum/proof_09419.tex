...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5244
\end{equation}

Proof instance 9419 quantum parameter:
\begin{equation}
\hbar \omega_{9419} = 1.005902 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9419} = 1.08e+192
\end{equation}
