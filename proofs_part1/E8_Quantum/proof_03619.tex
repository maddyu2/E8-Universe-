...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0348
\end{equation}

Proof instance 3619 quantum parameter:
\begin{equation}
\hbar \omega_{3619} = 1.010310 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3619} = 1.01e+192
\end{equation}
