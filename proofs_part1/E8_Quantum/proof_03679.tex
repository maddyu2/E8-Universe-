...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8118
\end{equation}

Proof instance 3679 quantum parameter:
\begin{equation}
\hbar \omega_{3679} = 1.026190 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3679} = 1.02e+192
\end{equation}
