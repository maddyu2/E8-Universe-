...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5575
\end{equation}

Proof instance 4499 quantum parameter:
\begin{equation}
\hbar \omega_{4499} = 0.997907 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4499} = 9.93e+191
\end{equation}
