...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2499
\end{equation}

Proof instance 4749 quantum parameter:
\begin{equation}
\hbar \omega_{4749} = 1.005561 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4749} = 1.03e+192
\end{equation}
