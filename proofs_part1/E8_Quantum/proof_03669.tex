...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4570
\end{equation}

Proof instance 3669 quantum parameter:
\begin{equation}
\hbar \omega_{3669} = 0.995157 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3669} = 9.21e+191
\end{equation}
