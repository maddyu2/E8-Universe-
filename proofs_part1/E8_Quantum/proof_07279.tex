...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7122
\end{equation}

Proof instance 7279 quantum parameter:
\begin{equation}
\hbar \omega_{7279} = 1.004234 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7279} = 7.96e+191
\end{equation}
