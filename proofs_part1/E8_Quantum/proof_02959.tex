...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8478
\end{equation}

Proof instance 2959 quantum parameter:
\begin{equation}
\hbar \omega_{2959} = 0.987495 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2959} = 8.73e+191
\end{equation}
