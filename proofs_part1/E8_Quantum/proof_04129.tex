...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0947
\end{equation}

Proof instance 4129 quantum parameter:
\begin{equation}
\hbar \omega_{4129} = 1.008085 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4129} = 1.04e+192
\end{equation}
