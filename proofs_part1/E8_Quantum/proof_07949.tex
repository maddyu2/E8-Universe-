...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2135
\end{equation}

Proof instance 7949 quantum parameter:
\begin{equation}
\hbar \omega_{7949} = 0.992875 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7949} = 1.17e+192
\end{equation}
