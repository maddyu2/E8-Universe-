...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4216
\end{equation}

Proof instance 169 quantum parameter:
\begin{equation}
\hbar \omega_{169} = 1.002304 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{169} = 1.07e+192
\end{equation}
