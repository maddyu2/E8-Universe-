...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1466
\end{equation}

Proof instance 5219 quantum parameter:
\begin{equation}
\hbar \omega_{5219} = 0.995233 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5219} = 7.23e+191
\end{equation}
