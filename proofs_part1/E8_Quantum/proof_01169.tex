...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9877
\end{equation}

Proof instance 1169 quantum parameter:
\begin{equation}
\hbar \omega_{1169} = 1.011051 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1169} = 1.02e+192
\end{equation}
