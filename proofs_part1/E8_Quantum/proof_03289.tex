...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6684
\end{equation}

Proof instance 3289 quantum parameter:
\begin{equation}
\hbar \omega_{3289} = 1.020350 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3289} = 9.63e+191
\end{equation}
