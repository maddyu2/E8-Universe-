...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2451
\end{equation}

Proof instance 1599 quantum parameter:
\begin{equation}
\hbar \omega_{1599} = 0.993056 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1599} = 9.15e+191
\end{equation}
