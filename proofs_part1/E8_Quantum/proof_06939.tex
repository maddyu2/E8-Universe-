...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7884
\end{equation}

Proof instance 6939 quantum parameter:
\begin{equation}
\hbar \omega_{6939} = 0.980622 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6939} = 1.09e+192
\end{equation}
