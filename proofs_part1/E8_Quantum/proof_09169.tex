...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.9438
\end{equation}

Proof instance 9169 quantum parameter:
\begin{equation}
\hbar \omega_{9169} = 0.989641 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9169} = 9.65e+191
\end{equation}
