...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5212
\end{equation}

Proof instance 7349 quantum parameter:
\begin{equation}
\hbar \omega_{7349} = 0.986777 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7349} = 1.01e+192
\end{equation}
