...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0383
\end{equation}

Proof instance 7199 quantum parameter:
\begin{equation}
\hbar \omega_{7199} = 1.009902 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7199} = 1.06e+192
\end{equation}
