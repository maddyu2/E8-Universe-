...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8511
\end{equation}

Proof instance 9459 quantum parameter:
\begin{equation}
\hbar \omega_{9459} = 0.997199 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9459} = 1.09e+192
\end{equation}
