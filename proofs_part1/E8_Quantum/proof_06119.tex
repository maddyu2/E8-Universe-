...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0222
\end{equation}

Proof instance 6119 quantum parameter:
\begin{equation}
\hbar \omega_{6119} = 1.005623 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6119} = 8.67e+191
\end{equation}
