...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2747
\end{equation}

Proof instance 4649 quantum parameter:
\begin{equation}
\hbar \omega_{4649} = 1.008502 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4649} = 9.26e+191
\end{equation}
