...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5008
\end{equation}

Proof instance 919 quantum parameter:
\begin{equation}
\hbar \omega_{919} = 1.002037 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{919} = 8.74e+191
\end{equation}
