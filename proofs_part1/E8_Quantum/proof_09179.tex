...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5736
\end{equation}

Proof instance 9179 quantum parameter:
\begin{equation}
\hbar \omega_{9179} = 0.996779 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9179} = 9.19e+191
\end{equation}
