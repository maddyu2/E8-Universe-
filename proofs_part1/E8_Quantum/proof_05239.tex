...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2675
\end{equation}

Proof instance 5239 quantum parameter:
\begin{equation}
\hbar \omega_{5239} = 0.995854 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5239} = 8.37e+191
\end{equation}
