...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8478
\end{equation}

Proof instance 6059 quantum parameter:
\begin{equation}
\hbar \omega_{6059} = 0.996053 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6059} = 1.18e+192
\end{equation}
