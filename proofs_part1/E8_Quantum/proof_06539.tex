...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5458
\end{equation}

Proof instance 6539 quantum parameter:
\begin{equation}
\hbar \omega_{6539} = 1.006231 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6539} = 1.08e+192
\end{equation}
