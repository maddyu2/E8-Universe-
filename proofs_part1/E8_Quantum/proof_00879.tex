...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1777
\end{equation}

Proof instance 879 quantum parameter:
\begin{equation}
\hbar \omega_{879} = 1.008535 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{879} = 1.11e+192
\end{equation}
