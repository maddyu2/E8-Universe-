...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8639
\end{equation}

Proof instance 5229 quantum parameter:
\begin{equation}
\hbar \omega_{5229} = 1.016039 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5229} = 1.08e+192
\end{equation}
