...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0352
\end{equation}

Proof instance 2599 quantum parameter:
\begin{equation}
\hbar \omega_{2599} = 1.009997 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2599} = 9.77e+191
\end{equation}
