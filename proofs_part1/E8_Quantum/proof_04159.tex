...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1902
\end{equation}

Proof instance 4159 quantum parameter:
\begin{equation}
\hbar \omega_{4159} = 0.987769 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4159} = 1.06e+192
\end{equation}
