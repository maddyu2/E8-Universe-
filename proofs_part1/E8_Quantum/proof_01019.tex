...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3561
\end{equation}

Proof instance 1019 quantum parameter:
\begin{equation}
\hbar \omega_{1019} = 1.006231 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1019} = 9.25e+191
\end{equation}
