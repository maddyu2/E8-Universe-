...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4146
\end{equation}

Proof instance 459 quantum parameter:
\begin{equation}
\hbar \omega_{459} = 1.007495 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{459} = 1.08e+192
\end{equation}
