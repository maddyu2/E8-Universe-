...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4184
\end{equation}

Proof instance 8019 quantum parameter:
\begin{equation}
\hbar \omega_{8019} = 0.999457 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8019} = 9.61e+191
\end{equation}
