...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3324
\end{equation}

Proof instance 8539 quantum parameter:
\begin{equation}
\hbar \omega_{8539} = 0.994282 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8539} = 1.05e+192
\end{equation}
