...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2041
\end{equation}

Proof instance 7439 quantum parameter:
\begin{equation}
\hbar \omega_{7439} = 1.001837 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7439} = 9.90e+191
\end{equation}
