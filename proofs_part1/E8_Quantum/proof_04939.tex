...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0409
\end{equation}

Proof instance 4939 quantum parameter:
\begin{equation}
\hbar \omega_{4939} = 1.004265 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4939} = 9.86e+191
\end{equation}
