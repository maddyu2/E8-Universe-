...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5111
\end{equation}

Proof instance 7909 quantum parameter:
\begin{equation}
\hbar \omega_{7909} = 1.001398 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7909} = 1.06e+192
\end{equation}
