...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3700
\end{equation}

Proof instance 3039 quantum parameter:
\begin{equation}
\hbar \omega_{3039} = 1.002871 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3039} = 1.14e+192
\end{equation}
