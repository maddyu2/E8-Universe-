...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9740
\end{equation}

Proof instance 4469 quantum parameter:
\begin{equation}
\hbar \omega_{4469} = 1.005928 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4469} = 1.19e+192
\end{equation}
