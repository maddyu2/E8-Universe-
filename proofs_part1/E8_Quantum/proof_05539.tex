...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9713
\end{equation}

Proof instance 5539 quantum parameter:
\begin{equation}
\hbar \omega_{5539} = 1.009368 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5539} = 1.03e+192
\end{equation}
