...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7657
\end{equation}

Proof instance 5879 quantum parameter:
\begin{equation}
\hbar \omega_{5879} = 0.997524 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5879} = 9.17e+191
\end{equation}
