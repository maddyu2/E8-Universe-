...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9485
\end{equation}

Proof instance 4549 quantum parameter:
\begin{equation}
\hbar \omega_{4549} = 0.999725 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4549} = 1.03e+192
\end{equation}
