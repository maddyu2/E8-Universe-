...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6598
\end{equation}

Proof instance 8139 quantum parameter:
\begin{equation}
\hbar \omega_{8139} = 0.993861 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8139} = 1.05e+192
\end{equation}
