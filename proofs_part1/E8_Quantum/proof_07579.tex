...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.0604
\end{equation}

Proof instance 7579 quantum parameter:
\begin{equation}
\hbar \omega_{7579} = 0.986090 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7579} = 1.03e+192
\end{equation}
