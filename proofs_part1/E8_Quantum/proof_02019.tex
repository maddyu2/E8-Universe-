...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4813
\end{equation}

Proof instance 2019 quantum parameter:
\begin{equation}
\hbar \omega_{2019} = 1.013319 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2019} = 9.78e+191
\end{equation}
