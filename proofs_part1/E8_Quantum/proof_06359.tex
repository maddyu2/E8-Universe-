...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1781
\end{equation}

Proof instance 6359 quantum parameter:
\begin{equation}
\hbar \omega_{6359} = 1.017840 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6359} = 1.01e+192
\end{equation}
