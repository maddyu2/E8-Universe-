...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3912
\end{equation}

Proof instance 8749 quantum parameter:
\begin{equation}
\hbar \omega_{8749} = 0.993166 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8749} = 9.66e+191
\end{equation}
