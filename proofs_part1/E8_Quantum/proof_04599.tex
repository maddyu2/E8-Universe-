...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9813
\end{equation}

Proof instance 4599 quantum parameter:
\begin{equation}
\hbar \omega_{4599} = 1.018910 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4599} = 1.10e+192
\end{equation}
