...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7280
\end{equation}

Proof instance 2339 quantum parameter:
\begin{equation}
\hbar \omega_{2339} = 1.008828 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2339} = 8.77e+191
\end{equation}
