...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0345
\end{equation}

Proof instance 5079 quantum parameter:
\begin{equation}
\hbar \omega_{5079} = 0.979493 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5079} = 8.68e+191
\end{equation}
