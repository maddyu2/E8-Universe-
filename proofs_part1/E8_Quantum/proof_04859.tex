...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7743
\end{equation}

Proof instance 4859 quantum parameter:
\begin{equation}
\hbar \omega_{4859} = 1.006190 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4859} = 8.70e+191
\end{equation}
