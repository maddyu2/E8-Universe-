...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0047
\end{equation}

Proof instance 3929 quantum parameter:
\begin{equation}
\hbar \omega_{3929} = 1.019006 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3929} = 1.01e+192
\end{equation}
