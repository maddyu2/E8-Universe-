...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8204
\end{equation}

Proof instance 8729 quantum parameter:
\begin{equation}
\hbar \omega_{8729} = 0.995210 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8729} = 8.74e+191
\end{equation}
