...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8771
\end{equation}

Proof instance 479 quantum parameter:
\begin{equation}
\hbar \omega_{479} = 0.995345 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{479} = 8.01e+191
\end{equation}
