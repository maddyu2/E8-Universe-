...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.0693
\end{equation}

Proof instance 8259 quantum parameter:
\begin{equation}
\hbar \omega_{8259} = 0.995333 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8259} = 1.06e+192
\end{equation}
