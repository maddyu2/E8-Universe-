...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8224
\end{equation}

Proof instance 589 quantum parameter:
\begin{equation}
\hbar \omega_{589} = 1.007382 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{589} = 1.11e+192
\end{equation}
