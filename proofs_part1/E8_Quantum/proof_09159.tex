...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1462
\end{equation}

Proof instance 9159 quantum parameter:
\begin{equation}
\hbar \omega_{9159} = 0.999953 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9159} = 9.61e+191
\end{equation}
