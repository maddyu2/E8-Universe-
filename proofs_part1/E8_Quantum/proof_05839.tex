...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2878
\end{equation}

Proof instance 5839 quantum parameter:
\begin{equation}
\hbar \omega_{5839} = 0.997265 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5839} = 1.01e+192
\end{equation}
