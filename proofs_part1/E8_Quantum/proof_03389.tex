...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2921
\end{equation}

Proof instance 3389 quantum parameter:
\begin{equation}
\hbar \omega_{3389} = 0.999020 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3389} = 1.04e+192
\end{equation}
