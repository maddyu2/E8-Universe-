...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0050
\end{equation}

Proof instance 7649 quantum parameter:
\begin{equation}
\hbar \omega_{7649} = 1.001415 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7649} = 1.10e+192
\end{equation}
