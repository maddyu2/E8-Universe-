...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7683
\end{equation}

Proof instance 1289 quantum parameter:
\begin{equation}
\hbar \omega_{1289} = 1.004606 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1289} = 9.78e+191
\end{equation}
