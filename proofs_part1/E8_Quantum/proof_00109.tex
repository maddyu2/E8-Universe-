...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0591
\end{equation}

Proof instance 109 quantum parameter:
\begin{equation}
\hbar \omega_{109} = 1.006139 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{109} = 9.81e+191
\end{equation}
