...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8784
\end{equation}

Proof instance 4699 quantum parameter:
\begin{equation}
\hbar \omega_{4699} = 1.008050 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4699} = 1.12e+192
\end{equation}
