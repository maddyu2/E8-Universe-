...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1112
\end{equation}

Proof instance 4779 quantum parameter:
\begin{equation}
\hbar \omega_{4779} = 0.987644 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4779} = 1.03e+192
\end{equation}
