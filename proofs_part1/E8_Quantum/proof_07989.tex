...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5930
\end{equation}

Proof instance 7989 quantum parameter:
\begin{equation}
\hbar \omega_{7989} = 1.022197 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7989} = 8.72e+191
\end{equation}
