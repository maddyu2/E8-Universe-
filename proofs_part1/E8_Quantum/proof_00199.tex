...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.2887
\end{equation}

Proof instance 199 quantum parameter:
\begin{equation}
\hbar \omega_{199} = 0.981546 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{199} = 1.11e+192
\end{equation}
