...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4248
\end{equation}

Proof instance 4109 quantum parameter:
\begin{equation}
\hbar \omega_{4109} = 1.008333 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4109} = 1.11e+192
\end{equation}
