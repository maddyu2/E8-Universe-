...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3818
\end{equation}

Proof instance 1919 quantum parameter:
\begin{equation}
\hbar \omega_{1919} = 1.012497 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1919} = 1.06e+192
\end{equation}
