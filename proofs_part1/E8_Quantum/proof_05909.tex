...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9713
\end{equation}

Proof instance 5909 quantum parameter:
\begin{equation}
\hbar \omega_{5909} = 0.988363 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5909} = 1.08e+192
\end{equation}
