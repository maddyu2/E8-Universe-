...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3385
\end{equation}

Proof instance 7639 quantum parameter:
\begin{equation}
\hbar \omega_{7639} = 1.001103 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7639} = 1.08e+192
\end{equation}
