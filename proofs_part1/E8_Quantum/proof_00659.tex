...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1341
\end{equation}

Proof instance 659 quantum parameter:
\begin{equation}
\hbar \omega_{659} = 1.003607 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{659} = 1.16e+192
\end{equation}
