...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1889
\end{equation}

Proof instance 9259 quantum parameter:
\begin{equation}
\hbar \omega_{9259} = 0.974711 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9259} = 9.47e+191
\end{equation}
