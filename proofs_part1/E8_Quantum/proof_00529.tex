...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1407
\end{equation}

Proof instance 529 quantum parameter:
\begin{equation}
\hbar \omega_{529} = 1.005185 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{529} = 1.06e+192
\end{equation}
