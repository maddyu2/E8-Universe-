...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5729
\end{equation}

Proof instance 8929 quantum parameter:
\begin{equation}
\hbar \omega_{8929} = 1.013855 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8929} = 1.15e+192
\end{equation}
