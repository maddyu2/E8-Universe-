...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9661
\end{equation}

Proof instance 7409 quantum parameter:
\begin{equation}
\hbar \omega_{7409} = 1.000629 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7409} = 9.74e+191
\end{equation}
