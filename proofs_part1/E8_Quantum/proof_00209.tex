...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4537
\end{equation}

Proof instance 209 quantum parameter:
\begin{equation}
\hbar \omega_{209} = 1.011407 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{209} = 9.55e+191
\end{equation}
