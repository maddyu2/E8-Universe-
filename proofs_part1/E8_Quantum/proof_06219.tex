...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3501
\end{equation}

Proof instance 6219 quantum parameter:
\begin{equation}
\hbar \omega_{6219} = 1.007867 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6219} = 9.56e+191
\end{equation}
