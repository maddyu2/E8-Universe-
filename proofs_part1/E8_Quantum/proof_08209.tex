...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2313
\end{equation}

Proof instance 8209 quantum parameter:
\begin{equation}
\hbar \omega_{8209} = 0.996348 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8209} = 8.86e+191
\end{equation}
