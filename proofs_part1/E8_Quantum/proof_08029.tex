...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8186
\end{equation}

Proof instance 8029 quantum parameter:
\begin{equation}
\hbar \omega_{8029} = 1.010089 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8029} = 1.04e+192
\end{equation}
