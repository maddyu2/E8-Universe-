...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2044
\end{equation}

Proof instance 7099 quantum parameter:
\begin{equation}
\hbar \omega_{7099} = 1.003359 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7099} = 1.09e+192
\end{equation}
