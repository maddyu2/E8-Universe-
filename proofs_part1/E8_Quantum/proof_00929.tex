...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0137
\end{equation}

Proof instance 929 quantum parameter:
\begin{equation}
\hbar \omega_{929} = 1.000532 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{929} = 9.01e+191
\end{equation}
