...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2879
\end{equation}

Proof instance 2049 quantum parameter:
\begin{equation}
\hbar \omega_{2049} = 1.022931 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2049} = 1.00e+192
\end{equation}
