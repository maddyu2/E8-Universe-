...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5824
\end{equation}

Proof instance 7119 quantum parameter:
\begin{equation}
\hbar \omega_{7119} = 0.997332 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7119} = 9.00e+191
\end{equation}
