...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9750
\end{equation}

Proof instance 2369 quantum parameter:
\begin{equation}
\hbar \omega_{2369} = 1.020229 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2369} = 1.02e+192
\end{equation}
