...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8883
\end{equation}

Proof instance 5939 quantum parameter:
\begin{equation}
\hbar \omega_{5939} = 0.994449 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5939} = 8.00e+191
\end{equation}
