...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9210
\end{equation}

Proof instance 5059 quantum parameter:
\begin{equation}
\hbar \omega_{5059} = 1.000881 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5059} = 9.26e+191
\end{equation}
