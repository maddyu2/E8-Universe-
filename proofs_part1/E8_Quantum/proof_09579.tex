...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2232
\end{equation}

Proof instance 9579 quantum parameter:
\begin{equation}
\hbar \omega_{9579} = 1.005266 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9579} = 8.84e+191
\end{equation}
