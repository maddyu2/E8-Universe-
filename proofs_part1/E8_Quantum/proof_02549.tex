...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9086
\end{equation}

Proof instance 2549 quantum parameter:
\begin{equation}
\hbar \omega_{2549} = 0.993371 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2549} = 1.02e+192
\end{equation}
