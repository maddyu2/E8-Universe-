...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.0244
\end{equation}

Proof instance 2149 quantum parameter:
\begin{equation}
\hbar \omega_{2149} = 0.999802 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2149} = 1.02e+192
\end{equation}
