...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4379
\end{equation}

Proof instance 889 quantum parameter:
\begin{equation}
\hbar \omega_{889} = 1.014812 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{889} = 1.13e+192
\end{equation}
