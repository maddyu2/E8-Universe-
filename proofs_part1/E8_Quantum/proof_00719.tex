...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6792
\end{equation}

Proof instance 719 quantum parameter:
\begin{equation}
\hbar \omega_{719} = 1.000399 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{719} = 1.12e+192
\end{equation}
