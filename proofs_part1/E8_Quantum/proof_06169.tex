...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6821
\end{equation}

Proof instance 6169 quantum parameter:
\begin{equation}
\hbar \omega_{6169} = 0.991096 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6169} = 1.11e+192
\end{equation}
