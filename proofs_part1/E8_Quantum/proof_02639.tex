...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1605
\end{equation}

Proof instance 2639 quantum parameter:
\begin{equation}
\hbar \omega_{2639} = 0.992908 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2639} = 1.14e+192
\end{equation}
