...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.4338
\end{equation}

Proof instance 9629 quantum parameter:
\begin{equation}
\hbar \omega_{9629} = 0.991196 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9629} = 9.78e+191
\end{equation}
