...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4656
\end{equation}

Proof instance 7559 quantum parameter:
\begin{equation}
\hbar \omega_{7559} = 1.014727 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7559} = 1.00e+192
\end{equation}
