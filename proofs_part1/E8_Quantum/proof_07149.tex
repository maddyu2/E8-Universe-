...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5566
\end{equation}

Proof instance 7149 quantum parameter:
\begin{equation}
\hbar \omega_{7149} = 0.984911 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7149} = 1.20e+192
\end{equation}
