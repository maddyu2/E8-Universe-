...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8693
\end{equation}

Proof instance 5669 quantum parameter:
\begin{equation}
\hbar \omega_{5669} = 1.007448 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5669} = 9.24e+191
\end{equation}
