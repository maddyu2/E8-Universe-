...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9014
\end{equation}

Proof instance 7259 quantum parameter:
\begin{equation}
\hbar \omega_{7259} = 0.993301 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7259} = 1.04e+192
\end{equation}
