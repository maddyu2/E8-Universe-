...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9951
\end{equation}

Proof instance 7209 quantum parameter:
\begin{equation}
\hbar \omega_{7209} = 0.994616 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7209} = 9.52e+191
\end{equation}
