...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3843
\end{equation}

Proof instance 3849 quantum parameter:
\begin{equation}
\hbar \omega_{3849} = 0.998375 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3849} = 8.82e+191
\end{equation}
