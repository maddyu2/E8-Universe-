...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4847
\end{equation}

Proof instance 3659 quantum parameter:
\begin{equation}
\hbar \omega_{3659} = 0.996980 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3659} = 1.00e+192
\end{equation}
