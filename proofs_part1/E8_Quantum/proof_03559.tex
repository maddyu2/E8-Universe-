...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4748
\end{equation}

Proof instance 3559 quantum parameter:
\begin{equation}
\hbar \omega_{3559} = 1.008109 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3559} = 1.16e+192
\end{equation}
