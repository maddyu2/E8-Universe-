...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0605
\end{equation}

Proof instance 8319 quantum parameter:
\begin{equation}
\hbar \omega_{8319} = 0.992819 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8319} = 1.06e+192
\end{equation}
