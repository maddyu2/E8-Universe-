...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9503
\end{equation}

Proof instance 2239 quantum parameter:
\begin{equation}
\hbar \omega_{2239} = 0.989594 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2239} = 8.93e+191
\end{equation}
