...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0139
\end{equation}

Proof instance 2779 quantum parameter:
\begin{equation}
\hbar \omega_{2779} = 0.992103 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2779} = 1.10e+192
\end{equation}
