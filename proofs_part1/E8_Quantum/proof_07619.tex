...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4515
\end{equation}

Proof instance 7619 quantum parameter:
\begin{equation}
\hbar \omega_{7619} = 0.989839 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7619} = 1.10e+192
\end{equation}
