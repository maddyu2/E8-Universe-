...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4432
\end{equation}

Proof instance 5009 quantum parameter:
\begin{equation}
\hbar \omega_{5009} = 1.020905 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5009} = 1.07e+192
\end{equation}
