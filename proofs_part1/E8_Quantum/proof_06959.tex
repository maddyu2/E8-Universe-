...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1032
\end{equation}

Proof instance 6959 quantum parameter:
\begin{equation}
\hbar \omega_{6959} = 1.017301 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6959} = 1.01e+192
\end{equation}
