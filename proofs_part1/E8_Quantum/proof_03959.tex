...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2894
\end{equation}

Proof instance 3959 quantum parameter:
\begin{equation}
\hbar \omega_{3959} = 1.002233 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3959} = 8.69e+191
\end{equation}
