...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0355
\end{equation}

Proof instance 6159 quantum parameter:
\begin{equation}
\hbar \omega_{6159} = 1.003218 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6159} = 9.55e+191
\end{equation}
