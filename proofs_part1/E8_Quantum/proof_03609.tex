...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3846
\end{equation}

Proof instance 3609 quantum parameter:
\begin{equation}
\hbar \omega_{3609} = 0.998401 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3609} = 8.99e+191
\end{equation}
