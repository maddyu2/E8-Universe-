...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5711
\end{equation}

Proof instance 6629 quantum parameter:
\begin{equation}
\hbar \omega_{6629} = 0.999027 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6629} = 1.01e+192
\end{equation}
