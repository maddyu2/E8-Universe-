...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.7400
\end{equation}

Proof instance 1239 quantum parameter:
\begin{equation}
\hbar \omega_{1239} = 1.005519 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1239} = 1.17e+192
\end{equation}
