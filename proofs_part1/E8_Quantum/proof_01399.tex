...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7312
\end{equation}

Proof instance 1399 quantum parameter:
\begin{equation}
\hbar \omega_{1399} = 0.990571 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1399} = 9.93e+191
\end{equation}
