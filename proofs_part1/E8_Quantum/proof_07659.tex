...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8240
\end{equation}

Proof instance 7659 quantum parameter:
\begin{equation}
\hbar \omega_{7659} = 0.995695 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7659} = 9.20e+191
\end{equation}
