...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2535
\end{equation}

Proof instance 8989 quantum parameter:
\begin{equation}
\hbar \omega_{8989} = 0.996292 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8989} = 1.02e+192
\end{equation}
