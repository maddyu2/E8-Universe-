...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5243
\end{equation}

Proof instance 369 quantum parameter:
\begin{equation}
\hbar \omega_{369} = 0.978959 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{369} = 8.68e+191
\end{equation}
