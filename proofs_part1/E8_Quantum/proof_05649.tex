...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3701
\end{equation}

Proof instance 5649 quantum parameter:
\begin{equation}
\hbar \omega_{5649} = 0.995276 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5649} = 1.04e+192
\end{equation}
