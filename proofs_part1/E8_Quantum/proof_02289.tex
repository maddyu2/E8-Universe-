...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0778
\end{equation}

Proof instance 2289 quantum parameter:
\begin{equation}
\hbar \omega_{2289} = 0.996761 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2289} = 9.40e+191
\end{equation}
