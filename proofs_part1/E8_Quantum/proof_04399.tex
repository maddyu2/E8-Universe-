...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1527
\end{equation}

Proof instance 4399 quantum parameter:
\begin{equation}
\hbar \omega_{4399} = 0.997750 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4399} = 9.64e+191
\end{equation}
