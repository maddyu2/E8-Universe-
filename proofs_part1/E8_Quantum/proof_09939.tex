...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0400
\end{equation}

Proof instance 9939 quantum parameter:
\begin{equation}
\hbar \omega_{9939} = 1.001404 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9939} = 9.81e+191
\end{equation}
