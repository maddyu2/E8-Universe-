...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0309
\end{equation}

Proof instance 7289 quantum parameter:
\begin{equation}
\hbar \omega_{7289} = 0.999518 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7289} = 1.00e+192
\end{equation}
