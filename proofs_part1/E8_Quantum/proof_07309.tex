...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1831
\end{equation}

Proof instance 7309 quantum parameter:
\begin{equation}
\hbar \omega_{7309} = 0.989114 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7309} = 1.10e+192
\end{equation}
