...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5690
\end{equation}

Proof instance 7159 quantum parameter:
\begin{equation}
\hbar \omega_{7159} = 0.987488 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7159} = 9.81e+191
\end{equation}
