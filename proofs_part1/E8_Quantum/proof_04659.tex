...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3643
\end{equation}

Proof instance 4659 quantum parameter:
\begin{equation}
\hbar \omega_{4659} = 0.996696 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4659} = 9.70e+191
\end{equation}
