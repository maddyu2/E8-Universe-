...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3437
\end{equation}

Proof instance 8399 quantum parameter:
\begin{equation}
\hbar \omega_{8399} = 1.004850 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8399} = 9.33e+191
\end{equation}
