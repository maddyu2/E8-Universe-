...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7721
\end{equation}

Proof instance 3269 quantum parameter:
\begin{equation}
\hbar \omega_{3269} = 1.005540 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3269} = 1.15e+192
\end{equation}
