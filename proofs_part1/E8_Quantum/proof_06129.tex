...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6655
\end{equation}

Proof instance 6129 quantum parameter:
\begin{equation}
\hbar \omega_{6129} = 1.002152 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6129} = 1.14e+192
\end{equation}
