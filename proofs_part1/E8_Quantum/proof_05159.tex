...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8601
\end{equation}

Proof instance 5159 quantum parameter:
\begin{equation}
\hbar \omega_{5159} = 0.993411 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5159} = 1.14e+192
\end{equation}
