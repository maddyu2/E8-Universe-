...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9229
\end{equation}

Proof instance 1889 quantum parameter:
\begin{equation}
\hbar \omega_{1889} = 0.994621 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1889} = 1.18e+192
\end{equation}
