...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6292
\end{equation}

Proof instance 2849 quantum parameter:
\begin{equation}
\hbar \omega_{2849} = 1.006219 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2849} = 1.02e+192
\end{equation}
