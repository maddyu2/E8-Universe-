...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6370
\end{equation}

Proof instance 5989 quantum parameter:
\begin{equation}
\hbar \omega_{5989} = 1.007029 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5989} = 9.00e+191
\end{equation}
