...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5217
\end{equation}

Proof instance 6749 quantum parameter:
\begin{equation}
\hbar \omega_{6749} = 1.001149 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6749} = 1.01e+192
\end{equation}
