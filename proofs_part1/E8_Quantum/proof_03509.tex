...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9329
\end{equation}

Proof instance 3509 quantum parameter:
\begin{equation}
\hbar \omega_{3509} = 0.993684 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3509} = 1.08e+192
\end{equation}
