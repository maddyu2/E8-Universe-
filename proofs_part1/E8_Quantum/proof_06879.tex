...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3570
\end{equation}

Proof instance 6879 quantum parameter:
\begin{equation}
\hbar \omega_{6879} = 0.991277 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6879} = 1.09e+192
\end{equation}
