...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3054
\end{equation}

Proof instance 4489 quantum parameter:
\begin{equation}
\hbar \omega_{4489} = 0.996486 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4489} = 1.10e+192
\end{equation}
