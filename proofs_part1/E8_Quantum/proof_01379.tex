...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9971
\end{equation}

Proof instance 1379 quantum parameter:
\begin{equation}
\hbar \omega_{1379} = 1.004349 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1379} = 1.19e+192
\end{equation}
