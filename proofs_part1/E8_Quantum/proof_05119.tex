...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3577
\end{equation}

Proof instance 5119 quantum parameter:
\begin{equation}
\hbar \omega_{5119} = 0.998896 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5119} = 1.16e+192
\end{equation}
