...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1595
\end{equation}

Proof instance 1059 quantum parameter:
\begin{equation}
\hbar \omega_{1059} = 0.992471 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1059} = 1.08e+192
\end{equation}
