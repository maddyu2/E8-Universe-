...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9375
\end{equation}

Proof instance 4429 quantum parameter:
\begin{equation}
\hbar \omega_{4429} = 1.012617 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4429} = 9.73e+191
\end{equation}
