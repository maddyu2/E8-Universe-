...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2219
\end{equation}

Proof instance 4579 quantum parameter:
\begin{equation}
\hbar \omega_{4579} = 1.003722 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4579} = 8.55e+191
\end{equation}
