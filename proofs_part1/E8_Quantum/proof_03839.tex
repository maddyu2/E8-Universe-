...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1961
\end{equation}

Proof instance 3839 quantum parameter:
\begin{equation}
\hbar \omega_{3839} = 1.008591 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3839} = 1.17e+192
\end{equation}
