...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8594
\end{equation}

Proof instance 3259 quantum parameter:
\begin{equation}
\hbar \omega_{3259} = 1.006102 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3259} = 7.83e+191
\end{equation}
