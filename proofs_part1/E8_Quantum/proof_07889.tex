...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6049
\end{equation}

Proof instance 7889 quantum parameter:
\begin{equation}
\hbar \omega_{7889} = 1.001451 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7889} = 9.80e+191
\end{equation}
