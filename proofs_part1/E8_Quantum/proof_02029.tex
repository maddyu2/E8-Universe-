...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2806
\end{equation}

Proof instance 2029 quantum parameter:
\begin{equation}
\hbar \omega_{2029} = 1.008755 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2029} = 9.58e+191
\end{equation}
