...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.6145
\end{equation}

Proof instance 9869 quantum parameter:
\begin{equation}
\hbar \omega_{9869} = 1.003282 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9869} = 7.95e+191
\end{equation}
