...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3240
\end{equation}

Proof instance 4419 quantum parameter:
\begin{equation}
\hbar \omega_{4419} = 0.991337 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4419} = 9.94e+191
\end{equation}
