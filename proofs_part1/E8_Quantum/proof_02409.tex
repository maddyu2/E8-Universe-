...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7137
\end{equation}

Proof instance 2409 quantum parameter:
\begin{equation}
\hbar \omega_{2409} = 1.008231 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2409} = 9.25e+191
\end{equation}
