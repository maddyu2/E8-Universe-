...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5116
\end{equation}

Proof instance 6209 quantum parameter:
\begin{equation}
\hbar \omega_{6209} = 0.992626 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6209} = 9.95e+191
\end{equation}
