...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6977
\end{equation}

Proof instance 1809 quantum parameter:
\begin{equation}
\hbar \omega_{1809} = 0.992916 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1809} = 1.03e+192
\end{equation}
