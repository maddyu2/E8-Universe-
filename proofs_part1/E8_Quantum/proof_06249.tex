...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4741
\end{equation}

Proof instance 6249 quantum parameter:
\begin{equation}
\hbar \omega_{6249} = 0.996299 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6249} = 9.60e+191
\end{equation}
