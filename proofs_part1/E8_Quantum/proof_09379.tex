...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5501
\end{equation}

Proof instance 9379 quantum parameter:
\begin{equation}
\hbar \omega_{9379} = 0.998054 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9379} = 7.45e+191
\end{equation}
