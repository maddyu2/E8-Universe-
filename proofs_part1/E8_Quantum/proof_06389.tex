...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5753
\end{equation}

Proof instance 6389 quantum parameter:
\begin{equation}
\hbar \omega_{6389} = 0.982916 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6389} = 9.70e+191
\end{equation}
