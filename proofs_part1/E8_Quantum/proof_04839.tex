...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2595
\end{equation}

Proof instance 4839 quantum parameter:
\begin{equation}
\hbar \omega_{4839} = 0.995990 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4839} = 1.18e+192
\end{equation}
