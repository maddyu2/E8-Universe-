...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4758
\end{equation}

Proof instance 639 quantum parameter:
\begin{equation}
\hbar \omega_{639} = 1.030609 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{639} = 1.15e+192
\end{equation}
