...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0881
\end{equation}

Proof instance 1359 quantum parameter:
\begin{equation}
\hbar \omega_{1359} = 0.987288 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1359} = 9.48e+191
\end{equation}
