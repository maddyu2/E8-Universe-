...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8178
\end{equation}

Proof instance 3529 quantum parameter:
\begin{equation}
\hbar \omega_{3529} = 0.985266 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3529} = 9.47e+191
\end{equation}
