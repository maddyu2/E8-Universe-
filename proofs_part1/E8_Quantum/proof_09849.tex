...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5112
\end{equation}

Proof instance 9849 quantum parameter:
\begin{equation}
\hbar \omega_{9849} = 0.995830 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9849} = 1.08e+192
\end{equation}
