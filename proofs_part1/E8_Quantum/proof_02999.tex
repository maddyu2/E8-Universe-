...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8340
\end{equation}

Proof instance 2999 quantum parameter:
\begin{equation}
\hbar \omega_{2999} = 0.993809 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2999} = 9.33e+191
\end{equation}
