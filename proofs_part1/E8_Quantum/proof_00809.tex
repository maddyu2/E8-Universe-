...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6216
\end{equation}

Proof instance 809 quantum parameter:
\begin{equation}
\hbar \omega_{809} = 1.000558 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{809} = 1.01e+192
\end{equation}
