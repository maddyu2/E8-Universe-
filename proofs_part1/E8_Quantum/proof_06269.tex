...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3541
\end{equation}

Proof instance 6269 quantum parameter:
\begin{equation}
\hbar \omega_{6269} = 1.008515 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6269} = 9.38e+191
\end{equation}
