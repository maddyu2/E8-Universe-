...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2365
\end{equation}

Proof instance 1709 quantum parameter:
\begin{equation}
\hbar \omega_{1709} = 0.993856 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1709} = 9.60e+191
\end{equation}
