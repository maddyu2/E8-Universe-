...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1596
\end{equation}

Proof instance 8269 quantum parameter:
\begin{equation}
\hbar \omega_{8269} = 0.991650 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8269} = 9.21e+191
\end{equation}
