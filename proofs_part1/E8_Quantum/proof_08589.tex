...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6364
\end{equation}

Proof instance 8589 quantum parameter:
\begin{equation}
\hbar \omega_{8589} = 1.000916 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8589} = 8.82e+191
\end{equation}
