...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6411
\end{equation}

Proof instance 5609 quantum parameter:
\begin{equation}
\hbar \omega_{5609} = 0.991988 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5609} = 1.16e+192
\end{equation}
