...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0467
\end{equation}

Proof instance 5019 quantum parameter:
\begin{equation}
\hbar \omega_{5019} = 0.993924 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5019} = 8.37e+191
\end{equation}
