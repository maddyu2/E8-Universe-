...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0007
\end{equation}

Proof instance 4719 quantum parameter:
\begin{equation}
\hbar \omega_{4719} = 0.999861 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4719} = 9.42e+191
\end{equation}
