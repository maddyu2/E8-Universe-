...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7517
\end{equation}

Proof instance 5179 quantum parameter:
\begin{equation}
\hbar \omega_{5179} = 1.010500 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5179} = 1.03e+192
\end{equation}
