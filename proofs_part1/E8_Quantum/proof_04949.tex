...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2121
\end{equation}

Proof instance 4949 quantum parameter:
\begin{equation}
\hbar \omega_{4949} = 1.002468 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4949} = 9.62e+191
\end{equation}
