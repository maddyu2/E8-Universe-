...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4531
\end{equation}

Proof instance 2629 quantum parameter:
\begin{equation}
\hbar \omega_{2629} = 1.009340 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2629} = 1.11e+192
\end{equation}
