...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1677
\end{equation}

Proof instance 1549 quantum parameter:
\begin{equation}
\hbar \omega_{1549} = 1.002022 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1549} = 1.00e+192
\end{equation}
