...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9556
\end{equation}

Proof instance 1139 quantum parameter:
\begin{equation}
\hbar \omega_{1139} = 1.000223 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1139} = 1.01e+192
\end{equation}
