...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2981
\end{equation}

Proof instance 3499 quantum parameter:
\begin{equation}
\hbar \omega_{3499} = 0.985990 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3499} = 1.04e+192
\end{equation}
