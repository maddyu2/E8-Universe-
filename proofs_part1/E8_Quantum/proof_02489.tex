...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8465
\end{equation}

Proof instance 2489 quantum parameter:
\begin{equation}
\hbar \omega_{2489} = 1.013311 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2489} = 8.72e+191
\end{equation}
