...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0440
\end{equation}

Proof instance 4099 quantum parameter:
\begin{equation}
\hbar \omega_{4099} = 1.018705 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4099} = 1.10e+192
\end{equation}
