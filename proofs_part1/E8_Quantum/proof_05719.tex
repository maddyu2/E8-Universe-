...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5202
\end{equation}

Proof instance 5719 quantum parameter:
\begin{equation}
\hbar \omega_{5719} = 0.995962 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5719} = 1.06e+192
\end{equation}
