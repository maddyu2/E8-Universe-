...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8084
\end{equation}

Proof instance 5359 quantum parameter:
\begin{equation}
\hbar \omega_{5359} = 0.997353 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5359} = 1.10e+192
\end{equation}
