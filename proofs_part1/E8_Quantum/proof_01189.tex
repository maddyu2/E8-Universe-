...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5442
\end{equation}

Proof instance 1189 quantum parameter:
\begin{equation}
\hbar \omega_{1189} = 0.974419 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1189} = 1.04e+192
\end{equation}
