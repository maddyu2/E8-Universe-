...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1696
\end{equation}

Proof instance 9649 quantum parameter:
\begin{equation}
\hbar \omega_{9649} = 1.003306 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9649} = 1.04e+192
\end{equation}
