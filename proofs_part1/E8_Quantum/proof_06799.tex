...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3261
\end{equation}

Proof instance 6799 quantum parameter:
\begin{equation}
\hbar \omega_{6799} = 0.990938 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6799} = 9.46e+191
\end{equation}
