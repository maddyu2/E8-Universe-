...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6017
\end{equation}

Proof instance 6029 quantum parameter:
\begin{equation}
\hbar \omega_{6029} = 0.990446 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6029} = 9.86e+191
\end{equation}
