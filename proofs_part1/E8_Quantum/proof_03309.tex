...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1476
\end{equation}

Proof instance 3309 quantum parameter:
\begin{equation}
\hbar \omega_{3309} = 1.001637 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3309} = 1.04e+192
\end{equation}
