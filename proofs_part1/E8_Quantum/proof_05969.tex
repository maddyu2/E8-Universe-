...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6967
\end{equation}

Proof instance 5969 quantum parameter:
\begin{equation}
\hbar \omega_{5969} = 1.002205 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5969} = 9.72e+191
\end{equation}
