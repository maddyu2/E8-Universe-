...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1728
\end{equation}

Proof instance 5929 quantum parameter:
\begin{equation}
\hbar \omega_{5929} = 0.979336 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5929} = 1.07e+192
\end{equation}
