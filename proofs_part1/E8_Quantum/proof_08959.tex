...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8498
\end{equation}

Proof instance 8959 quantum parameter:
\begin{equation}
\hbar \omega_{8959} = 0.988688 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8959} = 1.06e+192
\end{equation}
