...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6109
\end{equation}

Proof instance 2909 quantum parameter:
\begin{equation}
\hbar \omega_{2909} = 1.008631 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2909} = 9.68e+191
\end{equation}
