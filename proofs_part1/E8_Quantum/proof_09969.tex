...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3115
\end{equation}

Proof instance 9969 quantum parameter:
\begin{equation}
\hbar \omega_{9969} = 1.000129 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9969} = 9.66e+191
\end{equation}
