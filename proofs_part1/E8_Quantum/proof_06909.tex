...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2641
\end{equation}

Proof instance 6909 quantum parameter:
\begin{equation}
\hbar \omega_{6909} = 1.002910 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6909} = 9.82e+191
\end{equation}
