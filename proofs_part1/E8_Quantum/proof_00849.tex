...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9893
\end{equation}

Proof instance 849 quantum parameter:
\begin{equation}
\hbar \omega_{849} = 0.991359 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{849} = 8.07e+191
\end{equation}
