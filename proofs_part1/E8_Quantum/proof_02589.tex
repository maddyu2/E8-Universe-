...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8633
\end{equation}

Proof instance 2589 quantum parameter:
\begin{equation}
\hbar \omega_{2589} = 1.000912 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2589} = 1.06e+192
\end{equation}
