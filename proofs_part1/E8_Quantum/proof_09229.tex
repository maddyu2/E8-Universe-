...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4472
\end{equation}

Proof instance 9229 quantum parameter:
\begin{equation}
\hbar \omega_{9229} = 0.994005 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9229} = 9.90e+191
\end{equation}
