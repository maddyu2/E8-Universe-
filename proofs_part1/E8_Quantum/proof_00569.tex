...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1232
\end{equation}

Proof instance 569 quantum parameter:
\begin{equation}
\hbar \omega_{569} = 1.000577 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{569} = 9.63e+191
\end{equation}
