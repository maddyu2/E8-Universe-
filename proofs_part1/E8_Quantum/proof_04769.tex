...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5734
\end{equation}

Proof instance 4769 quantum parameter:
\begin{equation}
\hbar \omega_{4769} = 1.000477 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4769} = 1.02e+192
\end{equation}
