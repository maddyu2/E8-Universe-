...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3604
\end{equation}

Proof instance 2659 quantum parameter:
\begin{equation}
\hbar \omega_{2659} = 1.000124 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2659} = 1.14e+192
\end{equation}
