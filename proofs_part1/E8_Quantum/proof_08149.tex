...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2510
\end{equation}

Proof instance 8149 quantum parameter:
\begin{equation}
\hbar \omega_{8149} = 1.000266 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8149} = 9.11e+191
\end{equation}
