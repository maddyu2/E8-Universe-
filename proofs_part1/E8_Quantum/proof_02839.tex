...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7320
\end{equation}

Proof instance 2839 quantum parameter:
\begin{equation}
\hbar \omega_{2839} = 1.007980 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2839} = 1.07e+192
\end{equation}
