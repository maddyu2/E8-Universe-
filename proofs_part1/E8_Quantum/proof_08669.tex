...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4769
\end{equation}

Proof instance 8669 quantum parameter:
\begin{equation}
\hbar \omega_{8669} = 0.983025 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8669} = 9.56e+191
\end{equation}
