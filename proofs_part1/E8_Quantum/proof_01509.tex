...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6743
\end{equation}

Proof instance 1509 quantum parameter:
\begin{equation}
\hbar \omega_{1509} = 1.000239 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1509} = 9.90e+191
\end{equation}
