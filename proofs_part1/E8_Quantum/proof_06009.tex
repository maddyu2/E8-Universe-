...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.2166
\end{equation}

Proof instance 6009 quantum parameter:
\begin{equation}
\hbar \omega_{6009} = 0.994592 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6009} = 8.00e+191
\end{equation}
