...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3695
\end{equation}

Proof instance 1629 quantum parameter:
\begin{equation}
\hbar \omega_{1629} = 1.015823 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1629} = 1.00e+192
\end{equation}
