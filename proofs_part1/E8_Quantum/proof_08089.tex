...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7355
\end{equation}

Proof instance 8089 quantum parameter:
\begin{equation}
\hbar \omega_{8089} = 1.004825 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8089} = 1.07e+192
\end{equation}
