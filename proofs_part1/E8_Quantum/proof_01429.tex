...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2068
\end{equation}

Proof instance 1429 quantum parameter:
\begin{equation}
\hbar \omega_{1429} = 1.001473 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1429} = 9.56e+191
\end{equation}
