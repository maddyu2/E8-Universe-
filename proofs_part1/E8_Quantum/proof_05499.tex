...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3483
\end{equation}

Proof instance 5499 quantum parameter:
\begin{equation}
\hbar \omega_{5499} = 0.990030 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5499} = 1.02e+192
\end{equation}
