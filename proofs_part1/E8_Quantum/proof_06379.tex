...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3254
\end{equation}

Proof instance 6379 quantum parameter:
\begin{equation}
\hbar \omega_{6379} = 0.978614 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6379} = 1.02e+192
\end{equation}
