...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8662
\end{equation}

Proof instance 9499 quantum parameter:
\begin{equation}
\hbar \omega_{9499} = 0.990340 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9499} = 7.96e+191
\end{equation}
