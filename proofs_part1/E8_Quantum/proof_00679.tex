...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6157
\end{equation}

Proof instance 679 quantum parameter:
\begin{equation}
\hbar \omega_{679} = 0.991124 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{679} = 1.11e+192
\end{equation}
