...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4102
\end{equation}

Proof instance 7899 quantum parameter:
\begin{equation}
\hbar \omega_{7899} = 0.997169 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7899} = 1.02e+192
\end{equation}
