...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3064
\end{equation}

Proof instance 2219 quantum parameter:
\begin{equation}
\hbar \omega_{2219} = 1.002364 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2219} = 9.99e+191
\end{equation}
