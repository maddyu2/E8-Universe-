...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6116
\end{equation}

Proof instance 8429 quantum parameter:
\begin{equation}
\hbar \omega_{8429} = 1.013258 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8429} = 9.95e+191
\end{equation}
