...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0997
\end{equation}

Proof instance 8939 quantum parameter:
\begin{equation}
\hbar \omega_{8939} = 0.989402 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8939} = 9.51e+191
\end{equation}
