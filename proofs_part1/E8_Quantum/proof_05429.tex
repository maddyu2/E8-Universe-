...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9531
\end{equation}

Proof instance 5429 quantum parameter:
\begin{equation}
\hbar \omega_{5429} = 0.998194 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5429} = 9.24e+191
\end{equation}
