...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5309
\end{equation}

Proof instance 8869 quantum parameter:
\begin{equation}
\hbar \omega_{8869} = 0.987834 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8869} = 1.12e+192
\end{equation}
