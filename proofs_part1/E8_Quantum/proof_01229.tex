...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3715
\end{equation}

Proof instance 1229 quantum parameter:
\begin{equation}
\hbar \omega_{1229} = 0.986713 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1229} = 9.14e+191
\end{equation}
