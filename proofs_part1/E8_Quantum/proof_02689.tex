...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4778
\end{equation}

Proof instance 2689 quantum parameter:
\begin{equation}
\hbar \omega_{2689} = 0.992360 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2689} = 1.22e+192
\end{equation}
