...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8357
\end{equation}

Proof instance 9239 quantum parameter:
\begin{equation}
\hbar \omega_{9239} = 0.972867 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9239} = 9.72e+191
\end{equation}
