...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3662
\end{equation}

Proof instance 7049 quantum parameter:
\begin{equation}
\hbar \omega_{7049} = 0.987281 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7049} = 1.01e+192
\end{equation}
