...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0214
\end{equation}

Proof instance 9519 quantum parameter:
\begin{equation}
\hbar \omega_{9519} = 1.000818 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9519} = 8.73e+191
\end{equation}
