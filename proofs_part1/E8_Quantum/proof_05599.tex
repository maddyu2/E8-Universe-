...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7210
\end{equation}

Proof instance 5599 quantum parameter:
\begin{equation}
\hbar \omega_{5599} = 1.001508 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5599} = 1.16e+192
\end{equation}
