...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0117
\end{equation}

Proof instance 6579 quantum parameter:
\begin{equation}
\hbar \omega_{6579} = 1.008095 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6579} = 8.23e+191
\end{equation}
