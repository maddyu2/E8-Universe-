...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4245
\end{equation}

Proof instance 8439 quantum parameter:
\begin{equation}
\hbar \omega_{8439} = 1.019500 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8439} = 8.88e+191
\end{equation}
