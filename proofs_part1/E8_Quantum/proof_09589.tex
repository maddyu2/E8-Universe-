...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9998
\end{equation}

Proof instance 9589 quantum parameter:
\begin{equation}
\hbar \omega_{9589} = 0.991156 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9589} = 9.30e+191
\end{equation}
