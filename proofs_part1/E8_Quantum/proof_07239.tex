...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0822
\end{equation}

Proof instance 7239 quantum parameter:
\begin{equation}
\hbar \omega_{7239} = 1.007758 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7239} = 1.06e+192
\end{equation}
