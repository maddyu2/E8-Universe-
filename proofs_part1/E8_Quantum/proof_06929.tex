...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8848
\end{equation}

Proof instance 6929 quantum parameter:
\begin{equation}
\hbar \omega_{6929} = 1.012264 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6929} = 1.08e+192
\end{equation}
