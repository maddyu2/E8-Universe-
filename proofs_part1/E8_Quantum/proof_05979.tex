...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5524
\end{equation}

Proof instance 5979 quantum parameter:
\begin{equation}
\hbar \omega_{5979} = 1.003558 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5979} = 8.44e+191
\end{equation}
