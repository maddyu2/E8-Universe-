...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.8649
\end{equation}

Proof instance 9819 quantum parameter:
\begin{equation}
\hbar \omega_{9819} = 0.981892 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9819} = 1.02e+192
\end{equation}
