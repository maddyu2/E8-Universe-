...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6704
\end{equation}

Proof instance 2519 quantum parameter:
\begin{equation}
\hbar \omega_{2519} = 1.008168 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2519} = 1.09e+192
\end{equation}
