...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7401
\end{equation}

Proof instance 7799 quantum parameter:
\begin{equation}
\hbar \omega_{7799} = 1.003530 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7799} = 9.04e+191
\end{equation}
