...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8880
\end{equation}

Proof instance 7469 quantum parameter:
\begin{equation}
\hbar \omega_{7469} = 1.018066 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7469} = 9.62e+191
\end{equation}
