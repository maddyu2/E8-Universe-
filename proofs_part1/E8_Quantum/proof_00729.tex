...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0618
\end{equation}

Proof instance 729 quantum parameter:
\begin{equation}
\hbar \omega_{729} = 1.009837 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{729} = 1.14e+192
\end{equation}
