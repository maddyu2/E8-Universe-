...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1631
\end{equation}

Proof instance 9119 quantum parameter:
\begin{equation}
\hbar \omega_{9119} = 1.001307 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9119} = 1.02e+192
\end{equation}
