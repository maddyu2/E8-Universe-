...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3877
\end{equation}

Proof instance 9729 quantum parameter:
\begin{equation}
\hbar \omega_{9729} = 0.988001 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9729} = 9.85e+191
\end{equation}
