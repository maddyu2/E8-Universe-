...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5181
\end{equation}

Proof instance 9009 quantum parameter:
\begin{equation}
\hbar \omega_{9009} = 1.011958 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9009} = 1.06e+192
\end{equation}
