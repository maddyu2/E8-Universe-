...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6828
\end{equation}

Proof instance 2929 quantum parameter:
\begin{equation}
\hbar \omega_{2929} = 1.004608 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2929} = 1.07e+192
\end{equation}
