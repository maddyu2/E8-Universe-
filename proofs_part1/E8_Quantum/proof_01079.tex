...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4824
\end{equation}

Proof instance 1079 quantum parameter:
\begin{equation}
\hbar \omega_{1079} = 0.999066 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1079} = 1.12e+192
\end{equation}
