...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.9442
\end{equation}

Proof instance 7779 quantum parameter:
\begin{equation}
\hbar \omega_{7779} = 0.984762 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7779} = 1.11e+192
\end{equation}
