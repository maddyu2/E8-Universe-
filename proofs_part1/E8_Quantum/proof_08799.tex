...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0661
\end{equation}

Proof instance 8799 quantum parameter:
\begin{equation}
\hbar \omega_{8799} = 1.015880 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8799} = 1.07e+192
\end{equation}
