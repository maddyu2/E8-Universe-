...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4661
\end{equation}

Proof instance 8759 quantum parameter:
\begin{equation}
\hbar \omega_{8759} = 1.006660 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8759} = 1.00e+192
\end{equation}
