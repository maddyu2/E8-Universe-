...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5484
\end{equation}

Proof instance 2989 quantum parameter:
\begin{equation}
\hbar \omega_{2989} = 0.999748 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2989} = 9.23e+191
\end{equation}
