...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9992
\end{equation}

Proof instance 6189 quantum parameter:
\begin{equation}
\hbar \omega_{6189} = 0.995008 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6189} = 1.10e+192
\end{equation}
