...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0085
\end{equation}

Proof instance 9599 quantum parameter:
\begin{equation}
\hbar \omega_{9599} = 0.989524 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9599} = 1.11e+192
\end{equation}
