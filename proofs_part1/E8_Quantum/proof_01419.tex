...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4935
\end{equation}

Proof instance 1419 quantum parameter:
\begin{equation}
\hbar \omega_{1419} = 0.986401 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1419} = 9.33e+191
\end{equation}
