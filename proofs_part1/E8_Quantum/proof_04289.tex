...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9539
\end{equation}

Proof instance 4289 quantum parameter:
\begin{equation}
\hbar \omega_{4289} = 0.986469 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4289} = 8.35e+191
\end{equation}
