...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3423
\end{equation}

Proof instance 269 quantum parameter:
\begin{equation}
\hbar \omega_{269} = 0.999356 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{269} = 9.40e+191
\end{equation}
