...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6837
\end{equation}

Proof instance 4629 quantum parameter:
\begin{equation}
\hbar \omega_{4629} = 0.998144 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4629} = 9.93e+191
\end{equation}
