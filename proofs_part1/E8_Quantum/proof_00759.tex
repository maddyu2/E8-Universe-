...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4201
\end{equation}

Proof instance 759 quantum parameter:
\begin{equation}
\hbar \omega_{759} = 1.013722 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{759} = 1.17e+192
\end{equation}
