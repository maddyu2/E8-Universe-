...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.9724
\end{equation}

Proof instance 6659 quantum parameter:
\begin{equation}
\hbar \omega_{6659} = 0.995171 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6659} = 1.00e+192
\end{equation}
