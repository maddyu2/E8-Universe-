...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0275
\end{equation}

Proof instance 9129 quantum parameter:
\begin{equation}
\hbar \omega_{9129} = 1.003576 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9129} = 1.14e+192
\end{equation}
