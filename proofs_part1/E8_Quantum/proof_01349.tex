...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.9431
\end{equation}

Proof instance 1349 quantum parameter:
\begin{equation}
\hbar \omega_{1349} = 0.994669 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1349} = 9.82e+191
\end{equation}
