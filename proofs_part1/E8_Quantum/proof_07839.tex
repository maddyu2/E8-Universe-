...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6573
\end{equation}

Proof instance 7839 quantum parameter:
\begin{equation}
\hbar \omega_{7839} = 0.992451 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7839} = 1.08e+192
\end{equation}
