...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9577
\end{equation}

Proof instance 6229 quantum parameter:
\begin{equation}
\hbar \omega_{6229} = 1.005338 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6229} = 9.61e+191
\end{equation}
