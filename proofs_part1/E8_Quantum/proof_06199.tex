...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5990
\end{equation}

Proof instance 6199 quantum parameter:
\begin{equation}
\hbar \omega_{6199} = 0.992670 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6199} = 1.07e+192
\end{equation}
