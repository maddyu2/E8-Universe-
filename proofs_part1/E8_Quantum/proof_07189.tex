...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2267
\end{equation}

Proof instance 7189 quantum parameter:
\begin{equation}
\hbar \omega_{7189} = 1.008440 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7189} = 7.19e+191
\end{equation}
