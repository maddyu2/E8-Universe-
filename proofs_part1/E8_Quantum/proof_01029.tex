...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8717
\end{equation}

Proof instance 1029 quantum parameter:
\begin{equation}
\hbar \omega_{1029} = 1.001934 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1029} = 9.90e+191
\end{equation}
