...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9055
\end{equation}

Proof instance 159 quantum parameter:
\begin{equation}
\hbar \omega_{159} = 0.987893 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{159} = 9.39e+191
\end{equation}
