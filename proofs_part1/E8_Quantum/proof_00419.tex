...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9005
\end{equation}

Proof instance 419 quantum parameter:
\begin{equation}
\hbar \omega_{419} = 0.996961 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{419} = 1.09e+192
\end{equation}
