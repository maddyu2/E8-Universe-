...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2581
\end{equation}

Proof instance 8609 quantum parameter:
\begin{equation}
\hbar \omega_{8609} = 0.986470 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8609} = 9.08e+191
\end{equation}
