...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9061
\end{equation}

Proof instance 5569 quantum parameter:
\begin{equation}
\hbar \omega_{5569} = 0.985001 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5569} = 1.09e+192
\end{equation}
