...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3882
\end{equation}

Proof instance 5529 quantum parameter:
\begin{equation}
\hbar \omega_{5529} = 1.006232 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5529} = 1.19e+192
\end{equation}
