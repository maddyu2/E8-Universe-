...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9142
\end{equation}

Proof instance 5109 quantum parameter:
\begin{equation}
\hbar \omega_{5109} = 1.006028 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5109} = 1.01e+192
\end{equation}
