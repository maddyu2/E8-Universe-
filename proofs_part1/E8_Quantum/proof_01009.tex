...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9315
\end{equation}

Proof instance 1009 quantum parameter:
\begin{equation}
\hbar \omega_{1009} = 0.990614 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1009} = 8.89e+191
\end{equation}
