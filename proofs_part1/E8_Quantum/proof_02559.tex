...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3843
\end{equation}

Proof instance 2559 quantum parameter:
\begin{equation}
\hbar \omega_{2559} = 1.010223 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2559} = 9.07e+191
\end{equation}
