...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1194
\end{equation}

Proof instance 1249 quantum parameter:
\begin{equation}
\hbar \omega_{1249} = 0.994998 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1249} = 1.02e+192
\end{equation}
