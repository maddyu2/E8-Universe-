...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5156
\end{equation}

Proof instance 4079 quantum parameter:
\begin{equation}
\hbar \omega_{4079} = 0.998561 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4079} = 1.07e+192
\end{equation}
