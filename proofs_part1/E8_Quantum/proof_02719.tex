...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8765
\end{equation}

Proof instance 2719 quantum parameter:
\begin{equation}
\hbar \omega_{2719} = 0.992673 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2719} = 1.12e+192
\end{equation}
