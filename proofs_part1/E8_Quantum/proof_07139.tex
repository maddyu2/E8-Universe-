...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4892
\end{equation}

Proof instance 7139 quantum parameter:
\begin{equation}
\hbar \omega_{7139} = 0.994694 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7139} = 1.01e+192
\end{equation}
