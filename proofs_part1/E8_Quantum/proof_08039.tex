...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6832
\end{equation}

Proof instance 8039 quantum parameter:
\begin{equation}
\hbar \omega_{8039} = 0.998494 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8039} = 8.99e+191
\end{equation}
