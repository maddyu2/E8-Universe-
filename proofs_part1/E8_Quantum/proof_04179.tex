...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8760
\end{equation}

Proof instance 4179 quantum parameter:
\begin{equation}
\hbar \omega_{4179} = 1.000782 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4179} = 1.05e+192
\end{equation}
