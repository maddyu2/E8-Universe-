...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4001
\end{equation}

Proof instance 7449 quantum parameter:
\begin{equation}
\hbar \omega_{7449} = 1.028692 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7449} = 1.15e+192
\end{equation}
