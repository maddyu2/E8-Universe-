...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9926
\end{equation}

Proof instance 2229 quantum parameter:
\begin{equation}
\hbar \omega_{2229} = 0.987416 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2229} = 1.07e+192
\end{equation}
