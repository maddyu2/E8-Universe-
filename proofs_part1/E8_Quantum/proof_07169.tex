...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3944
\end{equation}

Proof instance 7169 quantum parameter:
\begin{equation}
\hbar \omega_{7169} = 1.006454 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7169} = 1.07e+192
\end{equation}
