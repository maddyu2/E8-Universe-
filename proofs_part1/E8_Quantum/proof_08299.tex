...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5454
\end{equation}

Proof instance 8299 quantum parameter:
\begin{equation}
\hbar \omega_{8299} = 1.001090 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8299} = 1.07e+192
\end{equation}
