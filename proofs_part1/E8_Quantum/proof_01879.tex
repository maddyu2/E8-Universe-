...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3935
\end{equation}

Proof instance 1879 quantum parameter:
\begin{equation}
\hbar \omega_{1879} = 0.993512 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1879} = 1.06e+192
\end{equation}
