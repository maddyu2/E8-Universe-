...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6316
\end{equation}

Proof instance 1949 quantum parameter:
\begin{equation}
\hbar \omega_{1949} = 0.993032 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1949} = 8.37e+191
\end{equation}
