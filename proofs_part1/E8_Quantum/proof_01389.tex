...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7252
\end{equation}

Proof instance 1389 quantum parameter:
\begin{equation}
\hbar \omega_{1389} = 0.996684 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1389} = 9.43e+191
\end{equation}
