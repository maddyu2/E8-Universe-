...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9033
\end{equation}

Proof instance 2259 quantum parameter:
\begin{equation}
\hbar \omega_{2259} = 0.999443 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2259} = 1.00e+192
\end{equation}
