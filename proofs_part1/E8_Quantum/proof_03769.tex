...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.0580
\end{equation}

Proof instance 3769 quantum parameter:
\begin{equation}
\hbar \omega_{3769} = 1.000176 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3769} = 9.48e+191
\end{equation}
