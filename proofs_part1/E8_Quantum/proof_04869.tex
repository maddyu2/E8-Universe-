...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9196
\end{equation}

Proof instance 4869 quantum parameter:
\begin{equation}
\hbar \omega_{4869} = 0.998881 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4869} = 1.14e+192
\end{equation}
