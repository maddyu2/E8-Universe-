...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8045
\end{equation}

Proof instance 3209 quantum parameter:
\begin{equation}
\hbar \omega_{3209} = 0.999678 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3209} = 1.00e+192
\end{equation}
