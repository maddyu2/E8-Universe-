...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4664
\end{equation}

Proof instance 7379 quantum parameter:
\begin{equation}
\hbar \omega_{7379} = 1.003417 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7379} = 1.05e+192
\end{equation}
