...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8528
\end{equation}

Proof instance 7749 quantum parameter:
\begin{equation}
\hbar \omega_{7749} = 0.987919 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7749} = 1.00e+192
\end{equation}
