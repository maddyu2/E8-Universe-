...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5697
\end{equation}

Proof instance 1749 quantum parameter:
\begin{equation}
\hbar \omega_{1749} = 0.993307 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1749} = 8.62e+191
\end{equation}
