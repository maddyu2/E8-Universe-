...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4707
\end{equation}

Proof instance 5389 quantum parameter:
\begin{equation}
\hbar \omega_{5389} = 0.988141 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5389} = 9.65e+191
\end{equation}
