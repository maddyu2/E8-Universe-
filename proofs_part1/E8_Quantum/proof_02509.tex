...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2449
\end{equation}

Proof instance 2509 quantum parameter:
\begin{equation}
\hbar \omega_{2509} = 0.985589 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2509} = 1.03e+192
\end{equation}
