...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5691
\end{equation}

Proof instance 8339 quantum parameter:
\begin{equation}
\hbar \omega_{8339} = 0.991851 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8339} = 9.60e+191
\end{equation}
