...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9920
\end{equation}

Proof instance 8619 quantum parameter:
\begin{equation}
\hbar \omega_{8619} = 1.005617 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8619} = 1.12e+192
\end{equation}
