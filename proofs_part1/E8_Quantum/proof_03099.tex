...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9828
\end{equation}

Proof instance 3099 quantum parameter:
\begin{equation}
\hbar \omega_{3099} = 0.996988 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3099} = 1.08e+192
\end{equation}
