...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6182
\end{equation}

Proof instance 8529 quantum parameter:
\begin{equation}
\hbar \omega_{8529} = 0.981693 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8529} = 1.11e+192
\end{equation}
