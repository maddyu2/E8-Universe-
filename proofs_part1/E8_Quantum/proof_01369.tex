...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9748
\end{equation}

Proof instance 1369 quantum parameter:
\begin{equation}
\hbar \omega_{1369} = 0.994103 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1369} = 9.60e+191
\end{equation}
