...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8193
\end{equation}

Proof instance 9469 quantum parameter:
\begin{equation}
\hbar \omega_{9469} = 1.007178 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9469} = 8.78e+191
\end{equation}
