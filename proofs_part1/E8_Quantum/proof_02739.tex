...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3032
\end{equation}

Proof instance 2739 quantum parameter:
\begin{equation}
\hbar \omega_{2739} = 0.993253 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2739} = 9.47e+191
\end{equation}
