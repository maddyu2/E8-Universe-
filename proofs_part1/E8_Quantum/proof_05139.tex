...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5084
\end{equation}

Proof instance 5139 quantum parameter:
\begin{equation}
\hbar \omega_{5139} = 0.984607 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5139} = 9.69e+191
\end{equation}
