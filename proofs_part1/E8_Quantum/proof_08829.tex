...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2741
\end{equation}

Proof instance 8829 quantum parameter:
\begin{equation}
\hbar \omega_{8829} = 1.012254 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8829} = 1.08e+192
\end{equation}
