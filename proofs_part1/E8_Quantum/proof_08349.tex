...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.7618
\end{equation}

Proof instance 8349 quantum parameter:
\begin{equation}
\hbar \omega_{8349} = 0.992929 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8349} = 1.04e+192
\end{equation}
