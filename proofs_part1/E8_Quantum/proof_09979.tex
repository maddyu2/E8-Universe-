...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9124
\end{equation}

Proof instance 9979 quantum parameter:
\begin{equation}
\hbar \omega_{9979} = 1.016986 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9979} = 9.44e+191
\end{equation}
