...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6234
\end{equation}

Proof instance 2459 quantum parameter:
\begin{equation}
\hbar \omega_{2459} = 1.014007 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2459} = 9.83e+191
\end{equation}
