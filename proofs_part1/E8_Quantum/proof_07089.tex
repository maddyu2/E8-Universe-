...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0183
\end{equation}

Proof instance 7089 quantum parameter:
\begin{equation}
\hbar \omega_{7089} = 1.004018 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7089} = 8.97e+191
\end{equation}
