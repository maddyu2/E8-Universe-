...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4931
\end{equation}

Proof instance 689 quantum parameter:
\begin{equation}
\hbar \omega_{689} = 0.988582 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{689} = 1.10e+192
\end{equation}
