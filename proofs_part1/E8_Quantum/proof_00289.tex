...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5612
\end{equation}

Proof instance 289 quantum parameter:
\begin{equation}
\hbar \omega_{289} = 0.991641 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{289} = 1.02e+192
\end{equation}
