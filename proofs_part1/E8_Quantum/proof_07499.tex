...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0017
\end{equation}

Proof instance 7499 quantum parameter:
\begin{equation}
\hbar \omega_{7499} = 1.003387 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7499} = 9.56e+191
\end{equation}
