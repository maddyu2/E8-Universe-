...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5751
\end{equation}

Proof instance 6989 quantum parameter:
\begin{equation}
\hbar \omega_{6989} = 0.990369 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6989} = 9.41e+191
\end{equation}
