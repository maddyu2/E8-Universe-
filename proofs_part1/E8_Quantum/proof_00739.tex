...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4784
\end{equation}

Proof instance 739 quantum parameter:
\begin{equation}
\hbar \omega_{739} = 0.999222 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{739} = 1.14e+192
\end{equation}
