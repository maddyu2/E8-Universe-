...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0479
\end{equation}

Proof instance 9999 quantum parameter:
\begin{equation}
\hbar \omega_{9999} = 0.995116 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9999} = 9.48e+191
\end{equation}
