...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7977
\end{equation}

Proof instance 8739 quantum parameter:
\begin{equation}
\hbar \omega_{8739} = 0.998236 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8739} = 1.05e+192
\end{equation}
