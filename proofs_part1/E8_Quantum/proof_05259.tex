...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3296
\end{equation}

Proof instance 5259 quantum parameter:
\begin{equation}
\hbar \omega_{5259} = 0.996084 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5259} = 9.86e+191
\end{equation}
