...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5693
\end{equation}

Proof instance 5729 quantum parameter:
\begin{equation}
\hbar \omega_{5729} = 0.984795 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5729} = 1.15e+192
\end{equation}
