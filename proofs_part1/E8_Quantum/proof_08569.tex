...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0174
\end{equation}

Proof instance 8569 quantum parameter:
\begin{equation}
\hbar \omega_{8569} = 0.990383 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8569} = 1.09e+192
\end{equation}
