...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0108
\end{equation}

Proof instance 4929 quantum parameter:
\begin{equation}
\hbar \omega_{4929} = 0.997653 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4929} = 9.82e+191
\end{equation}
