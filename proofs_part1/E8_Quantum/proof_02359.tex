...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1339
\end{equation}

Proof instance 2359 quantum parameter:
\begin{equation}
\hbar \omega_{2359} = 0.979335 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2359} = 1.24e+192
\end{equation}
