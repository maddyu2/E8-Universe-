...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7482
\end{equation}

Proof instance 8499 quantum parameter:
\begin{equation}
\hbar \omega_{8499} = 1.017808 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8499} = 9.42e+191
\end{equation}
