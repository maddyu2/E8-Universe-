...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1948
\end{equation}

Proof instance 1639 quantum parameter:
\begin{equation}
\hbar \omega_{1639} = 0.998604 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1639} = 8.95e+191
\end{equation}
