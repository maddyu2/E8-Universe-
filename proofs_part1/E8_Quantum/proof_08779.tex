...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8202
\end{equation}

Proof instance 8779 quantum parameter:
\begin{equation}
\hbar \omega_{8779} = 1.013558 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8779} = 9.91e+191
\end{equation}
