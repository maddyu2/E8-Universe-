...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4311
\end{equation}

Proof instance 7589 quantum parameter:
\begin{equation}
\hbar \omega_{7589} = 0.980735 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7589} = 9.11e+191
\end{equation}
