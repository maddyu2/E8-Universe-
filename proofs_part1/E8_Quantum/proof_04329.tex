...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9311
\end{equation}

Proof instance 4329 quantum parameter:
\begin{equation}
\hbar \omega_{4329} = 1.011551 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4329} = 1.11e+192
\end{equation}
