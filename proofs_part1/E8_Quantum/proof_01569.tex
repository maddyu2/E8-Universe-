...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0866
\end{equation}

Proof instance 1569 quantum parameter:
\begin{equation}
\hbar \omega_{1569} = 1.004072 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1569} = 1.13e+192
\end{equation}
