...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.3509
\end{equation}

Proof instance 8889 quantum parameter:
\begin{equation}
\hbar \omega_{8889} = 0.996757 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8889} = 1.19e+192
\end{equation}
