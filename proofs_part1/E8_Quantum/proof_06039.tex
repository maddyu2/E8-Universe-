...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2729
\end{equation}

Proof instance 6039 quantum parameter:
\begin{equation}
\hbar \omega_{6039} = 1.023991 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6039} = 9.89e+191
\end{equation}
