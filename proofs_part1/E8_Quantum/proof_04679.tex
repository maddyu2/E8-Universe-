...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2256
\end{equation}

Proof instance 4679 quantum parameter:
\begin{equation}
\hbar \omega_{4679} = 0.984191 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4679} = 9.49e+191
\end{equation}
