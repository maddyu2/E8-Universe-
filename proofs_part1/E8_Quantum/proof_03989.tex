...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7476
\end{equation}

Proof instance 3989 quantum parameter:
\begin{equation}
\hbar \omega_{3989} = 1.022297 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3989} = 9.38e+191
\end{equation}
