...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0161
\end{equation}

Proof instance 1439 quantum parameter:
\begin{equation}
\hbar \omega_{1439} = 0.998447 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1439} = 1.04e+192
\end{equation}
