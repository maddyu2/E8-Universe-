...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3739
\end{equation}

Proof instance 6949 quantum parameter:
\begin{equation}
\hbar \omega_{6949} = 0.999295 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6949} = 9.56e+191
\end{equation}
