...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3592
\end{equation}

Proof instance 7759 quantum parameter:
\begin{equation}
\hbar \omega_{7759} = 1.007757 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7759} = 1.16e+192
\end{equation}
