...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2303
\end{equation}

Proof instance 1799 quantum parameter:
\begin{equation}
\hbar \omega_{1799} = 1.004556 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1799} = 8.01e+191
\end{equation}
