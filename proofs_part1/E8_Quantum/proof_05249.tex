...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9787
\end{equation}

Proof instance 5249 quantum parameter:
\begin{equation}
\hbar \omega_{5249} = 1.013848 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5249} = 1.04e+192
\end{equation}
