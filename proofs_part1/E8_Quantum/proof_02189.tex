...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6195
\end{equation}

Proof instance 2189 quantum parameter:
\begin{equation}
\hbar \omega_{2189} = 0.999544 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2189} = 1.12e+192
\end{equation}
