...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7258
\end{equation}

Proof instance 8639 quantum parameter:
\begin{equation}
\hbar \omega_{8639} = 1.002260 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8639} = 8.87e+191
\end{equation}
