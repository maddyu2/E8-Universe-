...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.5537
\end{equation}

Proof instance 6569 quantum parameter:
\begin{equation}
\hbar \omega_{6569} = 1.020784 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6569} = 1.06e+192
\end{equation}
