...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4964
\end{equation}

Proof instance 9879 quantum parameter:
\begin{equation}
\hbar \omega_{9879} = 0.981470 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9879} = 1.17e+192
\end{equation}
