...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8089
\end{equation}

Proof instance 5089 quantum parameter:
\begin{equation}
\hbar \omega_{5089} = 0.997599 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5089} = 8.38e+191
\end{equation}
