...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9035
\end{equation}

Proof instance 7939 quantum parameter:
\begin{equation}
\hbar \omega_{7939} = 1.006753 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7939} = 1.07e+192
\end{equation}
