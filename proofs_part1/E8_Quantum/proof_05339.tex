...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8448
\end{equation}

Proof instance 5339 quantum parameter:
\begin{equation}
\hbar \omega_{5339} = 0.993736 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5339} = 1.07e+192
\end{equation}
