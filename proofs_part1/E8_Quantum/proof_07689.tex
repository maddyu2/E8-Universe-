...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9194
\end{equation}

Proof instance 7689 quantum parameter:
\begin{equation}
\hbar \omega_{7689} = 0.999837 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7689} = 1.02e+192
\end{equation}
