...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.0053
\end{equation}

Proof instance 1519 quantum parameter:
\begin{equation}
\hbar \omega_{1519} = 1.009868 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1519} = 1.04e+192
\end{equation}
