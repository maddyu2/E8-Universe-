...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2786
\end{equation}

Proof instance 6299 quantum parameter:
\begin{equation}
\hbar \omega_{6299} = 0.984211 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6299} = 1.08e+192
\end{equation}
