...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4773
\end{equation}

Proof instance 4039 quantum parameter:
\begin{equation}
\hbar \omega_{4039} = 0.996031 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4039} = 9.03e+191
\end{equation}
