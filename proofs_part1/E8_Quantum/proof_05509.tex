...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8079
\end{equation}

Proof instance 5509 quantum parameter:
\begin{equation}
\hbar \omega_{5509} = 1.000079 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5509} = 8.82e+191
\end{equation}
