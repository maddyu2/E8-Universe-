...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7174
\end{equation}

Proof instance 9449 quantum parameter:
\begin{equation}
\hbar \omega_{9449} = 0.991763 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9449} = 1.17e+192
\end{equation}
