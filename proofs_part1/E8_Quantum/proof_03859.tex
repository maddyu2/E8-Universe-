...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3902
\end{equation}

Proof instance 3859 quantum parameter:
\begin{equation}
\hbar \omega_{3859} = 0.993861 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3859} = 1.12e+192
\end{equation}
