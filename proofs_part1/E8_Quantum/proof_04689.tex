...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8127
\end{equation}

Proof instance 4689 quantum parameter:
\begin{equation}
\hbar \omega_{4689} = 0.991168 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4689} = 9.56e+191
\end{equation}
