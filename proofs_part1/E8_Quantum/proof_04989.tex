...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2081
\end{equation}

Proof instance 4989 quantum parameter:
\begin{equation}
\hbar \omega_{4989} = 0.999790 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4989} = 8.47e+191
\end{equation}
