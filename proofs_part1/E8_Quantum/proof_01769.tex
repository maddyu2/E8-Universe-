...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8017
\end{equation}

Proof instance 1769 quantum parameter:
\begin{equation}
\hbar \omega_{1769} = 0.991351 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1769} = 9.82e+191
\end{equation}
