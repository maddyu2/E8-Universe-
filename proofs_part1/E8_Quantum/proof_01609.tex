...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4784
\end{equation}

Proof instance 1609 quantum parameter:
\begin{equation}
\hbar \omega_{1609} = 1.001328 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1609} = 1.06e+192
\end{equation}
