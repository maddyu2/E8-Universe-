...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1726
\end{equation}

Proof instance 3299 quantum parameter:
\begin{equation}
\hbar \omega_{3299} = 1.003469 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3299} = 9.31e+191
\end{equation}
