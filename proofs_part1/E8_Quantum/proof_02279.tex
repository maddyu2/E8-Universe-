...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9572
\end{equation}

Proof instance 2279 quantum parameter:
\begin{equation}
\hbar \omega_{2279} = 0.999923 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2279} = 9.97e+191
\end{equation}
