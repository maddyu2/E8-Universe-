...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8425
\end{equation}

Proof instance 3889 quantum parameter:
\begin{equation}
\hbar \omega_{3889} = 0.997255 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3889} = 1.05e+192
\end{equation}
