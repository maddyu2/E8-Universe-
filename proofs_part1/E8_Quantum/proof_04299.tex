...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6932
\end{equation}

Proof instance 4299 quantum parameter:
\begin{equation}
\hbar \omega_{4299} = 1.012183 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4299} = 9.94e+191
\end{equation}
