...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3135
\end{equation}

Proof instance 8709 quantum parameter:
\begin{equation}
\hbar \omega_{8709} = 0.997054 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8709} = 9.15e+191
\end{equation}
