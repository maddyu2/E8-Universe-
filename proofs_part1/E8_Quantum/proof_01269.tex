...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9258
\end{equation}

Proof instance 1269 quantum parameter:
\begin{equation}
\hbar \omega_{1269} = 1.002871 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1269} = 9.32e+191
\end{equation}
