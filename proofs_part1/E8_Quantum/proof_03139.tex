...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6027
\end{equation}

Proof instance 3139 quantum parameter:
\begin{equation}
\hbar \omega_{3139} = 0.995425 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3139} = 9.53e+191
\end{equation}
