...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5449
\end{equation}

Proof instance 979 quantum parameter:
\begin{equation}
\hbar \omega_{979} = 0.992724 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{979} = 9.69e+191
\end{equation}
