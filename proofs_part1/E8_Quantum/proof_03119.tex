...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3329
\end{equation}

Proof instance 3119 quantum parameter:
\begin{equation}
\hbar \omega_{3119} = 0.987084 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3119} = 8.51e+191
\end{equation}
