...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3975
\end{equation}

Proof instance 2179 quantum parameter:
\begin{equation}
\hbar \omega_{2179} = 1.003736 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2179} = 1.10e+192
\end{equation}
