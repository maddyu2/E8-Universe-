...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6060
\end{equation}

Proof instance 2949 quantum parameter:
\begin{equation}
\hbar \omega_{2949} = 0.994377 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2949} = 1.04e+192
\end{equation}
