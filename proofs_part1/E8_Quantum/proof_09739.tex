...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7567
\end{equation}

Proof instance 9739 quantum parameter:
\begin{equation}
\hbar \omega_{9739} = 0.999581 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9739} = 9.72e+191
\end{equation}
