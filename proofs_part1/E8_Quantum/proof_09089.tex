...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4246
\end{equation}

Proof instance 9089 quantum parameter:
\begin{equation}
\hbar \omega_{9089} = 0.997754 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9089} = 1.00e+192
\end{equation}
