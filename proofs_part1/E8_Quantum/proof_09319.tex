...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.8967
\end{equation}

Proof instance 9319 quantum parameter:
\begin{equation}
\hbar \omega_{9319} = 0.988208 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9319} = 9.45e+191
\end{equation}
