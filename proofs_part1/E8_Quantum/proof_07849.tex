...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1013
\end{equation}

Proof instance 7849 quantum parameter:
\begin{equation}
\hbar \omega_{7849} = 0.995490 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7849} = 9.34e+191
\end{equation}
