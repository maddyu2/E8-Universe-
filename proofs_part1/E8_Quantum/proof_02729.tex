...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7318
\end{equation}

Proof instance 2729 quantum parameter:
\begin{equation}
\hbar \omega_{2729} = 0.997160 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2729} = 9.88e+191
\end{equation}
