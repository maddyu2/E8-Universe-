...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1958
\end{equation}

Proof instance 9429 quantum parameter:
\begin{equation}
\hbar \omega_{9429} = 0.996393 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9429} = 9.16e+191
\end{equation}
