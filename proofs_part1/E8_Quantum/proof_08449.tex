...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8834
\end{equation}

Proof instance 8449 quantum parameter:
\begin{equation}
\hbar \omega_{8449} = 1.009050 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8449} = 1.03e+192
\end{equation}
