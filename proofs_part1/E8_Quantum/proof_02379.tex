...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7420
\end{equation}

Proof instance 2379 quantum parameter:
\begin{equation}
\hbar \omega_{2379} = 0.995901 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2379} = 9.63e+191
\end{equation}
