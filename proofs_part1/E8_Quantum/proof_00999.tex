...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3148
\end{equation}

Proof instance 999 quantum parameter:
\begin{equation}
\hbar \omega_{999} = 0.991416 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{999} = 1.01e+192
\end{equation}
