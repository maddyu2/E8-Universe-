...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9257
\end{equation}

Proof instance 7549 quantum parameter:
\begin{equation}
\hbar \omega_{7549} = 0.999203 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7549} = 8.75e+191
\end{equation}
