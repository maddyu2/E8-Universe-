...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1340
\end{equation}

Proof instance 9189 quantum parameter:
\begin{equation}
\hbar \omega_{9189} = 1.003220 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9189} = 1.16e+192
\end{equation}
