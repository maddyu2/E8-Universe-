...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6210
\end{equation}

Proof instance 4919 quantum parameter:
\begin{equation}
\hbar \omega_{4919} = 1.019232 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4919} = 8.85e+191
\end{equation}
