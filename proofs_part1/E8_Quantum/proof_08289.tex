...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4712
\end{equation}

Proof instance 8289 quantum parameter:
\begin{equation}
\hbar \omega_{8289} = 1.008391 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8289} = 1.14e+192
\end{equation}
