...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7880
\end{equation}

Proof instance 5739 quantum parameter:
\begin{equation}
\hbar \omega_{5739} = 0.994675 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5739} = 9.47e+191
\end{equation}
