...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7190
\end{equation}

Proof instance 6669 quantum parameter:
\begin{equation}
\hbar \omega_{6669} = 1.000218 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6669} = 1.09e+192
\end{equation}
