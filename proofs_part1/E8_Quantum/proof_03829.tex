...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3575
\end{equation}

Proof instance 3829 quantum parameter:
\begin{equation}
\hbar \omega_{3829} = 0.985273 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3829} = 9.51e+191
\end{equation}
