...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7463
\end{equation}

Proof instance 8949 quantum parameter:
\begin{equation}
\hbar \omega_{8949} = 1.003333 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8949} = 1.10e+192
\end{equation}
