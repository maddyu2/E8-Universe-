...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3577
\end{equation}

Proof instance 8769 quantum parameter:
\begin{equation}
\hbar \omega_{8769} = 1.015388 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8769} = 9.71e+191
\end{equation}
