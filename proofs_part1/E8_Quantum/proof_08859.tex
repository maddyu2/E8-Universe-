...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3995
\end{equation}

Proof instance 8859 quantum parameter:
\begin{equation}
\hbar \omega_{8859} = 1.005830 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8859} = 9.45e+191
\end{equation}
