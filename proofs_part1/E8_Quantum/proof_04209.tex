...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8513
\end{equation}

Proof instance 4209 quantum parameter:
\begin{equation}
\hbar \omega_{4209} = 1.000637 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4209} = 9.75e+191
\end{equation}
