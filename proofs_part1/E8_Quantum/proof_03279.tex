...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4777
\end{equation}

Proof instance 3279 quantum parameter:
\begin{equation}
\hbar \omega_{3279} = 0.991351 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3279} = 9.75e+191
\end{equation}
