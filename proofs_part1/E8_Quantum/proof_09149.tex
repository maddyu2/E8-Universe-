...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3880
\end{equation}

Proof instance 9149 quantum parameter:
\begin{equation}
\hbar \omega_{9149} = 1.005620 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9149} = 9.51e+191
\end{equation}
