...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4579
\end{equation}

Proof instance 1529 quantum parameter:
\begin{equation}
\hbar \omega_{1529} = 0.997185 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1529} = 9.54e+191
\end{equation}
