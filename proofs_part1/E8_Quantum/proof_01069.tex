...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7902
\end{equation}

Proof instance 1069 quantum parameter:
\begin{equation}
\hbar \omega_{1069} = 1.000339 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1069} = 1.08e+192
\end{equation}
