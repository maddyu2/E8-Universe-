...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3550
\end{equation}

Proof instance 3709 quantum parameter:
\begin{equation}
\hbar \omega_{3709} = 1.009344 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3709} = 1.07e+192
\end{equation}
