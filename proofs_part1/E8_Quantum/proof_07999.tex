...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5228
\end{equation}

Proof instance 7999 quantum parameter:
\begin{equation}
\hbar \omega_{7999} = 1.003747 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7999} = 9.32e+191
\end{equation}
