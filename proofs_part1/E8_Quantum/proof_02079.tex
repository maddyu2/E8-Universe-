...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4591
\end{equation}

Proof instance 2079 quantum parameter:
\begin{equation}
\hbar \omega_{2079} = 1.008369 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2079} = 1.02e+192
\end{equation}
