...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3996
\end{equation}

Proof instance 6239 quantum parameter:
\begin{equation}
\hbar \omega_{6239} = 0.975849 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6239} = 1.19e+192
\end{equation}
