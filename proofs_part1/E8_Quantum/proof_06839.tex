...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2488
\end{equation}

Proof instance 6839 quantum parameter:
\begin{equation}
\hbar \omega_{6839} = 0.991938 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6839} = 1.02e+192
\end{equation}
