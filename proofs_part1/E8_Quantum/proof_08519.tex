...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7300
\end{equation}

Proof instance 8519 quantum parameter:
\begin{equation}
\hbar \omega_{8519} = 1.011699 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8519} = 1.04e+192
\end{equation}
