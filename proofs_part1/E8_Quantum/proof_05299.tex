...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9753
\end{equation}

Proof instance 5299 quantum parameter:
\begin{equation}
\hbar \omega_{5299} = 0.994601 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5299} = 1.11e+192
\end{equation}
