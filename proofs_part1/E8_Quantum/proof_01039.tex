...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2813
\end{equation}

Proof instance 1039 quantum parameter:
\begin{equation}
\hbar \omega_{1039} = 0.996806 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1039} = 1.15e+192
\end{equation}
