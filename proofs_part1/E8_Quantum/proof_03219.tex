...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9395
\end{equation}

Proof instance 3219 quantum parameter:
\begin{equation}
\hbar \omega_{3219} = 0.974583 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3219} = 9.36e+191
\end{equation}
