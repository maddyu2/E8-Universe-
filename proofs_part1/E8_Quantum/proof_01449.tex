...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5404
\end{equation}

Proof instance 1449 quantum parameter:
\begin{equation}
\hbar \omega_{1449} = 1.002974 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1449} = 9.84e+191
\end{equation}
