...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0909
\end{equation}

Proof instance 1259 quantum parameter:
\begin{equation}
\hbar \omega_{1259} = 1.012538 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1259} = 9.44e+191
\end{equation}
