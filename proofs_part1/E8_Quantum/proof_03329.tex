...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7485
\end{equation}

Proof instance 3329 quantum parameter:
\begin{equation}
\hbar \omega_{3329} = 0.995010 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3329} = 8.15e+191
\end{equation}
