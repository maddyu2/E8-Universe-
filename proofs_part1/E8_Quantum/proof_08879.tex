...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4312
\end{equation}

Proof instance 8879 quantum parameter:
\begin{equation}
\hbar \omega_{8879} = 1.002252 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8879} = 8.39e+191
\end{equation}
