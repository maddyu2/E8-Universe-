...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5399
\end{equation}

Proof instance 4909 quantum parameter:
\begin{equation}
\hbar \omega_{4909} = 1.003786 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4909} = 1.21e+192
\end{equation}
