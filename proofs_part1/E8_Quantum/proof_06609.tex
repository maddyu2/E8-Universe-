...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2103
\end{equation}

Proof instance 6609 quantum parameter:
\begin{equation}
\hbar \omega_{6609} = 1.002080 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6609} = 1.12e+192
\end{equation}
