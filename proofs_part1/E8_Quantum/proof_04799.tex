...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3735
\end{equation}

Proof instance 4799 quantum parameter:
\begin{equation}
\hbar \omega_{4799} = 1.004067 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4799} = 9.96e+191
\end{equation}
