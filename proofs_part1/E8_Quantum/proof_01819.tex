...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3444
\end{equation}

Proof instance 1819 quantum parameter:
\begin{equation}
\hbar \omega_{1819} = 1.017389 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1819} = 9.41e+191
\end{equation}
