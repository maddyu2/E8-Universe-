...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6324
\end{equation}

Proof instance 7479 quantum parameter:
\begin{equation}
\hbar \omega_{7479} = 1.001819 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7479} = 1.13e+192
\end{equation}
