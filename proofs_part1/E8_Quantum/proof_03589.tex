...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4264
\end{equation}

Proof instance 3589 quantum parameter:
\begin{equation}
\hbar \omega_{3589} = 0.996179 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3589} = 9.55e+191
\end{equation}
