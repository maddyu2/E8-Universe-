...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1842
\end{equation}

Proof instance 4889 quantum parameter:
\begin{equation}
\hbar \omega_{4889} = 0.984285 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4889} = 7.70e+191
\end{equation}
