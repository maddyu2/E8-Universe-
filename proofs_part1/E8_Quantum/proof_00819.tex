...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7600
\end{equation}

Proof instance 819 quantum parameter:
\begin{equation}
\hbar \omega_{819} = 0.996742 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{819} = 1.07e+192
\end{equation}
