...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7638
\end{equation}

Proof instance 7319 quantum parameter:
\begin{equation}
\hbar \omega_{7319} = 1.000525 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7319} = 8.48e+191
\end{equation}
