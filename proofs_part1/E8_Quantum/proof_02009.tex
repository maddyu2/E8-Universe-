...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9276
\end{equation}

Proof instance 2009 quantum parameter:
\begin{equation}
\hbar \omega_{2009} = 0.999750 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2009} = 1.04e+192
\end{equation}
