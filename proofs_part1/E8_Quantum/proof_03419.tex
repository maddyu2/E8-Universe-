...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.1227
\end{equation}

Proof instance 3419 quantum parameter:
\begin{equation}
\hbar \omega_{3419} = 0.995791 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3419} = 9.03e+191
\end{equation}
