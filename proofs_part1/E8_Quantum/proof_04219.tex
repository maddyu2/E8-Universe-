...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.9678
\end{equation}

Proof instance 4219 quantum parameter:
\begin{equation}
\hbar \omega_{4219} = 1.000376 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4219} = 1.03e+192
\end{equation}
