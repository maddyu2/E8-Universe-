...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5948
\end{equation}

Proof instance 8839 quantum parameter:
\begin{equation}
\hbar \omega_{8839} = 1.000526 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8839} = 1.06e+192
\end{equation}
