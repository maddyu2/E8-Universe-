...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3606
\end{equation}

Proof instance 5819 quantum parameter:
\begin{equation}
\hbar \omega_{5819} = 1.004954 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5819} = 1.11e+192
\end{equation}
