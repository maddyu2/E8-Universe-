...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1323
\end{equation}

Proof instance 1649 quantum parameter:
\begin{equation}
\hbar \omega_{1649} = 0.982387 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1649} = 8.90e+191
\end{equation}
