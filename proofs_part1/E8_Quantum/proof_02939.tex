...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1795
\end{equation}

Proof instance 2939 quantum parameter:
\begin{equation}
\hbar \omega_{2939} = 0.997697 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2939} = 8.08e+191
\end{equation}
