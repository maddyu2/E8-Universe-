...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7640
\end{equation}

Proof instance 8689 quantum parameter:
\begin{equation}
\hbar \omega_{8689} = 0.999441 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8689} = 1.06e+192
\end{equation}
