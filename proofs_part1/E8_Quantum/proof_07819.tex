...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9142
\end{equation}

Proof instance 7819 quantum parameter:
\begin{equation}
\hbar \omega_{7819} = 1.006882 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7819} = 1.09e+192
\end{equation}
