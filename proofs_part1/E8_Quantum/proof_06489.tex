...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5592
\end{equation}

Proof instance 6489 quantum parameter:
\begin{equation}
\hbar \omega_{6489} = 0.986363 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6489} = 8.78e+191
\end{equation}
