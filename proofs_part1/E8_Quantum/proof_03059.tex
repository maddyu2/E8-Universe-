...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1235
\end{equation}

Proof instance 3059 quantum parameter:
\begin{equation}
\hbar \omega_{3059} = 1.008909 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3059} = 9.74e+191
\end{equation}
