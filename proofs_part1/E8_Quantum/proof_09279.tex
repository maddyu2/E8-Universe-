...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9675
\end{equation}

Proof instance 9279 quantum parameter:
\begin{equation}
\hbar \omega_{9279} = 1.003677 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9279} = 1.14e+192
\end{equation}
