...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7030
\end{equation}

Proof instance 2859 quantum parameter:
\begin{equation}
\hbar \omega_{2859} = 1.016164 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2859} = 9.95e+191
\end{equation}
