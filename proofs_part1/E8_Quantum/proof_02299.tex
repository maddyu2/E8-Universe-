...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0839
\end{equation}

Proof instance 2299 quantum parameter:
\begin{equation}
\hbar \omega_{2299} = 0.982257 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2299} = 8.61e+191
\end{equation}
