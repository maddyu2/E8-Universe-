...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6864
\end{equation}

Proof instance 3429 quantum parameter:
\begin{equation}
\hbar \omega_{3429} = 1.022758 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3429} = 1.07e+192
\end{equation}
