...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8146
\end{equation}

Proof instance 1539 quantum parameter:
\begin{equation}
\hbar \omega_{1539} = 0.996388 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1539} = 1.03e+192
\end{equation}
