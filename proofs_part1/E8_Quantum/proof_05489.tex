...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3686
\end{equation}

Proof instance 5489 quantum parameter:
\begin{equation}
\hbar \omega_{5489} = 0.982584 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5489} = 9.23e+191
\end{equation}
