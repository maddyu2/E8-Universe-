...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9542
\end{equation}

Proof instance 5589 quantum parameter:
\begin{equation}
\hbar \omega_{5589} = 1.004233 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5589} = 1.17e+192
\end{equation}
