...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3257
\end{equation}

Proof instance 4369 quantum parameter:
\begin{equation}
\hbar \omega_{4369} = 1.017943 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4369} = 1.04e+192
\end{equation}
