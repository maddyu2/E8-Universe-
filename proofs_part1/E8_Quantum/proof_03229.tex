...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2359
\end{equation}

Proof instance 3229 quantum parameter:
\begin{equation}
\hbar \omega_{3229} = 0.999671 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3229} = 1.05e+192
\end{equation}
