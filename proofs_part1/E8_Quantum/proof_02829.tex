...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1290
\end{equation}

Proof instance 2829 quantum parameter:
\begin{equation}
\hbar \omega_{2829} = 1.004978 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2829} = 8.87e+191
\end{equation}
