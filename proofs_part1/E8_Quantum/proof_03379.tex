...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7633
\end{equation}

Proof instance 3379 quantum parameter:
\begin{equation}
\hbar \omega_{3379} = 0.982272 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3379} = 1.04e+192
\end{equation}
