...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7533
\end{equation}

Proof instance 9439 quantum parameter:
\begin{equation}
\hbar \omega_{9439} = 1.002670 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9439} = 8.98e+191
\end{equation}
