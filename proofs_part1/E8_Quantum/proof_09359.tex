...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2705
\end{equation}

Proof instance 9359 quantum parameter:
\begin{equation}
\hbar \omega_{9359} = 1.016957 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9359} = 8.97e+191
\end{equation}
