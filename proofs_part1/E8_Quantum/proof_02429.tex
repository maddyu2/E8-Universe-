...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6118
\end{equation}

Proof instance 2429 quantum parameter:
\begin{equation}
\hbar \omega_{2429} = 0.987348 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2429} = 9.82e+191
\end{equation}
