...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5158
\end{equation}

Proof instance 8079 quantum parameter:
\begin{equation}
\hbar \omega_{8079} = 0.985865 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8079} = 9.81e+191
\end{equation}
