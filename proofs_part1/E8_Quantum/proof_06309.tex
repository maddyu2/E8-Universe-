...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8268
\end{equation}

Proof instance 6309 quantum parameter:
\begin{equation}
\hbar \omega_{6309} = 1.023509 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6309} = 1.00e+192
\end{equation}
