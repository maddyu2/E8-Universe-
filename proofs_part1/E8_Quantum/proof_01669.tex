...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0646
\end{equation}

Proof instance 1669 quantum parameter:
\begin{equation}
\hbar \omega_{1669} = 0.996734 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1669} = 8.55e+191
\end{equation}
