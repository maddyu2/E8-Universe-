...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5410
\end{equation}

Proof instance 3169 quantum parameter:
\begin{equation}
\hbar \omega_{3169} = 0.983787 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3169} = 7.94e+191
\end{equation}
