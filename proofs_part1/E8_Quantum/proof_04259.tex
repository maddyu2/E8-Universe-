...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8620
\end{equation}

Proof instance 4259 quantum parameter:
\begin{equation}
\hbar \omega_{4259} = 1.011600 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4259} = 9.73e+191
\end{equation}
