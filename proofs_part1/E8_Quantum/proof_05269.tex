...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8109
\end{equation}

Proof instance 5269 quantum parameter:
\begin{equation}
\hbar \omega_{5269} = 0.988703 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5269} = 1.29e+192
\end{equation}
