...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7458
\end{equation}

Proof instance 959 quantum parameter:
\begin{equation}
\hbar \omega_{959} = 0.985804 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{959} = 1.24e+192
\end{equation}
