...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9632
\end{equation}

Proof instance 539 quantum parameter:
\begin{equation}
\hbar \omega_{539} = 0.992764 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{539} = 9.98e+191
\end{equation}
