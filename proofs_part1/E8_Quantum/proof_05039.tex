...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9588
\end{equation}

Proof instance 5039 quantum parameter:
\begin{equation}
\hbar \omega_{5039} = 1.002188 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5039} = 9.89e+191
\end{equation}
