...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6763
\end{equation}

Proof instance 9219 quantum parameter:
\begin{equation}
\hbar \omega_{9219} = 1.000610 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9219} = 9.95e+191
\end{equation}
