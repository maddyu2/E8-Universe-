...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1989
\end{equation}

Proof instance 7609 quantum parameter:
\begin{equation}
\hbar \omega_{7609} = 1.006811 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7609} = 1.02e+192
\end{equation}
