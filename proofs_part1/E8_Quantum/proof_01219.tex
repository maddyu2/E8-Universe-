...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0166
\end{equation}

Proof instance 1219 quantum parameter:
\begin{equation}
\hbar \omega_{1219} = 1.006082 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1219} = 1.18e+192
\end{equation}
