...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1915
\end{equation}

Proof instance 249 quantum parameter:
\begin{equation}
\hbar \omega_{249} = 1.006085 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{249} = 1.14e+192
\end{equation}
