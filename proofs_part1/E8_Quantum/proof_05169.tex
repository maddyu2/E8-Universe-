...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5116
\end{equation}

Proof instance 5169 quantum parameter:
\begin{equation}
\hbar \omega_{5169} = 0.982166 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5169} = 9.42e+191
\end{equation}
