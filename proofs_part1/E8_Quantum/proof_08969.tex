...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4756
\end{equation}

Proof instance 8969 quantum parameter:
\begin{equation}
\hbar \omega_{8969} = 0.984656 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8969} = 8.47e+191
\end{equation}
