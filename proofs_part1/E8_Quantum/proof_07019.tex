...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3199
\end{equation}

Proof instance 7019 quantum parameter:
\begin{equation}
\hbar \omega_{7019} = 0.990132 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7019} = 1.01e+192
\end{equation}
