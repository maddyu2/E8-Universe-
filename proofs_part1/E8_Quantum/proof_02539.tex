...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9526
\end{equation}

Proof instance 2539 quantum parameter:
\begin{equation}
\hbar \omega_{2539} = 0.998067 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2539} = 9.64e+191
\end{equation}
