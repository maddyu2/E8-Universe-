...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6911
\end{equation}

Proof instance 5279 quantum parameter:
\begin{equation}
\hbar \omega_{5279} = 0.973204 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5279} = 9.97e+191
\end{equation}
