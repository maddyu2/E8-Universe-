...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8677
\end{equation}

Proof instance 5899 quantum parameter:
\begin{equation}
\hbar \omega_{5899} = 1.002602 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5899} = 9.73e+191
\end{equation}
