...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2998
\end{equation}

Proof instance 1049 quantum parameter:
\begin{equation}
\hbar \omega_{1049} = 0.989005 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1049} = 1.06e+192
\end{equation}
