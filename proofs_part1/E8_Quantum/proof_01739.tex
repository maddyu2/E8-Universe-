...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7204
\end{equation}

Proof instance 1739 quantum parameter:
\begin{equation}
\hbar \omega_{1739} = 1.004537 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1739} = 1.16e+192
\end{equation}
