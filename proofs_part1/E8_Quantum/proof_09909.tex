...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0358
\end{equation}

Proof instance 9909 quantum parameter:
\begin{equation}
\hbar \omega_{9909} = 0.999604 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9909} = 9.36e+191
\end{equation}
