...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5554
\end{equation}

Proof instance 2119 quantum parameter:
\begin{equation}
\hbar \omega_{2119} = 0.995426 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2119} = 1.02e+192
\end{equation}
