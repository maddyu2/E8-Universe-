...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9476
\end{equation}

Proof instance 2979 quantum parameter:
\begin{equation}
\hbar \omega_{2979} = 0.994356 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2979} = 1.02e+192
\end{equation}
