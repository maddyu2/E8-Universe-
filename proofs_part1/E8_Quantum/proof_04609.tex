...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1197
\end{equation}

Proof instance 4609 quantum parameter:
\begin{equation}
\hbar \omega_{4609} = 1.010724 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4609} = 1.03e+192
\end{equation}
