...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5799
\end{equation}

Proof instance 429 quantum parameter:
\begin{equation}
\hbar \omega_{429} = 1.007514 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{429} = 8.58e+191
\end{equation}
