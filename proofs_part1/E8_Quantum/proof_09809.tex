...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0898
\end{equation}

Proof instance 9809 quantum parameter:
\begin{equation}
\hbar \omega_{9809} = 0.999377 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9809} = 1.07e+192
\end{equation}
