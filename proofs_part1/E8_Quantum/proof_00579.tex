...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1297
\end{equation}

Proof instance 579 quantum parameter:
\begin{equation}
\hbar \omega_{579} = 0.996073 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{579} = 1.08e+192
\end{equation}
