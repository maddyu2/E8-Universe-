...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6195
\end{equation}

Proof instance 3189 quantum parameter:
\begin{equation}
\hbar \omega_{3189} = 0.998827 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3189} = 9.20e+191
\end{equation}
