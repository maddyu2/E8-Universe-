...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8532
\end{equation}

Proof instance 6439 quantum parameter:
\begin{equation}
\hbar \omega_{6439} = 1.033215 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6439} = 1.01e+192
\end{equation}
