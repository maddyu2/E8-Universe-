...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7593
\end{equation}

Proof instance 7869 quantum parameter:
\begin{equation}
\hbar \omega_{7869} = 0.992821 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7869} = 1.09e+192
\end{equation}
