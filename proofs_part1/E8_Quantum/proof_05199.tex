...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.4476
\end{equation}

Proof instance 5199 quantum parameter:
\begin{equation}
\hbar \omega_{5199} = 1.008247 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5199} = 1.16e+192
\end{equation}
