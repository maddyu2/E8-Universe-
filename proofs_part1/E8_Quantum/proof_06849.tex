...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.2744
\end{equation}

Proof instance 6849 quantum parameter:
\begin{equation}
\hbar \omega_{6849} = 0.991351 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6849} = 1.23e+192
\end{equation}
