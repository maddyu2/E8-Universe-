...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6796
\end{equation}

Proof instance 7329 quantum parameter:
\begin{equation}
\hbar \omega_{7329} = 0.996443 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7329} = 1.12e+192
\end{equation}
