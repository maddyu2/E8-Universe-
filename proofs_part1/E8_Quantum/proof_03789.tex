...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1682
\end{equation}

Proof instance 3789 quantum parameter:
\begin{equation}
\hbar \omega_{3789} = 1.011398 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3789} = 1.04e+192
\end{equation}
