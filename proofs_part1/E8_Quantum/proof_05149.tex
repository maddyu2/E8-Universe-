...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3996
\end{equation}

Proof instance 5149 quantum parameter:
\begin{equation}
\hbar \omega_{5149} = 1.010550 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5149} = 1.11e+192
\end{equation}
