...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2423
\end{equation}

Proof instance 9079 quantum parameter:
\begin{equation}
\hbar \omega_{9079} = 0.984134 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9079} = 1.11e+192
\end{equation}
