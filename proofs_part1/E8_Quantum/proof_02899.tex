...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7552
\end{equation}

Proof instance 2899 quantum parameter:
\begin{equation}
\hbar \omega_{2899} = 1.006906 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2899} = 1.03e+192
\end{equation}
