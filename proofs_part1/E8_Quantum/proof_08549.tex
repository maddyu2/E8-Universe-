...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5703
\end{equation}

Proof instance 8549 quantum parameter:
\begin{equation}
\hbar \omega_{8549} = 0.998391 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8549} = 9.51e+191
\end{equation}
