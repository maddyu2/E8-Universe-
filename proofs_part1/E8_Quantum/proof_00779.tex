...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7792
\end{equation}

Proof instance 779 quantum parameter:
\begin{equation}
\hbar \omega_{779} = 1.005032 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{779} = 1.05e+192
\end{equation}
