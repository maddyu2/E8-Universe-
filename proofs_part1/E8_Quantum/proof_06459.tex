...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7314
\end{equation}

Proof instance 6459 quantum parameter:
\begin{equation}
\hbar \omega_{6459} = 1.000502 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6459} = 1.03e+192
\end{equation}
