...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9885
\end{equation}

Proof instance 8229 quantum parameter:
\begin{equation}
\hbar \omega_{8229} = 1.016077 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8229} = 9.23e+191
\end{equation}
