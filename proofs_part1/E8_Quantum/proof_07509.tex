...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1672
\end{equation}

Proof instance 7509 quantum parameter:
\begin{equation}
\hbar \omega_{7509} = 1.001271 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7509} = 9.27e+191
\end{equation}
