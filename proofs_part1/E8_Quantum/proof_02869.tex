...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6507
\end{equation}

Proof instance 2869 quantum parameter:
\begin{equation}
\hbar \omega_{2869} = 1.000539 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2869} = 1.00e+192
\end{equation}
