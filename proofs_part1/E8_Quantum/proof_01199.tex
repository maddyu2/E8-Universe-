...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3445
\end{equation}

Proof instance 1199 quantum parameter:
\begin{equation}
\hbar \omega_{1199} = 0.994914 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1199} = 8.66e+191
\end{equation}
