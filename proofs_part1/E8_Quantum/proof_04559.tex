...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2185
\end{equation}

Proof instance 4559 quantum parameter:
\begin{equation}
\hbar \omega_{4559} = 1.003319 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4559} = 9.91e+191
\end{equation}
