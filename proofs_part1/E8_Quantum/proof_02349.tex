...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7127
\end{equation}

Proof instance 2349 quantum parameter:
\begin{equation}
\hbar \omega_{2349} = 1.006980 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2349} = 1.06e+192
\end{equation}
