...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2067
\end{equation}

Proof instance 1129 quantum parameter:
\begin{equation}
\hbar \omega_{1129} = 0.990754 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1129} = 8.50e+191
\end{equation}
