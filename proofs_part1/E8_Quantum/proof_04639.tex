...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2366
\end{equation}

Proof instance 4639 quantum parameter:
\begin{equation}
\hbar \omega_{4639} = 1.000351 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4639} = 1.13e+192
\end{equation}
