...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2026
\end{equation}

Proof instance 1119 quantum parameter:
\begin{equation}
\hbar \omega_{1119} = 0.990238 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1119} = 9.76e+191
\end{equation}
