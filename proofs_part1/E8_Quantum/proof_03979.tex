...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5643
\end{equation}

Proof instance 3979 quantum parameter:
\begin{equation}
\hbar \omega_{3979} = 0.997675 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3979} = 1.14e+192
\end{equation}
