...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6489
\end{equation}

Proof instance 5889 quantum parameter:
\begin{equation}
\hbar \omega_{5889} = 0.994398 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5889} = 9.55e+191
\end{equation}
