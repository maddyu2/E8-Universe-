...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9856
\end{equation}

Proof instance 3719 quantum parameter:
\begin{equation}
\hbar \omega_{3719} = 1.024312 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3719} = 1.12e+192
\end{equation}
