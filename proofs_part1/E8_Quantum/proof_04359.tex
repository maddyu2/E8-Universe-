...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2848
\end{equation}

Proof instance 4359 quantum parameter:
\begin{equation}
\hbar \omega_{4359} = 1.007534 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4359} = 1.12e+192
\end{equation}
