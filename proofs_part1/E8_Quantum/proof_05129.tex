...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.5986
\end{equation}

Proof instance 5129 quantum parameter:
\begin{equation}
\hbar \omega_{5129} = 0.988983 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5129} = 1.19e+192
\end{equation}
