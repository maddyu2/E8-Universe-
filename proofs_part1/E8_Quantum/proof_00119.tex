...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6504
\end{equation}

Proof instance 119 quantum parameter:
\begin{equation}
\hbar \omega_{119} = 0.992369 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{119} = 9.99e+191
\end{equation}
