...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9043
\end{equation}

Proof instance 2069 quantum parameter:
\begin{equation}
\hbar \omega_{2069} = 1.001730 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2069} = 9.25e+191
\end{equation}
