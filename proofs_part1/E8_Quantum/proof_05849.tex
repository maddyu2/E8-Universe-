...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4910
\end{equation}

Proof instance 5849 quantum parameter:
\begin{equation}
\hbar \omega_{5849} = 1.002830 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5849} = 9.42e+191
\end{equation}
