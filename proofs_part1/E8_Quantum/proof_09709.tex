...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4131
\end{equation}

Proof instance 9709 quantum parameter:
\begin{equation}
\hbar \omega_{9709} = 0.998226 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9709} = 1.15e+192
\end{equation}
