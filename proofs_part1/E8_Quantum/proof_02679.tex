...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3670
\end{equation}

Proof instance 2679 quantum parameter:
\begin{equation}
\hbar \omega_{2679} = 1.001331 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2679} = 7.19e+191
\end{equation}
