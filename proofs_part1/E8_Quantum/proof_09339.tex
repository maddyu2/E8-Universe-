...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.3211
\end{equation}

Proof instance 9339 quantum parameter:
\begin{equation}
\hbar \omega_{9339} = 1.006743 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9339} = 7.81e+191
\end{equation}
