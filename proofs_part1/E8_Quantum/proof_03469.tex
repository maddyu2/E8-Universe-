...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4210
\end{equation}

Proof instance 3469 quantum parameter:
\begin{equation}
\hbar \omega_{3469} = 1.002901 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3469} = 9.48e+191
\end{equation}
