...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.7193
\end{equation}

Proof instance 2209 quantum parameter:
\begin{equation}
\hbar \omega_{2209} = 1.004531 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2209} = 8.32e+191
\end{equation}
