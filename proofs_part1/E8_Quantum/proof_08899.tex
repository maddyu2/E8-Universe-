...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4816
\end{equation}

Proof instance 8899 quantum parameter:
\begin{equation}
\hbar \omega_{8899} = 1.000564 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8899} = 1.04e+192
\end{equation}
