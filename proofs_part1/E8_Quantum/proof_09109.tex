...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5819
\end{equation}

Proof instance 9109 quantum parameter:
\begin{equation}
\hbar \omega_{9109} = 0.993273 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9109} = 1.01e+192
\end{equation}
