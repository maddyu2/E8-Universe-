...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.3503
\end{equation}

Proof instance 7699 quantum parameter:
\begin{equation}
\hbar \omega_{7699} = 1.006419 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7699} = 1.01e+192
\end{equation}
