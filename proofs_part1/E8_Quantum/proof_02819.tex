...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8635
\end{equation}

Proof instance 2819 quantum parameter:
\begin{equation}
\hbar \omega_{2819} = 0.994750 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2819} = 1.05e+192
\end{equation}
