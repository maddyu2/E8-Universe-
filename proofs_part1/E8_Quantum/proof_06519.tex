...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2757
\end{equation}

Proof instance 6519 quantum parameter:
\begin{equation}
\hbar \omega_{6519} = 0.994141 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6519} = 1.04e+192
\end{equation}
