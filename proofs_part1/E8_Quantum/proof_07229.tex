...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4737
\end{equation}

Proof instance 7229 quantum parameter:
\begin{equation}
\hbar \omega_{7229} = 1.006868 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7229} = 1.21e+192
\end{equation}
