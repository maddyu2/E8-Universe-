...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1308
\end{equation}

Proof instance 2479 quantum parameter:
\begin{equation}
\hbar \omega_{2479} = 0.998750 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2479} = 9.95e+191
\end{equation}
