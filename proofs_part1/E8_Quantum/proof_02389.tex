...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6591
\end{equation}

Proof instance 2389 quantum parameter:
\begin{equation}
\hbar \omega_{2389} = 1.004733 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2389} = 1.15e+192
\end{equation}
