...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6179
\end{equation}

Proof instance 4569 quantum parameter:
\begin{equation}
\hbar \omega_{4569} = 1.000213 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4569} = 9.65e+191
\end{equation}
