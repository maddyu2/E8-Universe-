...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5933
\end{equation}

Proof instance 8159 quantum parameter:
\begin{equation}
\hbar \omega_{8159} = 0.991412 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8159} = 9.77e+191
\end{equation}
