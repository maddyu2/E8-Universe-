...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6691
\end{equation}

Proof instance 6149 quantum parameter:
\begin{equation}
\hbar \omega_{6149} = 0.983711 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6149} = 1.03e+192
\end{equation}
