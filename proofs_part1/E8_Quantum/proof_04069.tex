...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5558
\end{equation}

Proof instance 4069 quantum parameter:
\begin{equation}
\hbar \omega_{4069} = 0.991996 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4069} = 1.11e+192
\end{equation}
