...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8636
\end{equation}

Proof instance 9139 quantum parameter:
\begin{equation}
\hbar \omega_{9139} = 0.988854 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9139} = 9.33e+191
\end{equation}
