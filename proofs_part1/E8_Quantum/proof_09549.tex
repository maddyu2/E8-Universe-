...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3556
\end{equation}

Proof instance 9549 quantum parameter:
\begin{equation}
\hbar \omega_{9549} = 0.980480 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9549} = 9.50e+191
\end{equation}
