...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4172
\end{equation}

Proof instance 8379 quantum parameter:
\begin{equation}
\hbar \omega_{8379} = 0.993658 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8379} = 9.86e+191
\end{equation}
