...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1856
\end{equation}

Proof instance 3539 quantum parameter:
\begin{equation}
\hbar \omega_{3539} = 0.986508 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3539} = 1.12e+192
\end{equation}
