...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2736
\end{equation}

Proof instance 7179 quantum parameter:
\begin{equation}
\hbar \omega_{7179} = 0.984666 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7179} = 1.06e+192
\end{equation}
