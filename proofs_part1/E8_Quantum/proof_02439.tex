...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.1142
\end{equation}

Proof instance 2439 quantum parameter:
\begin{equation}
\hbar \omega_{2439} = 1.006627 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2439} = 9.37e+191
\end{equation}
