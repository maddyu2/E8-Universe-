...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3271
\end{equation}

Proof instance 2799 quantum parameter:
\begin{equation}
\hbar \omega_{2799} = 1.000485 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2799} = 1.10e+192
\end{equation}
