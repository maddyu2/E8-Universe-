...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.4966
\end{equation}

Proof instance 2399 quantum parameter:
\begin{equation}
\hbar \omega_{2399} = 0.991915 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2399} = 1.14e+192
\end{equation}
