...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3696
\end{equation}

Proof instance 6079 quantum parameter:
\begin{equation}
\hbar \omega_{6079} = 1.002599 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6079} = 1.11e+192
\end{equation}
