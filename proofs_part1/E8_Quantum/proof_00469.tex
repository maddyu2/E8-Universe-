...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.6761
\end{equation}

Proof instance 469 quantum parameter:
\begin{equation}
\hbar \omega_{469} = 1.008610 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{469} = 9.45e+191
\end{equation}
