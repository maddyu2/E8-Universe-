...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8875
\end{equation}

Proof instance 5779 quantum parameter:
\begin{equation}
\hbar \omega_{5779} = 0.989465 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5779} = 9.51e+191
\end{equation}
