...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7547
\end{equation}

Proof instance 6089 quantum parameter:
\begin{equation}
\hbar \omega_{6089} = 0.973120 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6089} = 7.91e+191
\end{equation}
