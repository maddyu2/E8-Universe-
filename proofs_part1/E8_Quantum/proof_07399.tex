...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0774
\end{equation}

Proof instance 7399 quantum parameter:
\begin{equation}
\hbar \omega_{7399} = 1.011981 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7399} = 9.05e+191
\end{equation}
