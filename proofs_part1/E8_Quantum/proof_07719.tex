...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4810
\end{equation}

Proof instance 7719 quantum parameter:
\begin{equation}
\hbar \omega_{7719} = 1.011427 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7719} = 9.57e+191
\end{equation}
