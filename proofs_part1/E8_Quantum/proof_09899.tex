...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0927
\end{equation}

Proof instance 9899 quantum parameter:
\begin{equation}
\hbar \omega_{9899} = 0.988811 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9899} = 9.64e+191
\end{equation}
