...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4848
\end{equation}

Proof instance 5099 quantum parameter:
\begin{equation}
\hbar \omega_{5099} = 0.997427 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5099} = 9.04e+191
\end{equation}
