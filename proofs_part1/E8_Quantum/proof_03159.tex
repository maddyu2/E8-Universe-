...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0932
\end{equation}

Proof instance 3159 quantum parameter:
\begin{equation}
\hbar \omega_{3159} = 1.003791 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3159} = 1.06e+192
\end{equation}
