...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1651
\end{equation}

Proof instance 8009 quantum parameter:
\begin{equation}
\hbar \omega_{8009} = 1.024423 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8009} = 9.64e+191
\end{equation}
