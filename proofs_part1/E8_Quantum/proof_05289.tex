...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7708
\end{equation}

Proof instance 5289 quantum parameter:
\begin{equation}
\hbar \omega_{5289} = 1.003569 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5289} = 1.06e+192
\end{equation}
