...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2933
\end{equation}

Proof instance 7529 quantum parameter:
\begin{equation}
\hbar \omega_{7529} = 0.982635 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7529} = 1.00e+192
\end{equation}
