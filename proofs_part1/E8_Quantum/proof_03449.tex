...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7687
\end{equation}

Proof instance 3449 quantum parameter:
\begin{equation}
\hbar \omega_{3449} = 1.008941 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3449} = 9.35e+191
\end{equation}
