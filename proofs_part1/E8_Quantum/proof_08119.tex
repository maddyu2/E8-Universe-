...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1128
\end{equation}

Proof instance 8119 quantum parameter:
\begin{equation}
\hbar \omega_{8119} = 1.014735 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8119} = 8.90e+191
\end{equation}
