...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7118
\end{equation}

Proof instance 6759 quantum parameter:
\begin{equation}
\hbar \omega_{6759} = 1.015386 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6759} = 1.00e+192
\end{equation}
