...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8283
\end{equation}

Proof instance 8629 quantum parameter:
\begin{equation}
\hbar \omega_{8629} = 0.986805 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8629} = 1.08e+192
\end{equation}
