...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7035
\end{equation}

Proof instance 4849 quantum parameter:
\begin{equation}
\hbar \omega_{4849} = 1.007828 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4849} = 9.74e+191
\end{equation}
