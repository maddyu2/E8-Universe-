...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7041
\end{equation}

Proof instance 9959 quantum parameter:
\begin{equation}
\hbar \omega_{9959} = 0.996468 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9959} = 1.11e+192
\end{equation}
