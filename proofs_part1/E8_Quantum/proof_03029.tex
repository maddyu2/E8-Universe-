...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6321
\end{equation}

Proof instance 3029 quantum parameter:
\begin{equation}
\hbar \omega_{3029} = 0.992963 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3029} = 1.03e+192
\end{equation}
