...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5094
\end{equation}

Proof instance 5869 quantum parameter:
\begin{equation}
\hbar \omega_{5869} = 0.993116 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5869} = 8.88e+191
\end{equation}
