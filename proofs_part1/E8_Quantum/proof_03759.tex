...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9412
\end{equation}

Proof instance 3759 quantum parameter:
\begin{equation}
\hbar \omega_{3759} = 1.013851 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3759} = 9.91e+191
\end{equation}
