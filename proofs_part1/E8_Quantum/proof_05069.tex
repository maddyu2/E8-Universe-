...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8825
\end{equation}

Proof instance 5069 quantum parameter:
\begin{equation}
\hbar \omega_{5069} = 0.987538 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5069} = 1.07e+192
\end{equation}
