...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1724
\end{equation}

Proof instance 1559 quantum parameter:
\begin{equation}
\hbar \omega_{1559} = 1.002420 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1559} = 1.10e+192
\end{equation}
