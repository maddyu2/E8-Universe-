...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5150
\end{equation}

Proof instance 1829 quantum parameter:
\begin{equation}
\hbar \omega_{1829} = 1.013616 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1829} = 1.12e+192
\end{equation}
