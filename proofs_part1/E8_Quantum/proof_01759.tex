...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3115
\end{equation}

Proof instance 1759 quantum parameter:
\begin{equation}
\hbar \omega_{1759} = 1.003128 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1759} = 1.09e+192
\end{equation}
