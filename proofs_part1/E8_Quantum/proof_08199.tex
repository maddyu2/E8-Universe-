...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.8837
\end{equation}

Proof instance 8199 quantum parameter:
\begin{equation}
\hbar \omega_{8199} = 1.001036 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8199} = 9.80e+191
\end{equation}
