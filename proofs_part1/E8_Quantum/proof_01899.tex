...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5632
\end{equation}

Proof instance 1899 quantum parameter:
\begin{equation}
\hbar \omega_{1899} = 0.996048 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1899} = 9.56e+191
\end{equation}
