...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4153
\end{equation}

Proof instance 7969 quantum parameter:
\begin{equation}
\hbar \omega_{7969} = 1.006006 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7969} = 8.31e+191
\end{equation}
