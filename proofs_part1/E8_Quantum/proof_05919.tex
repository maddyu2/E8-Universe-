...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9365
\end{equation}

Proof instance 5919 quantum parameter:
\begin{equation}
\hbar \omega_{5919} = 0.979849 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5919} = 1.06e+192
\end{equation}
