...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.1522
\end{equation}

Proof instance 2529 quantum parameter:
\begin{equation}
\hbar \omega_{2529} = 1.001189 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2529} = 8.98e+191
\end{equation}
