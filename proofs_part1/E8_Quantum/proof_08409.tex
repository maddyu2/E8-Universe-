...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4509
\end{equation}

Proof instance 8409 quantum parameter:
\begin{equation}
\hbar \omega_{8409} = 0.986317 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8409} = 1.25e+192
\end{equation}
