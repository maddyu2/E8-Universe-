...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4882
\end{equation}

Proof instance 3599 quantum parameter:
\begin{equation}
\hbar \omega_{3599} = 1.002251 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3599} = 1.03e+192
\end{equation}
