...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2629
\end{equation}

Proof instance 6549 quantum parameter:
\begin{equation}
\hbar \omega_{6549} = 0.996920 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6549} = 9.66e+191
\end{equation}
