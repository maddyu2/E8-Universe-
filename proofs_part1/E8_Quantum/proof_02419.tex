...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5652
\end{equation}

Proof instance 2419 quantum parameter:
\begin{equation}
\hbar \omega_{2419} = 1.003842 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2419} = 1.10e+192
\end{equation}
