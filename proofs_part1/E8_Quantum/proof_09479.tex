...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1082
\end{equation}

Proof instance 9479 quantum parameter:
\begin{equation}
\hbar \omega_{9479} = 0.999456 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9479} = 1.07e+192
\end{equation}
