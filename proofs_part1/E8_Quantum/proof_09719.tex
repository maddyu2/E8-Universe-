...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7623
\end{equation}

Proof instance 9719 quantum parameter:
\begin{equation}
\hbar \omega_{9719} = 0.986907 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9719} = 9.98e+191
\end{equation}
