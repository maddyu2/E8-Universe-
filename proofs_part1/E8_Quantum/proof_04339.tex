...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5273
\end{equation}

Proof instance 4339 quantum parameter:
\begin{equation}
\hbar \omega_{4339} = 1.013735 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4339} = 9.55e+191
\end{equation}
