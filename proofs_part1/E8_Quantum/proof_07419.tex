...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5824
\end{equation}

Proof instance 7419 quantum parameter:
\begin{equation}
\hbar \omega_{7419} = 1.011411 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7419} = 1.09e+192
\end{equation}
