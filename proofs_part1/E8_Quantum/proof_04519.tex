...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3153
\end{equation}

Proof instance 4519 quantum parameter:
\begin{equation}
\hbar \omega_{4519} = 1.001691 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4519} = 9.98e+191
\end{equation}
