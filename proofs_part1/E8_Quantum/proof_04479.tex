...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4862
\end{equation}

Proof instance 4479 quantum parameter:
\begin{equation}
\hbar \omega_{4479} = 0.988947 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4479} = 9.53e+191
\end{equation}
