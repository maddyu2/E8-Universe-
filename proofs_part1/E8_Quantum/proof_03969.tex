...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8510
\end{equation}

Proof instance 3969 quantum parameter:
\begin{equation}
\hbar \omega_{3969} = 0.998384 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3969} = 1.06e+192
\end{equation}
