...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8793
\end{equation}

Proof instance 3629 quantum parameter:
\begin{equation}
\hbar \omega_{3629} = 0.997360 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3629} = 1.00e+192
\end{equation}
