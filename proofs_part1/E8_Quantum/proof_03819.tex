...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0135
\end{equation}

Proof instance 3819 quantum parameter:
\begin{equation}
\hbar \omega_{3819} = 1.005013 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3819} = 9.31e+191
\end{equation}
