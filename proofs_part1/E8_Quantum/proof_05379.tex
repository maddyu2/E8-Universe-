...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.1527
\end{equation}

Proof instance 5379 quantum parameter:
\begin{equation}
\hbar \omega_{5379} = 1.000801 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5379} = 9.74e+191
\end{equation}
