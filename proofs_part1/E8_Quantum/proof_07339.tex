...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1680
\end{equation}

Proof instance 7339 quantum parameter:
\begin{equation}
\hbar \omega_{7339} = 0.995572 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7339} = 1.07e+192
\end{equation}
