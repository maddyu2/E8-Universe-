...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0370
\end{equation}

Proof instance 3739 quantum parameter:
\begin{equation}
\hbar \omega_{3739} = 0.989201 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3739} = 9.92e+191
\end{equation}
