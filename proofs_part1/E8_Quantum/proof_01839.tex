...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8249
\end{equation}

Proof instance 1839 quantum parameter:
\begin{equation}
\hbar \omega_{1839} = 1.022634 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1839} = 1.14e+192
\end{equation}
