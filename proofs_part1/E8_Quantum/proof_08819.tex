...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2328
\end{equation}

Proof instance 8819 quantum parameter:
\begin{equation}
\hbar \omega_{8819} = 0.989058 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8819} = 1.12e+192
\end{equation}
