...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2931
\end{equation}

Proof instance 7079 quantum parameter:
\begin{equation}
\hbar \omega_{7079} = 0.994838 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7079} = 8.33e+191
\end{equation}
