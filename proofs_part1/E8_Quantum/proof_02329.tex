...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8660
\end{equation}

Proof instance 2329 quantum parameter:
\begin{equation}
\hbar \omega_{2329} = 1.013380 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2329} = 9.49e+191
\end{equation}
