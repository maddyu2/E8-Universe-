...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7718
\end{equation}

Proof instance 329 quantum parameter:
\begin{equation}
\hbar \omega_{329} = 1.016381 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{329} = 8.09e+191
\end{equation}
