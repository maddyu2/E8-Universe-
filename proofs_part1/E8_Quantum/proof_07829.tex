...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7948
\end{equation}

Proof instance 7829 quantum parameter:
\begin{equation}
\hbar \omega_{7829} = 1.001210 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7829} = 9.81e+191
\end{equation}
