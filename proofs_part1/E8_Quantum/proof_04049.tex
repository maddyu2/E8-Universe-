...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5261
\end{equation}

Proof instance 4049 quantum parameter:
\begin{equation}
\hbar \omega_{4049} = 1.006257 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4049} = 1.02e+192
\end{equation}
