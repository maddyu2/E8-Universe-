...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9781
\end{equation}

Proof instance 6639 quantum parameter:
\begin{equation}
\hbar \omega_{6639} = 1.004214 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6639} = 1.14e+192
\end{equation}
