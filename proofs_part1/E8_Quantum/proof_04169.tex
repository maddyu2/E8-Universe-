...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5504
\end{equation}

Proof instance 4169 quantum parameter:
\begin{equation}
\hbar \omega_{4169} = 0.992301 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4169} = 9.06e+191
\end{equation}
