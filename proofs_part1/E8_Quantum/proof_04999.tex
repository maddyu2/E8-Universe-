...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8571
\end{equation}

Proof instance 4999 quantum parameter:
\begin{equation}
\hbar \omega_{4999} = 1.015922 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4999} = 9.58e+191
\end{equation}
