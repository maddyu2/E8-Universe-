...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4659
\end{equation}

Proof instance 5749 quantum parameter:
\begin{equation}
\hbar \omega_{5749} = 0.999093 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5749} = 1.13e+192
\end{equation}
