...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1480
\end{equation}

Proof instance 839 quantum parameter:
\begin{equation}
\hbar \omega_{839} = 1.012972 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{839} = 1.11e+192
\end{equation}
