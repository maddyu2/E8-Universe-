...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1706
\end{equation}

Proof instance 1959 quantum parameter:
\begin{equation}
\hbar \omega_{1959} = 0.999261 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1959} = 1.16e+192
\end{equation}
