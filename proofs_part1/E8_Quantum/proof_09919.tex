...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7978
\end{equation}

Proof instance 9919 quantum parameter:
\begin{equation}
\hbar \omega_{9919} = 1.002360 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9919} = 9.40e+191
\end{equation}
