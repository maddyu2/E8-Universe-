...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2113
\end{equation}

Proof instance 9789 quantum parameter:
\begin{equation}
\hbar \omega_{9789} = 1.006192 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9789} = 1.02e+192
\end{equation}
