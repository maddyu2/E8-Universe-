...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.1878
\end{equation}

Proof instance 8649 quantum parameter:
\begin{equation}
\hbar \omega_{8649} = 1.007522 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8649} = 8.50e+191
\end{equation}
