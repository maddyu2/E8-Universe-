...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2948
\end{equation}

Proof instance 7369 quantum parameter:
\begin{equation}
\hbar \omega_{7369} = 1.000735 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7369} = 9.32e+191
\end{equation}
