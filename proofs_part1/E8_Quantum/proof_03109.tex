...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0700
\end{equation}

Proof instance 3109 quantum parameter:
\begin{equation}
\hbar \omega_{3109} = 0.997077 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3109} = 9.91e+191
\end{equation}
