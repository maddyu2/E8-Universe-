...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2343
\end{equation}

Proof instance 519 quantum parameter:
\begin{equation}
\hbar \omega_{519} = 0.989125 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{519} = 1.15e+192
\end{equation}
