...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9262
\end{equation}

Proof instance 5559 quantum parameter:
\begin{equation}
\hbar \omega_{5559} = 1.003859 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5559} = 1.11e+192
\end{equation}
