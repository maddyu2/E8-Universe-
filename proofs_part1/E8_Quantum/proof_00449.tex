...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8238
\end{equation}

Proof instance 449 quantum parameter:
\begin{equation}
\hbar \omega_{449} = 1.013553 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{449} = 1.15e+192
\end{equation}
