...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8350
\end{equation}

Proof instance 2809 quantum parameter:
\begin{equation}
\hbar \omega_{2809} = 1.001248 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2809} = 1.02e+192
\end{equation}
