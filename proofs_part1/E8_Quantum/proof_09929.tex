...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7478
\end{equation}

Proof instance 9929 quantum parameter:
\begin{equation}
\hbar \omega_{9929} = 1.002801 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9929} = 8.74e+191
\end{equation}
