...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9030
\end{equation}

Proof instance 1929 quantum parameter:
\begin{equation}
\hbar \omega_{1929} = 0.984960 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1929} = 8.72e+191
\end{equation}
