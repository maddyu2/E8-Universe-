...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8854
\end{equation}

Proof instance 9369 quantum parameter:
\begin{equation}
\hbar \omega_{9369} = 1.004060 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9369} = 1.03e+192
\end{equation}
