...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5723
\end{equation}

Proof instance 9509 quantum parameter:
\begin{equation}
\hbar \omega_{9509} = 1.014570 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9509} = 9.61e+191
\end{equation}
