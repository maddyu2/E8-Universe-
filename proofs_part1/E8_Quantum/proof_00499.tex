...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2955
\end{equation}

Proof instance 499 quantum parameter:
\begin{equation}
\hbar \omega_{499} = 0.994759 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{499} = 1.01e+192
\end{equation}
