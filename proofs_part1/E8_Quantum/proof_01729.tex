...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.6524
\end{equation}

Proof instance 1729 quantum parameter:
\begin{equation}
\hbar \omega_{1729} = 0.994247 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1729} = 9.31e+191
\end{equation}
