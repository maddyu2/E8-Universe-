...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9833
\end{equation}

Proof instance 1939 quantum parameter:
\begin{equation}
\hbar \omega_{1939} = 1.002864 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1939} = 1.02e+192
\end{equation}
