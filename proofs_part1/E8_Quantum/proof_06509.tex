...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7629
\end{equation}

Proof instance 6509 quantum parameter:
\begin{equation}
\hbar \omega_{6509} = 0.996804 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6509} = 1.02e+192
\end{equation}
