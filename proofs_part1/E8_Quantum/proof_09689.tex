...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8936
\end{equation}

Proof instance 9689 quantum parameter:
\begin{equation}
\hbar \omega_{9689} = 1.004896 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9689} = 9.56e+191
\end{equation}
