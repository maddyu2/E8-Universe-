...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0190
\end{equation}

Proof instance 9349 quantum parameter:
\begin{equation}
\hbar \omega_{9349} = 1.003063 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9349} = 9.90e+191
\end{equation}
