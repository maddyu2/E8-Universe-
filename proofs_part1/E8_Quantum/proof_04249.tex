...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0257
\end{equation}

Proof instance 4249 quantum parameter:
\begin{equation}
\hbar \omega_{4249} = 1.002436 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4249} = 1.06e+192
\end{equation}
