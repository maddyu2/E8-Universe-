...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.6009
\end{equation}

Proof instance 9539 quantum parameter:
\begin{equation}
\hbar \omega_{9539} = 0.998692 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9539} = 9.47e+191
\end{equation}
