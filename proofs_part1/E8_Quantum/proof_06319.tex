...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2818
\end{equation}

Proof instance 6319 quantum parameter:
\begin{equation}
\hbar \omega_{6319} = 0.993053 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6319} = 1.02e+192
\end{equation}
