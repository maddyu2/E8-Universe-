...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.7117
\end{equation}

Proof instance 5639 quantum parameter:
\begin{equation}
\hbar \omega_{5639} = 1.008150 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5639} = 1.05e+192
\end{equation}
