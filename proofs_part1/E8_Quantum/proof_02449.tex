...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6145
\end{equation}

Proof instance 2449 quantum parameter:
\begin{equation}
\hbar \omega_{2449} = 0.985779 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2449} = 9.55e+191
\end{equation}
