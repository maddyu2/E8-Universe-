...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4444
\end{equation}

Proof instance 6419 quantum parameter:
\begin{equation}
\hbar \omega_{6419} = 0.999204 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6419} = 1.07e+192
\end{equation}
