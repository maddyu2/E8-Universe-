...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8758
\end{equation}

Proof instance 2759 quantum parameter:
\begin{equation}
\hbar \omega_{2759} = 0.994617 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2759} = 1.03e+192
\end{equation}
