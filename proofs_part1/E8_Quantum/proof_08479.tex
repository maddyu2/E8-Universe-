...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4986
\end{equation}

Proof instance 8479 quantum parameter:
\begin{equation}
\hbar \omega_{8479} = 0.997381 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8479} = 1.06e+192
\end{equation}
