...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3573
\end{equation}

Proof instance 5659 quantum parameter:
\begin{equation}
\hbar \omega_{5659} = 1.007937 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5659} = 9.99e+191
\end{equation}
