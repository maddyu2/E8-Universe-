...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5877
\end{equation}

Proof instance 8599 quantum parameter:
\begin{equation}
\hbar \omega_{8599} = 0.995889 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8599} = 8.12e+191
\end{equation}
