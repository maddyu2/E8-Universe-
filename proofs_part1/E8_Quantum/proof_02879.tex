...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2057
\end{equation}

Proof instance 2879 quantum parameter:
\begin{equation}
\hbar \omega_{2879} = 1.009265 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2879} = 9.93e+191
\end{equation}
