...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8512
\end{equation}

Proof instance 2569 quantum parameter:
\begin{equation}
\hbar \omega_{2569} = 0.991761 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2569} = 9.87e+191
\end{equation}
