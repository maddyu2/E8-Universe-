...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8112
\end{equation}

Proof instance 1339 quantum parameter:
\begin{equation}
\hbar \omega_{1339} = 1.002782 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1339} = 9.03e+191
\end{equation}
