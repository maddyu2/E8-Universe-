...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5617
\end{equation}

Proof instance 2699 quantum parameter:
\begin{equation}
\hbar \omega_{2699} = 0.999739 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2699} = 9.12e+191
\end{equation}
