...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2112
\end{equation}

Proof instance 3439 quantum parameter:
\begin{equation}
\hbar \omega_{3439} = 1.011719 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3439} = 1.11e+192
\end{equation}
