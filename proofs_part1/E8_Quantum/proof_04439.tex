...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8684
\end{equation}

Proof instance 4439 quantum parameter:
\begin{equation}
\hbar \omega_{4439} = 1.014984 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4439} = 9.27e+191
\end{equation}
