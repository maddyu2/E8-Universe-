...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9661
\end{equation}

Proof instance 559 quantum parameter:
\begin{equation}
\hbar \omega_{559} = 0.991692 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{559} = 7.90e+191
\end{equation}
