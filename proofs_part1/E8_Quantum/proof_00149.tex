...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 245.4487
\end{equation}

Proof instance 149 quantum parameter:
\begin{equation}
\hbar \omega_{149} = 0.987302 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{149} = 1.01e+192
\end{equation}
