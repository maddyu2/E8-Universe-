...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6389
\end{equation}

Proof instance 609 quantum parameter:
\begin{equation}
\hbar \omega_{609} = 0.998210 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{609} = 9.54e+191
\end{equation}
