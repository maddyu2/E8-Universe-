...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2389
\end{equation}

Proof instance 669 quantum parameter:
\begin{equation}
\hbar \omega_{669} = 0.997672 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{669} = 1.17e+192
\end{equation}
