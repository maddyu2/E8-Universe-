...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1845
\end{equation}

Proof instance 8189 quantum parameter:
\begin{equation}
\hbar \omega_{8189} = 0.990456 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8189} = 9.94e+191
\end{equation}
