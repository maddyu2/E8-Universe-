...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4991
\end{equation}

Proof instance 799 quantum parameter:
\begin{equation}
\hbar \omega_{799} = 1.006251 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{799} = 9.41e+191
\end{equation}
