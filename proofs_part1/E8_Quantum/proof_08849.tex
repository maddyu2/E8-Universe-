...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4316
\end{equation}

Proof instance 8849 quantum parameter:
\begin{equation}
\hbar \omega_{8849} = 1.011336 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8849} = 9.42e+191
\end{equation}
