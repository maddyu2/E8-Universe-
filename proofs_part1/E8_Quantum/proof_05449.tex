...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0635
\end{equation}

Proof instance 5449 quantum parameter:
\begin{equation}
\hbar \omega_{5449} = 0.991301 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5449} = 8.89e+191
\end{equation}
