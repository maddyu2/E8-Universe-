...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7770
\end{equation}

Proof instance 8249 quantum parameter:
\begin{equation}
\hbar \omega_{8249} = 1.017357 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8249} = 8.95e+191
\end{equation}
