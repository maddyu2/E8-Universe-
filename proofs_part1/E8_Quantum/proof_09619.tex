...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4618
\end{equation}

Proof instance 9619 quantum parameter:
\begin{equation}
\hbar \omega_{9619} = 1.003413 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9619} = 9.88e+191
\end{equation}
