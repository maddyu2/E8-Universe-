...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3066
\end{equation}

Proof instance 1299 quantum parameter:
\begin{equation}
\hbar \omega_{1299} = 0.997215 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1299} = 1.20e+192
\end{equation}
