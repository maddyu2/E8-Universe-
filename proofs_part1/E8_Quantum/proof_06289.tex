...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8524
\end{equation}

Proof instance 6289 quantum parameter:
\begin{equation}
\hbar \omega_{6289} = 0.993522 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6289} = 1.05e+192
\end{equation}
