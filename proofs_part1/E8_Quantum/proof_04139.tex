...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3698
\end{equation}

Proof instance 4139 quantum parameter:
\begin{equation}
\hbar \omega_{4139} = 0.992935 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4139} = 1.03e+192
\end{equation}
