...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0506
\end{equation}

Proof instance 3319 quantum parameter:
\begin{equation}
\hbar \omega_{3319} = 0.993418 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3319} = 9.49e+191
\end{equation}
