...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3730
\end{equation}

Proof instance 4019 quantum parameter:
\begin{equation}
\hbar \omega_{4019} = 0.993603 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4019} = 9.90e+191
\end{equation}
