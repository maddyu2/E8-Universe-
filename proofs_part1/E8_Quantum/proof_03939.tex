...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7273
\end{equation}

Proof instance 3939 quantum parameter:
\begin{equation}
\hbar \omega_{3939} = 1.010382 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3939} = 8.13e+191
\end{equation}
