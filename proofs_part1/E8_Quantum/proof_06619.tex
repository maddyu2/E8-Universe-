...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4858
\end{equation}

Proof instance 6619 quantum parameter:
\begin{equation}
\hbar \omega_{6619} = 0.998309 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6619} = 1.14e+192
\end{equation}
