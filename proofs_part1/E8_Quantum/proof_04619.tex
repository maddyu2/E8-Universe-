...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1925
\end{equation}

Proof instance 4619 quantum parameter:
\begin{equation}
\hbar \omega_{4619} = 1.015265 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4619} = 9.04e+191
\end{equation}
