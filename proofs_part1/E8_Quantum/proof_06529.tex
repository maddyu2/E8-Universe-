...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1318
\end{equation}

Proof instance 6529 quantum parameter:
\begin{equation}
\hbar \omega_{6529} = 0.985558 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6529} = 9.99e+191
\end{equation}
