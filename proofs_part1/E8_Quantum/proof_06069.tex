...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6061
\end{equation}

Proof instance 6069 quantum parameter:
\begin{equation}
\hbar \omega_{6069} = 1.020016 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6069} = 1.05e+192
\end{equation}
