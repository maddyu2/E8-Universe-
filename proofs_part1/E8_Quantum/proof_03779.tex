...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3170
\end{equation}

Proof instance 3779 quantum parameter:
\begin{equation}
\hbar \omega_{3779} = 0.984570 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3779} = 9.19e+191
\end{equation}
