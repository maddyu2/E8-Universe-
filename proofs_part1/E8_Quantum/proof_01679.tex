...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.2628
\end{equation}

Proof instance 1679 quantum parameter:
\begin{equation}
\hbar \omega_{1679} = 1.003744 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1679} = 1.02e+192
\end{equation}
