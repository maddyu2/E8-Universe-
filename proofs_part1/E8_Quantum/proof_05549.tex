...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6357
\end{equation}

Proof instance 5549 quantum parameter:
\begin{equation}
\hbar \omega_{5549} = 0.984302 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5549} = 1.04e+192
\end{equation}
