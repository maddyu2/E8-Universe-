...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4853
\end{equation}

Proof instance 2089 quantum parameter:
\begin{equation}
\hbar \omega_{2089} = 0.988699 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2089} = 9.79e+191
\end{equation}
