...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3343
\end{equation}

Proof instance 909 quantum parameter:
\begin{equation}
\hbar \omega_{909} = 0.987619 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{909} = 9.23e+191
\end{equation}
