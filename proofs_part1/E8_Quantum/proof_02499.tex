...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8695
\end{equation}

Proof instance 2499 quantum parameter:
\begin{equation}
\hbar \omega_{2499} = 1.014509 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2499} = 9.95e+191
\end{equation}
