...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4660
\end{equation}

Proof instance 8239 quantum parameter:
\begin{equation}
\hbar \omega_{8239} = 0.994439 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8239} = 1.15e+192
\end{equation}
