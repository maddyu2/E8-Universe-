...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4884
\end{equation}

Proof instance 9099 quantum parameter:
\begin{equation}
\hbar \omega_{9099} = 1.006132 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9099} = 1.27e+192
\end{equation}
