...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1369
\end{equation}

Proof instance 9749 quantum parameter:
\begin{equation}
\hbar \omega_{9749} = 1.008086 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9749} = 1.13e+192
\end{equation}
