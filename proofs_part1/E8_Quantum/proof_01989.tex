...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4300
\end{equation}

Proof instance 1989 quantum parameter:
\begin{equation}
\hbar \omega_{1989} = 1.008951 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1989} = 9.74e+191
\end{equation}
