...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0490
\end{equation}

Proof instance 3879 quantum parameter:
\begin{equation}
\hbar \omega_{3879} = 0.988783 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3879} = 9.93e+191
\end{equation}
