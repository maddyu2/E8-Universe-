...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2772
\end{equation}

Proof instance 1159 quantum parameter:
\begin{equation}
\hbar \omega_{1159} = 0.999603 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1159} = 1.02e+192
\end{equation}
