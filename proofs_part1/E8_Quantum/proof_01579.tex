...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0116
\end{equation}

Proof instance 1579 quantum parameter:
\begin{equation}
\hbar \omega_{1579} = 1.000366 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1579} = 1.11e+192
\end{equation}
