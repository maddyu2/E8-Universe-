...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4203
\end{equation}

Proof instance 5469 quantum parameter:
\begin{equation}
\hbar \omega_{5469} = 0.998179 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5469} = 9.80e+191
\end{equation}
