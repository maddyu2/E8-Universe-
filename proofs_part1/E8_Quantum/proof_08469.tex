...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8886
\end{equation}

Proof instance 8469 quantum parameter:
\begin{equation}
\hbar \omega_{8469} = 0.999020 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8469} = 1.04e+192
\end{equation}
