...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9379
\end{equation}

Proof instance 2109 quantum parameter:
\begin{equation}
\hbar \omega_{2109} = 1.003554 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2109} = 1.07e+192
\end{equation}
