...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6610
\end{equation}

Proof instance 4199 quantum parameter:
\begin{equation}
\hbar \omega_{4199} = 0.991769 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4199} = 9.54e+191
\end{equation}
