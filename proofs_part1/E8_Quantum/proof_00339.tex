...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1747
\end{equation}

Proof instance 339 quantum parameter:
\begin{equation}
\hbar \omega_{339} = 0.982423 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{339} = 8.93e+191
\end{equation}
