...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5487
\end{equation}

Proof instance 4269 quantum parameter:
\begin{equation}
\hbar \omega_{4269} = 0.997942 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4269} = 1.14e+192
\end{equation}
