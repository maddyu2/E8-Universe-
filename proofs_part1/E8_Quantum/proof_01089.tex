...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7124
\end{equation}

Proof instance 1089 quantum parameter:
\begin{equation}
\hbar \omega_{1089} = 0.996896 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1089} = 8.28e+191
\end{equation}
