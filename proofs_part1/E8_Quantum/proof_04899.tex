...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2831
\end{equation}

Proof instance 4899 quantum parameter:
\begin{equation}
\hbar \omega_{4899} = 0.994931 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4899} = 7.60e+191
\end{equation}
