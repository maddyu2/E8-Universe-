...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.8527
\end{equation}

Proof instance 7039 quantum parameter:
\begin{equation}
\hbar \omega_{7039} = 1.012793 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7039} = 8.56e+191
\end{equation}
