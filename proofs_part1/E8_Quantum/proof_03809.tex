...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7762
\end{equation}

Proof instance 3809 quantum parameter:
\begin{equation}
\hbar \omega_{3809} = 1.002689 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3809} = 9.88e+191
\end{equation}
