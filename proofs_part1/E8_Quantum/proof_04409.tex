...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.5500
\end{equation}

Proof instance 4409 quantum parameter:
\begin{equation}
\hbar \omega_{4409} = 1.002378 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4409} = 8.39e+191
\end{equation}
