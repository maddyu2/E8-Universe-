...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3246
\end{equation}

Proof instance 5459 quantum parameter:
\begin{equation}
\hbar \omega_{5459} = 1.007764 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5459} = 1.00e+192
\end{equation}
