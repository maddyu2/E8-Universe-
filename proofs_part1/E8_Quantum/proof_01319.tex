...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9741
\end{equation}

Proof instance 1319 quantum parameter:
\begin{equation}
\hbar \omega_{1319} = 0.964602 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1319} = 9.37e+191
\end{equation}
