...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1280
\end{equation}

Proof instance 2129 quantum parameter:
\begin{equation}
\hbar \omega_{2129} = 1.023242 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2129} = 8.74e+191
\end{equation}
