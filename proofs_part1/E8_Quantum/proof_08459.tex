...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1192
\end{equation}

Proof instance 8459 quantum parameter:
\begin{equation}
\hbar \omega_{8459} = 1.001333 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8459} = 8.97e+191
\end{equation}
