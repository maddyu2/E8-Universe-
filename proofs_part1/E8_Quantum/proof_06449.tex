...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.7384
\end{equation}

Proof instance 6449 quantum parameter:
\begin{equation}
\hbar \omega_{6449} = 0.987116 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6449} = 8.88e+191
\end{equation}
