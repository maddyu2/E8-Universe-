...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7720
\end{equation}

Proof instance 5709 quantum parameter:
\begin{equation}
\hbar \omega_{5709} = 0.994003 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5709} = 9.07e+191
\end{equation}
