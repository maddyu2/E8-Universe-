...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.8246
\end{equation}

Proof instance 6679 quantum parameter:
\begin{equation}
\hbar \omega_{6679} = 1.012158 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6679} = 8.74e+191
\end{equation}
