...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9430
\end{equation}

Proof instance 2199 quantum parameter:
\begin{equation}
\hbar \omega_{2199} = 0.983017 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2199} = 8.07e+191
\end{equation}
