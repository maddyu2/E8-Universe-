...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1180
\end{equation}

Proof instance 5479 quantum parameter:
\begin{equation}
\hbar \omega_{5479} = 0.989546 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5479} = 1.22e+192
\end{equation}
