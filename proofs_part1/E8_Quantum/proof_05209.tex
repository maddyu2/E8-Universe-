...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7973
\end{equation}

Proof instance 5209 quantum parameter:
\begin{equation}
\hbar \omega_{5209} = 1.003336 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5209} = 1.13e+192
\end{equation}
