...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5043
\end{equation}

Proof instance 5999 quantum parameter:
\begin{equation}
\hbar \omega_{5999} = 1.004337 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5999} = 1.09e+192
\end{equation}
