...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5539
\end{equation}

Proof instance 299 quantum parameter:
\begin{equation}
\hbar \omega_{299} = 1.000303 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{299} = 9.33e+191
\end{equation}
