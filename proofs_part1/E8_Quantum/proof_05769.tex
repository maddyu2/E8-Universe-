...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.9499
\end{equation}

Proof instance 5769 quantum parameter:
\begin{equation}
\hbar \omega_{5769} = 0.984556 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5769} = 1.04e+192
\end{equation}
