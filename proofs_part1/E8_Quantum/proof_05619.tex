...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4382
\end{equation}

Proof instance 5619 quantum parameter:
\begin{equation}
\hbar \omega_{5619} = 1.002361 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5619} = 1.03e+192
\end{equation}
