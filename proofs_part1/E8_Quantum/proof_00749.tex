...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.3902
\end{equation}

Proof instance 749 quantum parameter:
\begin{equation}
\hbar \omega_{749} = 0.996957 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{749} = 9.70e+191
\end{equation}
