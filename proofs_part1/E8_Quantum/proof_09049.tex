...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.4194
\end{equation}

Proof instance 9049 quantum parameter:
\begin{equation}
\hbar \omega_{9049} = 1.004657 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9049} = 1.12e+192
\end{equation}
