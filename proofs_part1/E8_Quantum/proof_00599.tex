...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 251.0407
\end{equation}

Proof instance 599 quantum parameter:
\begin{equation}
\hbar \omega_{599} = 0.985585 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{599} = 9.02e+191
\end{equation}
