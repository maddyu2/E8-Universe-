...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3594
\end{equation}

Proof instance 7219 quantum parameter:
\begin{equation}
\hbar \omega_{7219} = 0.976099 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7219} = 1.06e+192
\end{equation}
