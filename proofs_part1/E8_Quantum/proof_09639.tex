...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0044
\end{equation}

Proof instance 9639 quantum parameter:
\begin{equation}
\hbar \omega_{9639} = 1.006583 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9639} = 9.38e+191
\end{equation}
