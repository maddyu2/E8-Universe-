...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0764
\end{equation}

Proof instance 439 quantum parameter:
\begin{equation}
\hbar \omega_{439} = 1.008624 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{439} = 1.11e+192
\end{equation}
