...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.1469
\end{equation}

Proof instance 8099 quantum parameter:
\begin{equation}
\hbar \omega_{8099} = 1.001980 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8099} = 8.55e+191
\end{equation}
