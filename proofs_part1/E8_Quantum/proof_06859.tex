...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.1734
\end{equation}

Proof instance 6859 quantum parameter:
\begin{equation}
\hbar \omega_{6859} = 1.013127 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6859} = 1.00e+192
\end{equation}
