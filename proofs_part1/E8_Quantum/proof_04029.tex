...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7251
\end{equation}

Proof instance 4029 quantum parameter:
\begin{equation}
\hbar \omega_{4029} = 0.988194 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4029} = 8.24e+191
\end{equation}
