...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0560
\end{equation}

Proof instance 8309 quantum parameter:
\begin{equation}
\hbar \omega_{8309} = 0.998618 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8309} = 1.06e+192
\end{equation}
