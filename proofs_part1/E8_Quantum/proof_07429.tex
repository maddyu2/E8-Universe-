...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1604
\end{equation}

Proof instance 7429 quantum parameter:
\begin{equation}
\hbar \omega_{7429} = 0.979515 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{7429} = 1.01e+192
\end{equation}
