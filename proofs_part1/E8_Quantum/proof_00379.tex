...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.4060
\end{equation}

Proof instance 379 quantum parameter:
\begin{equation}
\hbar \omega_{379} = 1.018245 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{379} = 9.54e+191
\end{equation}
