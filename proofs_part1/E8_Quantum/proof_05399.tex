...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9307
\end{equation}

Proof instance 5399 quantum parameter:
\begin{equation}
\hbar \omega_{5399} = 0.998721 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5399} = 1.06e+192
\end{equation}
