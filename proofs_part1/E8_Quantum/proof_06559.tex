...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2370
\end{equation}

Proof instance 6559 quantum parameter:
\begin{equation}
\hbar \omega_{6559} = 0.984297 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6559} = 1.01e+192
\end{equation}
