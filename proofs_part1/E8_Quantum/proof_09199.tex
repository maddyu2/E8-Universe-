...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6801
\end{equation}

Proof instance 9199 quantum parameter:
\begin{equation}
\hbar \omega_{9199} = 1.003179 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9199} = 9.48e+191
\end{equation}
