...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5085
\end{equation}

Proof instance 5349 quantum parameter:
\begin{equation}
\hbar \omega_{5349} = 1.013432 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5349} = 8.12e+191
\end{equation}
