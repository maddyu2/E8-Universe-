...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.8865
\end{equation}

Proof instance 3909 quantum parameter:
\begin{equation}
\hbar \omega_{3909} = 0.998452 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3909} = 9.74e+191
\end{equation}
