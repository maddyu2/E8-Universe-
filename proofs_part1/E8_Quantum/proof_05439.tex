...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5581
\end{equation}

Proof instance 5439 quantum parameter:
\begin{equation}
\hbar \omega_{5439} = 0.997326 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5439} = 1.07e+192
\end{equation}
