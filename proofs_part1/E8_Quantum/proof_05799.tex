...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9434
\end{equation}

Proof instance 5799 quantum parameter:
\begin{equation}
\hbar \omega_{5799} = 1.009802 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5799} = 9.08e+191
\end{equation}
