...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8829
\end{equation}

Proof instance 4979 quantum parameter:
\begin{equation}
\hbar \omega_{4979} = 1.017380 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4979} = 1.02e+192
\end{equation}
