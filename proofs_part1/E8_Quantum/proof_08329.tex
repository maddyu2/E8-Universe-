...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.0979
\end{equation}

Proof instance 8329 quantum parameter:
\begin{equation}
\hbar \omega_{8329} = 1.001921 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8329} = 1.19e+192
\end{equation}
