...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.9979
\end{equation}

Proof instance 9269 quantum parameter:
\begin{equation}
\hbar \omega_{9269} = 1.003485 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{9269} = 9.82e+191
\end{equation}
