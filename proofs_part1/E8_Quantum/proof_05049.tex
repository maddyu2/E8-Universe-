...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.0341
\end{equation}

Proof instance 5049 quantum parameter:
\begin{equation}
\hbar \omega_{5049} = 0.987273 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5049} = 1.18e+192
\end{equation}
