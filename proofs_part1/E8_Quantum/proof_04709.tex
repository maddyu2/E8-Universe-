...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7745
\end{equation}

Proof instance 4709 quantum parameter:
\begin{equation}
\hbar \omega_{4709} = 1.001319 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4709} = 1.14e+192
\end{equation}
