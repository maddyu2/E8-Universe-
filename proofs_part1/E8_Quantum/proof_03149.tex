...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.7632
\end{equation}

Proof instance 3149 quantum parameter:
\begin{equation}
\hbar \omega_{3149} = 1.002884 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3149} = 8.47e+191
\end{equation}
