...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8008
\end{equation}

Proof instance 2469 quantum parameter:
\begin{equation}
\hbar \omega_{2469} = 0.999261 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2469} = 1.06e+192
\end{equation}
