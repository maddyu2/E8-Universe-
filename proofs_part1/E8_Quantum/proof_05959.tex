...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.3187
\end{equation}

Proof instance 5959 quantum parameter:
\begin{equation}
\hbar \omega_{5959} = 1.022994 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5959} = 9.91e+191
\end{equation}
