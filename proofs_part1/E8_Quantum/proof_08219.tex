...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.7799
\end{equation}

Proof instance 8219 quantum parameter:
\begin{equation}
\hbar \omega_{8219} = 1.002074 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8219} = 9.83e+191
\end{equation}
