...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.0244
\end{equation}

Proof instance 4389 quantum parameter:
\begin{equation}
\hbar \omega_{4389} = 1.006390 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4389} = 1.11e+192
\end{equation}
