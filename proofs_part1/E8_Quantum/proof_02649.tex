...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.5505
\end{equation}

Proof instance 2649 quantum parameter:
\begin{equation}
\hbar \omega_{2649} = 0.988055 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2649} = 1.07e+192
\end{equation}
