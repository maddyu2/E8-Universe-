...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.5633
\end{equation}

Proof instance 5689 quantum parameter:
\begin{equation}
\hbar \omega_{5689} = 1.012360 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5689} = 1.02e+192
\end{equation}
