...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2362
\end{equation}

Proof instance 1969 quantum parameter:
\begin{equation}
\hbar \omega_{1969} = 0.992193 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1969} = 1.15e+192
\end{equation}
