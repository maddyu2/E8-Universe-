...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 250.0391
\end{equation}

Proof instance 319 quantum parameter:
\begin{equation}
\hbar \omega_{319} = 0.994730 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{319} = 1.02e+192
\end{equation}
