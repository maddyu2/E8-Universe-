...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.9160
\end{equation}

Proof instance 6979 quantum parameter:
\begin{equation}
\hbar \omega_{6979} = 1.000748 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{6979} = 1.08e+192
\end{equation}
