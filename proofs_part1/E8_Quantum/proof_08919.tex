...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.8284
\end{equation}

Proof instance 8919 quantum parameter:
\begin{equation}
\hbar \omega_{8919} = 0.994645 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{8919} = 1.11e+192
\end{equation}
