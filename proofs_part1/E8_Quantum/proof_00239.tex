...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.2006
\end{equation}

Proof instance 239 quantum parameter:
\begin{equation}
\hbar \omega_{239} = 0.993202 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{239} = 9.24e+191
\end{equation}
