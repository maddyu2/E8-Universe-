...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.5521
\end{equation}

Proof instance 5859 quantum parameter:
\begin{equation}
\hbar \omega_{5859} = 0.993256 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5859} = 1.00e+192
\end{equation}
