...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.3086
\end{equation}

Proof instance 2269 quantum parameter:
\begin{equation}
\hbar \omega_{2269} = 1.016317 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2269} = 1.06e+192
\end{equation}
