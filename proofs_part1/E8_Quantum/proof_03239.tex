...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.2698
\end{equation}

Proof instance 3239 quantum parameter:
\begin{equation}
\hbar \omega_{3239} = 0.997328 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3239} = 1.01e+192
\end{equation}
