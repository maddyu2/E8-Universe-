...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.4482
\end{equation}

Proof instance 1459 quantum parameter:
\begin{equation}
\hbar \omega_{1459} = 1.007610 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{1459} = 1.06e+192
\end{equation}
