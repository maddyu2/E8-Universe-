...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 249.0634
\end{equation}

Proof instance 3349 quantum parameter:
\begin{equation}
\hbar \omega_{3349} = 0.982078 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3349} = 9.51e+191
\end{equation}
