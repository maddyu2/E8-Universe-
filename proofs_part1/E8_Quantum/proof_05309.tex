...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.2104
\end{equation}

Proof instance 5309 quantum parameter:
\begin{equation}
\hbar \omega_{5309} = 1.003396 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{5309} = 1.02e+192
\end{equation}
