...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.6273
\end{equation}

Proof instance 989 quantum parameter:
\begin{equation}
\hbar \omega_{989} = 0.993817 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{989} = 1.10e+192
\end{equation}
