...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 247.6773
\end{equation}

Proof instance 4509 quantum parameter:
\begin{equation}
\hbar \omega_{4509} = 1.003495 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{4509} = 8.62e+191
\end{equation}
