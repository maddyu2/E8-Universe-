...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 246.1705
\end{equation}

Proof instance 2169 quantum parameter:
\begin{equation}
\hbar \omega_{2169} = 0.992101 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{2169} = 1.05e+192
\end{equation}
