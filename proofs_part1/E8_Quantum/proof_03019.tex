...
\begin{equation}
\sum_{\alpha \in \Phi} |N_{\alpha,\beta}|^2 = 248.1296
\end{equation}

Proof instance 3019 quantum parameter:
\begin{equation}
\hbar \omega_{3019} = 0.998637 \text{ (Planck units}
\end{equation}

\begin{equation}
\sigma_{3019} = 1.26e+192
\end{equation}
